...
8. 核对作者姓名及其单位。优先查看论文 PDF 首页、论文正式作者页或作者提供的正式信息，并按作者上标逐一对应机构；多机构作者完整保留。若正式来源没有列出机构，写“未列机构（论文首页未提供）”；若只给出地点、职业或集体署名，明确记录“论文首页仅列地点/职业/集体署名”，不要使用无说明的未核验占位，也不能根据邮箱域名、作者过往单位或其他间接线索推测。
