...
- 作者及单位：
  - Gunja Agarwal — 单位未核实
  - Arup Kumar Das — 单位未核实
  - Arun Menon — 单位未核实
  - Jitesh Chandra Mishra — 单位未核实
  - Vignesh Divakaran — 单位未核实
...
### 29. Neurosymbolic Alignment for Physiologically-Safe Clinical Language Models

**内容概述：** 针对临床 LLM 输出事实合理但违反生理约束，论文用 84.7 万节点 HGNN Physiological World Model 为 on-policy ORPO 排序候选；CSB 安全分从 69.5% 升至 90.8%、医生评估 harm rate 从 14.1% 降至 5.1%，但仍需真实临床外部验证。

- 收录理由：论文不是一般临床问答，而是针对“事实合理但生理不安全”的具体失效，以生理约束和独立规则引擎验证训练时安全对齐干预。
- 论文/arXiv：[Neurosymbolic Alignment for Physiologically-Safe Clinical Language Models](https://arxiv.org/abs/2608.24534)
- arXiv ID：`2608.24534`
- 代码：暂未找到公开代码
- arXiv 分类：`cs.AI`
- 提交日期：2026-08-25
...
### 31. FraudBench: Protocol-Sensitive Benchmarking of Adversarial Robustness for Financial Risk Assessment
...
### 32. When "Must" Becomes "Maybe": Constraint Weakening in LLM Agent Workflows
...
### 33. Beyond Semantic Accuracy: Consequence-Aware Evaluation for Safety-Critical Language Understanding
...
### 34. Lost in Speech: Trilingual Spoken Hallucination Detection Across Audio and Transcripts
...
### 36. Prompt Structure Redistributes, Not Reduces: An Empirical Analysis of Security-Weaknesses in LLM-Generated Python Code
