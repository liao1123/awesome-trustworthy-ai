...
### 6. Amodei 周末呼吁行业放慢能力发展，并承诺给予独立评估者常驻员工级访问

🌐 [Official](https://apnews.com/article/anthropic-ai-dario-amodei-d59552edcb27892d8ee4d98a48397706)　📅 2026-09-12

👤 **发布方**：AP / PBS / Fortune（多源报道）

- 🎯 **背景与动因**：Anthropic CEO Dario Amodei 9 月 12 日（周六）在 CBS Face the Nation 上表示，AI 行业应放慢快速推进的能力发展，给安全措施追赶的时间；此言论紧随 7.30 越权访问事件、Astra 网络关键能力争议与国会议员施压之后，成为周末最热的安全话题。
- 🔬 **内容与举措**：同期宣布 Anthropic 的新安全承诺：给予独立评估者**永久性、员工级别的访问权限**（permanent, employee-like access），把此前偶发的外部评测变成常驻机制；这与公司内配速（安全优先于速度）和行业配速（反竞次、可验证协调）的区分一脉相承。
- 📌 **意义与要点**：评估者常驻访问若落地将是外部安全审计模式的实质变化——从厂商自报/邀请制转向持续监督；配合 Fortune 同日报道的 Altman「安全公约」表态，两大实验室同周末释放协调配速信号。

### 7. Altman 暗示 OpenAI 与其他 AI 公司将达成安全公约

🌐 [Official](https://fortune.com/2026/09/12/openai-ceo-sam-altman-safety-pact-ai-companies-risks-anthropic-dario-amodei/)　📅 2026-09-12

👤 **发布方**：Fortune

- 🎯 **背景与动因**：在 Amodei 周六放慢呼吁的同一天，Fortune 报道 Sam Altman 暗示 OpenAI 正与其他 AI 公司商讨某种安全公约（pact），共同应对前沿能力风险——此前 OpenAI 刚因 Astra 的网络关键能力自行调整发布节奏，并在 9.9 发文呼吁立法窗口。
- 🔬 **内容与举措**：报道梳理了双方表态的互补性：Anthropic 押注行业协调配速机制（合法、可验证、有效），OpenAI 则推动联邦立法 + 公司间自律公约双轨；两大实验室上市进程（Anthropic 6.1、OpenAI 6.8 机密递交 IPO）也被认为在放大安全承诺的约束力。
- 📌 **意义与要点**：若公约成型，将成为继 EU AI Act 之后首个跨厂商的自愿安全协调机制——值得关注其对评测互认、能力披露和事故报告共享的具体设计。

### 8. Anthropic 9 月威胁情报报告（154 页）周末引发解读热潮

🌐 [Official](https://www.anthropic.com/threat-intelligence-report-september-2026)　📅 2026-09-12

👤 **发布方**：Anthropic（官方报告）；周末多方解读

- 🎯 **背景与动因**：Anthropic 9.10 发布迄今最详细的威胁情报报告（154 页），披露 Claude 遭受的真实滥用图景——网络攻击、影响力运营与商业间谍；9.12 起周末解读（Medium 长文、播客专题、SOC 社区要点提炼）使其实际影响在本窗口集中发酵。
- 🔬 **内容与举措**：报告按内部指派的设计者（designators）追踪滥用行为者，并尝试量化 uplift（模型为恶意行为者带来的真实能力增量）；官方 X 同步发布摘要，第三方安全团队提炼 SOC 可操作要点（d3security 等）。
- 📌 **意义与要点**：报告代表厂商威胁情报的事实标准升级：从轶事式 case study 转向带 uplift 度量的持续监测；对研究者而言，其 designator 分类与 uplift 口径是滥用评测 benchmark 设计的难得公开参照。

## 常规收录

### 9. Do Multimodal LLMs See Before They Read? Diagnosing Contextual Sycophancy
...
### 10. SAEScientist-Bench: Can AI Agents Conduct Autonomous SAE Interpretability Research?
...
### 11. Can Foundation Models Moderate Online Content? Evaluating Instruction- vs. Example-Driven Policy Operationalization
...
### 12. R2VC: Modular Fact-Checking with Retrieval, Verification, and Confidence Calibration
...
### 13. Scan the Skill, Govern the Action: Composing Registry Verdicts with Runtime Consequence Control
...
### 14. Certified Safety Curation: Distribution-Free Guarantees for Safe Offline Reinforcement Learning
...
### 15. Do Influence-Derived Data Perturbations Enable Machine Unlearning? A Controlled Study of Three Plausible Roles
...
### 16. AIM: A Privacy-Aware Interoperable Memory Framework for Multi-Agent Multi-User LLM Systems
...
### 17. Membership Inference via Pairwise Likelihood Ratios
...
### 18. GraphProfiler: Source-Linked Sensitive Attribute Inference via Personal Knowledge Graphs
...
### 20. Access Control as Verified Parse Constraints
...
### 21. PIA-Bench: Towards Automated Privacy Impact Assessment with Large Language Models
...
### 22. Correlation-Guided Fast Machine Unlearning via Hessian Analysis
...
### 23. SWARM: A Multilingual Human-Annotated Dataset for Russian Propaganda Detection in Search Engine Results
...
### 24. Beyond Ambiguous Visual Cues: Studying Physiological Disruptions and Cross-Modal Inconsistencies in Deepfake Videos
...
### 25. Detecting and Explaining Fake News Short Videos with Multimodal Content and Real-World Evidence
...
### 26. Evaluating Context Segmentation in Locally Deployable SLMs for Cybersecurity CTF Tasks
...
### 27. Forging Tree-Ring: Reproducing and Instrumenting Black-Box Semantic Watermark Forgery
...
### 28. Shuffling is Not Enough: Breaking Permutation-Based Model Confidentiality in Hybrid FHE Inference
...
### 29. EvoHarnessBench: Can Your Agents Keep Pace with an Evolving Harness?
...
### 30. AI Safety: Not Optional, Not Later
...
### 31. The Agent Incident Registry: Toward Preventing Repeated AI Agent Failures
...
### 32. SoulAuth: An Actor-native Identity Architecture and Rust Reference Implementation for Humans and Long-lived AI Actors
...
### 33. Position: Recommender Systems Should Move Beyond Platform-Centric Ranking toward Personal Agent-Mediated Recommendation
...
### 34. Who Are We Recommending To? Recommender Systems in the Agentic Web
...
### 35. On-Device Language Models for Privacy-Preserving Stress Prediction: A Multimodal Evaluation on Mobile Health
...
### 36. Occamy-1.0: Open Pareto-frontier 35B Intelligence for Co-work
...
### 37. Who Pays for Open Review? Visible Author Reputation and Its Effect on Ratings
...
### 38. Harness or Model? Isolating the Harness Effect in Agentic Coding with a Contamination-Controlled Private Suite
...
### 39. Can We Trust LLM Judges: A Study of Capability-Dependent Biases and Multi-Judge Ensemble for Bias Calibration
...
### 40. Inverting Self-Triggered Control: Adversarial Reinforcement Learning for Sparse Denial-of-Service Attacks
...
### 41. Reality Is the Final Verifier: On Two Key Gaps in Agentic Software Engineering
...
### 42. Creating an Atomic User Model for Personality-Aware Large Language Model Interaction
...
### 43. The Cost of Compression: A Rate-Distortion Limit on Factual Hallucination
...
### 44. On Identifying Adversarial Intent Injection in AI-Native 6G Networks
...
### 45. Plans They Abandon, Reports They Author: The Narrative Layer of Autonomous Agents
...
### 46. Synthetic TLX: Forecasting Human Workload Using Agent Simulation
...
### 47. Breaking the Token Ceiling: Distilling Smaller, Stronger Byte Models
...
### 48. &#34;I Felt Very Seen, But Still Very Alone&#34;: Longitudinal Trajectories of General-Purpose LLM Use for Socioemotional Support
...
### 49. I Am No One: Style-Aware Paraphrasing for Text Anonymization
...
### 50. SynthSentry: Detecting Synthetic Data Contamination in Language Model Training Data
...
### 51. Toward Robust Personalized Alignment for LLMs: Mitigating Persona Drift in Multi-Turn Dialogue
...
### 52. BlueLM-GUI Technical Report: A Real-Device-Centric Flywheel for Self-Improving Mobile GUI Agents
...
### 53. VRL-Bench: Benchmarking agents on computer control tasks under finite trial budgets
...
### 54. Why User Studies and Participant Experience Reporting Matter for VR Motion Privacy?
...
### 55. LifeFuse-Mem: Lifecycle-Aware State Fusion Against Temporary Overwriting for Long-Term Memory
...
### 56. Diverse Minds, Divided Networks? Personality Composition, Polarization, and Collective Intelligence in LLM-Based Social Simulations
...
### 57. Do LLMs Trust the Accuser or the Accusation? Measuring Belief Shifts in Werewolf
...
### 58. EvoRS: On-Policy Self-Evolution of Reward Systems for Open-Ended Reinforcement Learning
...
### 59. Meddies-PII: A Multilingual Framework for Personally Identifiable Information Extraction in Clinical De-identification
...
### 60. Omniscience for the Masses: New Threats in the Metaverse's Democratized World Creation
...
### 61. NovaFabric: Tamper-Evident, Replayable Evidence for Autonomous AI Agent Runs
...
### 62. Reproducing and Evaluating the Generalizability of Subliminal Learning in Open-Weight Models
...
### 63. Distortion of AI Alignment Revisited: RLHF is a Decent Utilitarian Aligner
...
### 64. LifeMem: Enabling Lifelong Experience Reuse for LLM Agents
...
### 65. Bridging the First-Hour Gap: Evaluating AI Reliability and Benchmarking Deficiencies in Cyber Incident Response for Law Enforcement
...
### 66. Implicit Personality Representations in Humans and LLMs
...
### 67. When Rubrics Fail: Hallucinations Reveal Blind Spots in Medical AI Evaluation
...
### 68. The Mechanics of a Swarm: A Reproducible External Reconstruction of an Unintended Agent-Coordination Episode on a Third-Party Wiki
...
### 69. A Historical Corpus Is Not a Historical System: Auditing Hindsight Leakage in Stateful Data Discovery
...
### 70. Judging by the Cover: Cleaning LLM Truthfulness Benchmarks to Avoid Surface-Level Feature Leakage
...
### 71. Pixel Decodability Is Not a Compression Signal: Causally Evaluating Importance Proxies for Visual KV-Cache Eviction
...
### 72. Robust Policy Optimization via Adversarial Importance Sampling
...
### 73. Expert-Space Exploration in MoE Reinforcement Learning
...
### 74. MAxBench: A Multinomial Concept Recovery Benchmark
