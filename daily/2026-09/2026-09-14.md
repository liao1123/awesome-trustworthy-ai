...
- 检索日期：2026-09-14
- arXiv 范围：检查 2026-09-14（星期一）官方 `new` 页面中的 `cs.AI`、`cs.CL`、`cs.CR`、`cs.CV`、`cs.HC`、`cs.IR`、`cs.LG`、`cs.MA`、`cs.RO` 主分类及其 cross-list；九个分类共 732 条跨分类去重条目，去除本月已收录后 725 篇，其中 2609.* 新论文 518 篇；按 `RESEARCH_INTERESTS.md` 的安全边界标题宽筛 79 篇、逐篇阅读摘要后收录 53 篇。
- 候选论文：518 个 2609.* 新条目（标题宽筛 79 + 扩展视野补扫 15）
- 最终收录：53 篇
...
### 22. The Agent Incident Registry: Toward Preventing Repeated AI Agent Failures
...
### 23. Position: Recommender Systems Should Move Beyond Platform-Centric Ranking toward Personal Agent-Mediated Recommendation
...
### 24. Who Are We Recommending To? Recommender Systems in the Agentic Web
...
### 25. On-Device Language Models for Privacy-Preserving Stress Prediction: A Multimodal Evaluation on Mobile Health
...
### 26. Harness or Model? Isolating the Harness Effect in Agentic Coding with a Contamination-Controlled Private Suite
...
### 27. Can We Trust LLM Judges: A Study of Capability-Dependent Biases and Multi-Judge Ensemble for Bias Calibration
...
### 28. Inverting Self-Triggered Control: Adversarial Reinforcement Learning for Sparse Denial-of-Service Attacks
...
### 29. Reality Is the Final Verifier: On Two Key Gaps in Agentic Software Engineering
...
### 30. Creating an Atomic User Model for Personality-Aware Large Language Model Interaction
...
### 31. The Cost of Compression: A Rate-Distortion Limit on Factual Hallucination
...
### 32. On Identifying Adversarial Intent Injection in AI-Native 6G Networks
...
### 33. Synthetic TLX: Forecasting Human Workload Using Agent Simulation
...
### 34. Breaking the Token Ceiling: Distilling Smaller, Stronger Byte Models
...
### 35. &#34;I Felt Very Seen, But Still Very Alone&#34;: Longitudinal Trajectories of General-Purpose LLM Use for Socioemotional Support
...
### 36. SynthSentry: Detecting Synthetic Data Contamination in Language Model Training Data
...
### 37. Toward Robust Personalized Alignment for LLMs: Mitigating Persona Drift in Multi-Turn Dialogue
...
### 38. BlueLM-GUI Technical Report: A Real-Device-Centric Flywheel for Self-Improving Mobile GUI Agents
...
### 39. VRL-Bench: Benchmarking agents on computer control tasks under finite trial budgets
...
### 40. Why User Studies and Participant Experience Reporting Matter for VR Motion Privacy?
...
### 41. Diverse Minds, Divided Networks? Personality Composition, Polarization, and Collective Intelligence in LLM-Based Social Simulations
...
### 42. EvoRS: On-Policy Self-Evolution of Reward Systems for Open-Ended Reinforcement Learning
...
### 43. Meddies-PII: A Multilingual Framework for Personally Identifiable Information Extraction in Clinical De-identification
...
### 44. NovaFabric: Tamper-Evident, Replayable Evidence for Autonomous AI Agent Runs
...
### 45. Distortion of AI Alignment Revisited: RLHF is a Decent Utilitarian Aligner
...
### 46. LifeMem: Enabling Lifelong Experience Reuse for LLM Agents
...
### 47. Bridging the First-Hour Gap: Evaluating AI Reliability and Benchmarking Deficiencies in Cyber Incident Response for Law Enforcement
...
### 48. Implicit Personality Representations in Humans and LLMs
...
### 49. When Rubrics Fail: Hallucinations Reveal Blind Spots in Medical AI Evaluation
...
### 50. A Historical Corpus Is Not a Historical System: Auditing Hindsight Leakage in Stateful Data Discovery
...
### 51. Judging by the Cover: Cleaning LLM Truthfulness Benchmarks to Avoid Surface-Level Feature Leakage
...
### 52. Robust Policy Optimization via Adversarial Importance Sampling
...
### 53. Expert-Space Exploration in MoE Reinforcement Learning
