...
### 11. Previewing the Model Hardware Standard
...
### 12. Improving Fable 5's biology safeguards
...
### 13. Do Multimodal LLMs See Before They Read? Diagnosing Contextual Sycophancy
...
### 14. SAEScientist-Bench: Can AI Agents Conduct Autonomous SAE Interpretability Research?
...
### 16. R2VC: Modular Fact-Checking with Retrieval, Verification, and Confidence Calibration
...
### 17. Scan the Skill, Govern the Action: Composing Registry Verdicts with Runtime Consequence Control
...
### 18. Certified Safety Curation: Distribution-Free Guarantees for Safe Offline Reinforcement Learning
...
### 19. Do Influence-Derived Data Perturbations Enable Machine Unlearning? A Controlled Study of Three Plausible Roles
...
### 21. Membership Inference via Pairwise Likelihood Ratios
...
### 22. GraphProfiler: Source-Linked Sensitive Attribute Inference via Personal Knowledge Graphs
...
### 23. TripPattern: A Pattern-based Text Watermarking Method for Large Language Models
...
### 24. Access Control as Verified Parse Constraints
...
### 25. PIA-Bench: Towards Automated Privacy Impact Assessment with Large Language Models
...
### 26. Correlation-Guided Fast Machine Unlearning via Hessian Analysis
...
### 27. SWARM: A Multilingual Human-Annotated Dataset for Russian Propaganda Detection in Search Engine Results
...
### 28. Beyond Ambiguous Visual Cues: Studying Physiological Disruptions and Cross-Modal Inconsistencies in Deepfake Videos
...
### 29. Detecting and Explaining Fake News Short Videos with Multimodal Content and Real-World Evidence
...
### 30. Evaluating Context Segmentation in Locally Deployable SLMs for Cybersecurity CTF Tasks
...
### 31. Forging Tree-Ring: Reproducing and Instrumenting Black-Box Semantic Watermark Forgery
...
### 32. Shuffling is Not Enough: Breaking Permutation-Based Model Confidentiality in Hybrid FHE Inference
...
### 33. EvoHarnessBench: Can Your Agents Keep Pace with an Evolving Harness?
...
### 35. The Agent Incident Registry: Toward Preventing Repeated AI Agent Failures
...
### 36. SoulAuth: An Actor-native Identity Architecture and Rust Reference Implementation for Humans and Long-lived AI Actors
...
### 37. Position: Recommender Systems Should Move Beyond Platform-Centric Ranking toward Personal Agent-Mediated Recommendation
...
### 38. Who Are We Recommending To? Recommender Systems in the Agentic Web
...
### 39. On-Device Language Models for Privacy-Preserving Stress Prediction: A Multimodal Evaluation on Mobile Health
...
### 40. Occamy-1.0: Open Pareto-frontier 35B Intelligence for Co-work
...
### 41. Who Pays for Open Review? Visible Author Reputation and Its Effect on Ratings
...
### 42. Harness or Model? Isolating the Harness Effect in Agentic Coding with a Contamination-Controlled Private Suite
...
### 43. Can We Trust LLM Judges: A Study of Capability-Dependent Biases and Multi-Judge Ensemble for Bias Calibration
...
### 44. Inverting Self-Triggered Control: Adversarial Reinforcement Learning for Sparse Denial-of-Service Attacks
...
### 45. Reality Is the Final Verifier: On Two Key Gaps in Agentic Software Engineering
...
### 46. Creating an Atomic User Model for Personality-Aware Large Language Model Interaction
...
### 47. The Cost of Compression: A Rate-Distortion Limit on Factual Hallucination
...
### 48. On Identifying Adversarial Intent Injection in AI-Native 6G Networks
...
### 49. Plans They Abandon, Reports They Author: The Narrative Layer of Autonomous Agents
...
### 50. Synthetic TLX: Forecasting Human Workload Using Agent Simulation
...
### 51. Breaking the Token Ceiling: Distilling Smaller, Stronger Byte Models
...
### 52. &#34;I Felt Very Seen, But Still Very Alone&#34;: Longitudinal Trajectories of General-Purpose LLM Use for Socioemotional Support
...
### 53. I Am No One: Style-Aware Paraphrasing for Text Anonymization
...
### 54. SynthSentry: Detecting Synthetic Data Contamination in Language Model Training Data
...
### 55. Toward Robust Personalized Alignment for LLMs: Mitigating Persona Drift in Multi-Turn Dialogue
...
### 56. BlueLM-GUI Technical Report: A Real-Device-Centric Flywheel for Self-Improving Mobile GUI Agents
...
### 57. VRL-Bench: Benchmarking agents on computer control tasks under finite trial budgets
...
### 58. Why User Studies and Participant Experience Reporting Matter for VR Motion Privacy?
...
### 59. LifeFuse-Mem: Lifecycle-Aware State Fusion Against Temporary Overwriting for Long-Term Memory
...
### 60. Diverse Minds, Divided Networks? Personality Composition, Polarization, and Collective Intelligence in LLM-Based Social Simulations
...
### 61. Do LLMs Trust the Accuser or the Accusation? Measuring Belief Shifts in Werewolf
...
### 62. EvoRS: On-Policy Self-Evolution of Reward Systems for Open-Ended Reinforcement Learning
...
### 63. Meddies-PII: A Multilingual Framework for Personally Identifiable Information Extraction in Clinical De-identification
...
### 64. Omniscience for the Masses: New Threats in the Metaverse's Democratized World Creation
...
### 65. NovaFabric: Tamper-Evident, Replayable Evidence for Autonomous AI Agent Runs
...
### 66. Reproducing and Evaluating the Generalizability of Subliminal Learning in Open-Weight Models
...
### 67. Distortion of AI Alignment Revisited: RLHF is a Decent Utilitarian Aligner
...
### 68. LifeMem: Enabling Lifelong Experience Reuse for LLM Agents
...
### 69. Bridging the First-Hour Gap: Evaluating AI Reliability and Benchmarking Deficiencies in Cyber Incident Response for Law Enforcement
...
### 70. Implicit Personality Representations in Humans and LLMs
...
### 71. When Rubrics Fail: Hallucinations Reveal Blind Spots in Medical AI Evaluation
...
### 72. The Mechanics of a Swarm: A Reproducible External Reconstruction of an Unintended Agent-Coordination Episode on a Third-Party Wiki
...
### 73. A Historical Corpus Is Not a Historical System: Auditing Hindsight Leakage in Stateful Data Discovery
...
### 74. Judging by the Cover: Cleaning LLM Truthfulness Benchmarks to Avoid Surface-Level Feature Leakage
...
### 75. Pixel Decodability Is Not a Compression Signal: Causally Evaluating Importance Proxies for Visual KV-Cache Eviction
...
### 76. Robust Policy Optimization via Adversarial Importance Sampling
...
### 77. Expert-Space Exploration in MoE Reinforcement Learning
...
### 78. MAxBench: A Multinomial Concept Recovery Benchmark
