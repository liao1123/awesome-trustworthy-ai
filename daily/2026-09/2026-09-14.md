...
### 22. Reproducing and Evaluating the Generalizability of Subliminal Learning in Open-Weight Models
...
### 23. Correlation-Guided Fast Machine Unlearning via Hessian Analysis
...
### 24. SWARM: A Multilingual Human-Annotated Dataset for Russian Propaganda Detection in Search Engine Results
...
### 25. Beyond Ambiguous Visual Cues: Studying Physiological Disruptions and Cross-Modal Inconsistencies in Deepfake Videos
...
### 26. Detecting and Explaining Fake News Short Videos with Multimodal Content and Real-World Evidence
...
### 27. Evaluating Context Segmentation in Locally Deployable SLMs for Cybersecurity CTF Tasks
...
### 28. Forging Tree-Ring: Reproducing and Instrumenting Black-Box Semantic Watermark Forgery
...
### 29. Shuffling is Not Enough: Breaking Permutation-Based Model Confidentiality in Hybrid FHE Inference
...
### 30. EvoHarnessBench: Can Your Agents Keep Pace with an Evolving Harness?
...
### 31. AI Safety: Not Optional, Not Later
...
### 32. The Agent Incident Registry: Toward Preventing Repeated AI Agent Failures
...
### 33. SoulAuth: An Actor-native Identity Architecture and Rust Reference Implementation for Humans and Long-lived AI Actors
...
### 34. Position: Recommender Systems Should Move Beyond Platform-Centric Ranking toward Personal Agent-Mediated Recommendation
...
### 35. Who Are We Recommending To? Recommender Systems in the Agentic Web
...
### 36. On-Device Language Models for Privacy-Preserving Stress Prediction: A Multimodal Evaluation on Mobile Health
...
### 37. Occamy-1.0: Open Pareto-frontier 35B Intelligence for Co-work
...
### 38. Who Pays for Open Review? Visible Author Reputation and Its Effect on Ratings
...
### 40. Can We Trust LLM Judges: A Study of Capability-Dependent Biases and Multi-Judge Ensemble for Bias Calibration
...
### 41. Inverting Self-Triggered Control: Adversarial Reinforcement Learning for Sparse Denial-of-Service Attacks
...
### 42. Reality Is the Final Verifier: On Two Key Gaps in Agentic Software Engineering
...
### 43. Creating an Atomic User Model for Personality-Aware Large Language Model Interaction
...
### 44. The Cost of Compression: A Rate-Distortion Limit on Factual Hallucination
...
### 45. On Identifying Adversarial Intent Injection in AI-Native 6G Networks
...
### 46. Plans They Abandon, Reports They Author: The Narrative Layer of Autonomous Agents
...
### 47. Synthetic TLX: Forecasting Human Workload Using Agent Simulation
...
### 48. Breaking the Token Ceiling: Distilling Smaller, Stronger Byte Models
...
### 49. &#34;I Felt Very Seen, But Still Very Alone&#34;: Longitudinal Trajectories of General-Purpose LLM Use for Socioemotional Support
...
### 50. I Am No One: Style-Aware Paraphrasing for Text Anonymization
...
### 51. SynthSentry: Detecting Synthetic Data Contamination in Language Model Training Data
...
### 52. Toward Robust Personalized Alignment for LLMs: Mitigating Persona Drift in Multi-Turn Dialogue
...
### 53. BlueLM-GUI Technical Report: A Real-Device-Centric Flywheel for Self-Improving Mobile GUI Agents
...
### 54. VRL-Bench: Benchmarking agents on computer control tasks under finite trial budgets
...
### 55. Why User Studies and Participant Experience Reporting Matter for VR Motion Privacy?
...
### 56. LifeFuse-Mem: Lifecycle-Aware State Fusion Against Temporary Overwriting for Long-Term Memory
...
### 57. Diverse Minds, Divided Networks? Personality Composition, Polarization, and Collective Intelligence in LLM-Based Social Simulations
...
### 58. Do LLMs Trust the Accuser or the Accusation? Measuring Belief Shifts in Werewolf
...
### 59. EvoRS: On-Policy Self-Evolution of Reward Systems for Open-Ended Reinforcement Learning
...
### 60. Meddies-PII: A Multilingual Framework for Personally Identifiable Information Extraction in Clinical De-identification
...
### 61. Omniscience for the Masses: New Threats in the Metaverse's Democratized World Creation
...
### 62. NovaFabric: Tamper-Evident, Replayable Evidence for Autonomous AI Agent Runs
