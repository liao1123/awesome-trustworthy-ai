...
### 72. Pacing model development in an era of cyber-critical capabilities
...
### 73. Safety and alignment in an era of long-horizon models
...
### 74. The AI policy window is open. We need to act.
...
### 75. How Claude's text watermark works
...
### 76. Improving our alignment and security efforts
...
### 78. Improving Fable 5's biology safeguards
...
### 6. Do Multimodal LLMs See Before They Read? Diagnosing Contextual Sycophancy
...
### 8. Can Foundation Models Moderate Online Content? Evaluating Instruction- vs. Example-Driven Policy Operationalization
...
### 10. Scan the Skill, Govern the Action: Composing Registry Verdicts with Runtime Consequence Control
...
### 11. Certified Safety Curation: Distribution-Free Guarantees for Safe Offline Reinforcement Learning
...
### 12. Do Influence-Derived Data Perturbations Enable Machine Unlearning? A Controlled Study of Three Plausible Roles
...
### 13. AIM: A Privacy-Aware Interoperable Memory Framework for Multi-Agent Multi-User LLM Systems
...
### 14. Membership Inference via Pairwise Likelihood Ratios
...
### 16. TripPattern: A Pattern-based Text Watermarking Method for Large Language Models
...
### 17. Access Control as Verified Parse Constraints
...
### 18. PIA-Bench: Towards Automated Privacy Impact Assessment with Large Language Models
...
### 19. Correlation-Guided Fast Machine Unlearning via Hessian Analysis
...
### 20. SWARM: A Multilingual Human-Annotated Dataset for Russian Propaganda Detection in Search Engine Results
...
### 21. Beyond Ambiguous Visual Cues: Studying Physiological Disruptions and Cross-Modal Inconsistencies in Deepfake Videos
...
### 22. Detecting and Explaining Fake News Short Videos with Multimodal Content and Real-World Evidence
...
### 24. Forging Tree-Ring: Reproducing and Instrumenting Black-Box Semantic Watermark Forgery
