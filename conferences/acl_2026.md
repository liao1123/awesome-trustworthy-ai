...
| 正式论文集 | [Volume 1: Long Papers](https://aclanthology.org/volumes/2026.acl-long/) · [Volume 2: Short Papers](https://aclanthology.org/volumes/2026.acl-short/) · [Findings of ACL: ACL 2026](https://aclanthology.org/volumes/2026.findings-acl/) |
| 检查范围 | 主会 Long Papers 与 Short Papers 共 2,296 篇 + Findings 2,163 篇研究论文；主会数据截至 2026-08-22，Findings 数据截至 2026-09-09 |
...
- 官方论文总数：4,459（主会 Long Papers 2,222 篇、Short Papers 74 篇、Findings 2,163 篇；Anthology 卷页面显示的记录各含一条 proceedings front matter）。
- 初筛候选：766；主会 380 篇以标题高召回检索与摘要安全语义检索覆盖越狱、对齐、智能体、投毒、隐私、机器遗忘、内容真实性、操纵及高风险部署等问题；Findings 386 篇经同一关键词集宽筛后逐篇阅读摘要确认。
- 最终收录：466（主会 277、Findings 189；Findings 中 36 篇此前已经日报渠道入库，卡片总结与仓内保持一致）。
...
- 范围边界：本页覆盖主会 Long/Short research papers 与 Findings 研究论文；System Demonstrations、Industry Track、SRW、Tutorial、TACL/CL presentation 与 workshop papers 均为独立卷或非主会研究录用范围，不计入本页分母和论文表。
...
### 23. HAUNTATTACK: When Attack Follows Reasoning as a Shadow

🎓 [Official](https://aclanthology.org/2026.findings-acl.1002/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`attack`、`HauntAttack`、`reasoning jailbreak`、`large reasoning models`、`black-box attack`

👤 **作者**：Jingyuan Ma、…、Zhifang Sui

- 🎯 **研究动机**：推理能力增强与思维链暴露带来新攻击面，推理与有害意图交织时 LRM 是否更易被越狱缺乏检验
- 🔬 **研究方法**：HauntAttack 把有害指令改写进推理题的关键条件，构造逐步导向不安全输出的推理路径，黑盒评测 11 个 LRM
- 📌 **结论**：平均攻击成功率超 70%，推理模式反而放大越狱风险
...
### 24. FLASH: Focused Layer Attention Sink Hijacking

🎓 [Official](https://aclanthology.org/2026.findings-acl.1039/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`attack`、`FLASH`、`attention sink hijacking`、`shallow-layer guardrails`、`structural alignment weakness`

👤 **作者**：Siyuan Deng、Yerong Li、Fanhua Shang、Hongying Liu

- 🎯 **研究动机**：安全护栏在模型内部如何分布不明，维持稳定性的 attention sink 可能成为对齐的结构锚点
- 🔬 **研究方法**：FLASH 实证护栏主要前置分布于浅层特定注意力头，通过劫持 attention sink 穿透安全机制，避开高成本输入优化
- 📌 **结论**：浅层注意力汇聚被确认为对齐的结构性弱点，可低成本利用
...
### 25. MSIA: Adaptive Medical Multimodal Multi-turn Semantic Jailbreak

🎓 [Official](https://aclanthology.org/2026.findings-acl.1096/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`attack`、`MSIA`、`medical multimodal dialogue`、`cumulative semantic drift`、`multi-turn jailbreak`

👤 **作者**：Zhiheng Han、Yao Zhang、Jun Wang、Zhenglu Yang

- 🎯 **研究动机**：临床多轮对话中语义漂移可累积夸大或掩盖关键医学发现而不触发安全机制，现有评测忽视该失效
- 🔬 **研究方法**：MSIA 以自适应策略选择与医学证据闭环奖励，在隐身约束下优化累积语义漂移，攻击胸片多模态医疗对话
- 📌 **结论**：对 GPT-4o、Claude 等模型的攻击效果持续超越现有越狱方法
...
### 26. Pattern Enhanced Multi-Turn Jailbreaking: Exploiting Structural Vulnerabilities in Large Language Models

🎓 [Official](https://aclanthology.org/2026.findings-acl.1113/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`attack`、`PE-CoA`、`multi-turn jailbreak`、`conversation pattern`、`structural vulnerability`

👤 **作者**：Ragib Nihal、Rui Wen、Kazuhiro Nakadai、Jun Sakuma

- 🎯 **研究动机**：多轮越狱的对话模式与模型脆弱性的关系缺乏系统理解，已有方法依赖启发式探索
- 🔬 **研究方法**：PE-CoA 定义五种对话模式在自然对话中构造多轮攻击，覆盖 12 个 LLM、10 类危害
- 📌 **结论**：取得 SOTA 攻击效果，揭示各危害类别下模式特异的弱点画像
...
### 29. Steering Away from Refusal: A Black-box Jailbreak Method Based on First-Token Distribution

🎓 [Official](https://aclanthology.org/2026.findings-acl.1294/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`attack`、`first-token distribution`、`refusal signal leakage`、`black-box jailbreak`、`logprob exposure`

👤 **作者**：Shuangjie Fu、Du Su、Xin Chen、Fei Sun、Huawei Shen、Xueqi Cheng

- 🎯 **研究动机**：黑盒越狱缺梯度信号，模型静态拒答使 PAIR、TAP 类输出反馈失效，开放部分 logprobs 的风险未被评估
- 🔬 **研究方法**：发现拒答在首个生成 token 上呈一致分布模式，据此构建攻击以区分并绕开拒答
- 📌 **结论**：首 token 分布泄露拒答信号，可引导有效黑盒越狱
...
### 30. Safety Guardrails of Large Language Models Are Vulnerable to Value-Driven Adversarial Prompting

🎓 [Official](https://aclanthology.org/2026.findings-acl.1357/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`attack`、`VDJA`、`value-driven adversarial prompting`、`moral endorsement exploitation`、`implicit token prior`

👤 **作者**：Xiaohao Luo、Ying Wei、Zhijun Li

- 🎯 **研究动机**：LLM 倾向附和人类，诱导其肯定有害任务的道德价值可能从内部瓦解安全护栏
- 🔬 **研究方法**：VDJA 先诱导模型背书任务价值，价值认同 token 在自回归中形成隐式先验，促使模型接受并生成有害内容
- 📌 **结论**：单次查询且不伪装指令，JailbreakBench ASR 91.8%、AdvBench 子集 95.2%
...
### 31. Jailbreaking Large Language Models with Morality Attacks

🎓 [Official](https://aclanthology.org/2026.findings-acl.1461/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`attack`、`morality attack`、`value ambiguity`、`moral judgment manipulation`、`guardrail model failure`

👤 **作者**：Ying Su、Zheng Mingen、Weili Diao、Haoran Li

- 🎯 **研究动机**：多元价值对齐下，LLM 面对道德争议内容生成鲁棒性缺少系统检验
- 🔬 **研究方法**：构建 10.4K 道德数据集（价值歧义与价值冲突两类），形式化四种对抗攻击操纵道德判断，同时评估 LLM 与护栏模型
- 📌 **结论**：现有模型与护栏在价值操纵攻击下大面积失守
...
### 32. STAR-Teaming: A Strategy-Response Multiplex Network Approach to Automated LLM Red Teaming

🎓 [Official](https://aclanthology.org/2026.findings-acl.1470/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`attack`、`STAR-Teaming`、`automated red teaming`、`strategy-response multiplex network`、`semantic community search`

👤 **作者**：Min Jung、YongTaek Lim、Chaeyun Kim、Junghwan Kim、Kihyun Kim、Minwoo Kim

- 🎯 **研究动机**：自动红队在高维策略空间搜索低效，且难以解释模型策略性弱点
- 🔬 **研究方法**：STAR-Teaming 结合多智能体系统与 Strategy-Response Multiplex Network，按语义社区组织搜索避免重复探索
- 📌 **结论**：越狱效果超越已有黑盒红队，并输出可解释的策略性弱点
...
### 33. Incomplete Prompt Jailbreaks in Large Language Models

🎓 [Official](https://aclanthology.org/2026.findings-acl.1567/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`analysis`、`incomplete prompt jailbreak`、`refusal delay`、`attractor analysis`、`neuron-level intervention`

👤 **作者**：Yeonjea Kim、Bumjin Park、Jaesik Choi

- 🎯 **研究动机**：开放权重模型的句子补全模式对未说完的有害句子缺乏防线，该现象从未被形式化
- 🔬 **研究方法**：定义 incomplete prompt jailbreak，分析吸引子类型与拒答延迟，定位终止与续写两类功能神经元
- 📌 **结论**：LLM 系统性推迟拒答到句末，参数微调难跨域泛化，需神经元级干预
...
### 34. Chimera: Compositional Jailbreak Attacks on LLMs via Judgment-Driven Search over Heterogeneous Strategies

🎓 [Official](https://aclanthology.org/2026.findings-acl.1667/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`attack`、`Chimera`、`compositional jailbreak`、`judgment-driven search`、`heterogeneous strategy composition`

👤 **作者**：Leo Park、Juwon Cho、Gyuhwan Kim、YoonDong Yeo、Taekyoung Kwon

- 🎯 **研究动机**：自动红队多孤立探索同质变换，且脆弱判分把非拒答幻觉误判为攻击成功
- 🔬 **研究方法**：Chimera 把越狱重构为判分驱动的组合搜索，在排序约束下组合混淆、语义说服等异质原语
- 📌 **结论**：组合攻击优于单一变换，且攻击判定更可靠
...
### 35. How Do LLMs “Trust” Unknown Knowledge? An Unknown Knowledge Based Jailbreak Attack

🎓 [Official](https://aclanthology.org/2026.findings-acl.1849/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`attack`、`unknown knowledge jailbreak`、`trust-enhancing transformation`、`ICL and RAG injection`、`fully randomized attack`

👤 **作者**：Yixiao Huang、Lan Zhang、Chaoran Wang

- 🎯 **研究动机**：LLM 经 ICL/RAG 信任并采纳未知知识的机制不明，埋下可利用的安全风险
- 🔬 **研究方法**：设计五组信任增强/削弱变换定位关键信任因子，将恶意查询嵌入信任增强的未知知识实施全随机化越狱
- 📌 **结论**：有/无防御场景下 99%-100% ASR，覆盖 GPT-5.1 等模型，达 SOTA 且难以防御
...
### 36. TinyAttack: Exploring Stylistic Vulnerabilities in Large Language Models

🎓 [Official](https://aclanthology.org/2026.findings-acl.1987/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`attack`、`TinyAttack`、`stylistic perturbation`、`font-size manipulation`、`safety filter bypass`

👤 **作者**：Mamta Mamta、Bogdan Grecu、Oana Cocarascu

- 🎯 **研究动机**：社交媒体盛行样式化字符，其对 LLM 的扰动脆弱性被既有研究忽视
- 🔬 **研究方法**：TinyAttack 以小号字体等样式化字符构造对抗输入，系统检验 LLM 与安全过滤的稳健性
- 📌 **结论**：细微样式变化即可在保持语义下误导模型输出并绕过安全机制，暴露字体级漏洞
...
### 37. Dictionary Guided Sparse Logit Editing for Reliable Jailbreak Attacks

🎓 [Official](https://aclanthology.org/2026.findings-acl.2137/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`attack`、`SIBI`、`sparse logit editing`、`gradient-free white-box attack`、`dictionary-guided token reward`

👤 **作者**：Shuaibiao Han、Ruiyang Ni、Zhiyu Yi、Changlong Li、Perley Xu、Wenjie Ruan

- 🎯 **研究动机**：梯度类越狱昂贵且不可解释，现有 logit 攻击依赖繁琐辅助模型
- 🔬 **研究方法**：SIBI 免梯度白盒攻击：以对齐分词器的奖惩 token 词典稀疏编辑 pre-softmax logits，配温度一致缩放与混合范数信赖域
- 📌 **结论**：标准基准上高 ASR 同时大幅降低计算与空间开销
...
### 38. Logic Jailbreak: Efficiently Unlocking LLM Safety Restrictions Through Formal Logical Expression

🎓 [Official](https://aclanthology.org/2026.findings-acl.25/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`attack`、`LogiBreak`、`formal logical expression`、`multilingual jailbreak`、`distribution gap exploitation`

👤 **作者**：Jingyu Peng、…、Xiangyu Zhao

- 🎯 **研究动机**：对齐数据与逻辑表达输入间的分布差可被利用绕过安全机制
- 🔬 **研究方法**：LogiBreak 将有害自然语言提示转译为形式逻辑表达实施黑盒越狱，并构建多语言逻辑表达越狱数据集
- 📌 **结论**：五种语言上均验证有效且泛化性好
...
### 39. StructBreak: Structural Cognitive Overload-Induced Safety Failures in MLLMs

🎓 [Official](https://aclanthology.org/2026.findings-acl.293/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`attack`、`StructBreak`、`structural cognitive overload`、`MLLM jailbreak`、`attention interpretability`

👤 **作者**：Yang Luo、Liu Xinran、TianTian Ji、Zhiyi Yin、Lingyun Peng、Shuyu Li

- 🎯 **研究动机**：深层结构推理与安全对齐相争导致结构一致性脆弱，此前攻击局限于排版与像素扰动
- 🔬 **研究方法**：StructBreak 端到端自动生成结构认知过载（SCO）输入，黑盒无需模型内部访问，覆盖十类威胁场景并做注意力与隐空间解释
- 📌 **结论**：六个领先 MLLM 平均 ASR 92%（Gemini 2.5 达 97%），揭示绕过安全过滤的结构性通道
...
### 40. Knowing-but-Doing: Diagnosing and Defending Role-Play-Driven LLMs Jailbreaks via Moral Disengagement

🎓 [Official](https://aclanthology.org/2026.findings-acl.349/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`analysis`、`role-play jailbreak`、`moral disengagement`、`MD-Trace diagnosis`、`introspective defense`

👤 **作者**：Haiming Qin、Jianxun Lian、Qimin Zhong、Mingyang Zhou、Hao Liao、Naipeng Chao

- 🎯 **研究动机**：角色扮演情境下 LLM 安全失效的心理机制缺乏解释性框架
- 🔬 **研究方法**：以 Bandura 道德脱离理论构建 MD-Trace 诊断基准，剖析思维链中知而不拒的失效并提出内省式防御 MD-Shield
- 📌 **结论**：恶意人设增加危险顺从、道德合理化为主导机制；MD-Shield 降低 ASR 且保持角色忠实
...
### 41. Three Minds, One Legend: Jailbreak Large Reasoning Model with Adaptive Stacked Ciphers

🎓 [Official](https://aclanthology.org/2026.findings-acl.355/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`attack`、`SEAL`、`stacked cipher pipeline`、`LRM jailbreak`、`adaptive encryption`

👤 **作者**：Nguyen Anh、…、Anh Luu

- 🎯 **研究动机**：更强推理能力是否引入更严重安全漏洞缺乏探索，既有越狱难抗自适应对齐
- 🔬 **研究方法**：SEAL 以自适应堆叠加密管线压制 LRM 推理过程，随机与自适应策略动态调整密码长度、顺序与组合
- 📌 **结论**：对 GPT-o4-mini ASR 达 85.6%，并在 DeepSeek-R1、Claude 等模型验证
...
### 42. Conflicts Make Large Reasoning Models Vulnerable to Attacks

🎓 [Official](https://aclanthology.org/2026.findings-acl.463/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`analysis`、`value conflict jailbreak`、`large reasoning models`、`dilemma prompts`、`representation overlap`

👤 **作者**：Honghao Liu、…、Jian Guo

- 🎯 **研究动机**：LRM 在冲突目标下的决策与安全脆弱性缺乏理解
- 🔬 **研究方法**：构造内部价值冲突与牺牲/胁迫/智能体中心/社会四类困境共 1300+ 提示，跨五基准评测三个 LRM 并做逐层与神经元分析
- 📌 **结论**：冲突显著提升 ASR（单轮非叙述查询即可），安全与功能表示发生偏移重叠
...
### 43. Hard to Read, Easy to Jailbreak: How Visual Degradation Bypasses MLLM Safety Alignment

🎓 [Official](https://aclanthology.org/2026.findings-acl.983/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`cognitive overload`、`visual degradation`、`structured offloading`

👤 **作者**：Zhixue Song、Boyan Han、Yiwei Wang、Chi Zhang

- 🎯 **研究动机**：针对低分辨率视觉压缩为何在文字仍可读时削弱安全的问题
- 🔬 **研究方法**：论文把失效解释为 Cognitive Overload 并提出 Structured Cognitive Offloading 分离转写与安全判断
- 📌 **结论**：结果该串行流程能缓解多种噪声和几何退化造成的越狱
...
### 44. Silencing the Guardrails: Inference-Time Jailbreaking via Dynamic Contextual Representation Ablation

📄 [arXiv](https://arxiv.org/abs/2604.07835) · 🎓 [Official](https://aclanthology.org/2026.findings-acl.211/)　📅 2026-04　🏷 ACL 2026 Findings
...
- 🎯 **研究动机**：研究 inference-time attack、representation ablation 场景下的攻击面，重点考察 refusal subspace 如何影响目标模型或系统
- 🔬 **研究方法**：无需权重更新即可削弱多个安全对齐开放模型的拒答
- 📌 **结论**：结果表明只依赖脆弱潜在方向的内置 guard 可被局部表征干预绕过
...
### 45. Jailbreaking Attacks vs. Content Safety Filters: How Far Are We in the LLM Safety Arms Race?

📄 [arXiv](https://arxiv.org/abs/2512.24044) · 🎓 [Official](https://aclanthology.org/2026.findings-acl.20/)　📅 2025-12　🏷 ACL 2026 Findings
...
- 🎯 **研究动机**：论文把 jailbreak 从只攻击基础模型的设置扩展到包含输入与输出 filter 的完整部署流水线
- 🔬 **研究方法**：系统比较攻击能否穿过每一层
- 📌 **结论**：结果表明既有研究可能高估实际穿透率，但 filter 的 recall、precision 与用户体验仍需共同优化
...
### 46. A Lightweight Explainable Guardrail for Prompt Safety
...
### 47. Beyond Surface-Level Detection: Towards Cognitive-Driven Defense Against Jailbreak Attacks via Meta-Operations Reasoning
...
### 48. CachePrune: Teaching LLMs What Not to Follow via KV-Cache Editing
...
### 49. CrossGuard: Safeguarding MLLMs against Joint-Modal Implicit Malicious Attacks
...
### 50. Defenses Against Prompt Attacks Learn Surface Heuristics
...
### 51. Leave My Images Alone: Preventing Multi-Modal Large Language Models from Analyzing Images via Visual Prompt Injection
...
### 52. LLM-VA: Resolving the Jailbreak-Overrefusal Trade-off via Vector Alignment
...
### 53. PIArena: A Platform for Prompt Injection Evaluation
...
### 54. Rethinking Jailbreak Detection of Large Vision Language Models with Representational Contrastive Scoring
...
### 55. Retrieval-Augmented Defense: Adaptive and Controllable Jailbreak Prevention for Large Language Models
...
### 56. SafetyMem: Adaptive Jailbreak Defense via Dual-Component Safety Memory
...
### 59. VLMGuard-R1: Proactive Safety Alignment for VLMs via Reasoning-Driven Prompt Optimization

🎓 [Official](https://aclanthology.org/2026.findings-acl.1986/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`VLMGuard-R1`、`reasoning-driven prompt rewriting`、`image-text interaction risk`、`parameter-free safeguard`

👤 **作者**：Menglan Chen、Xianghe Pang、Jingjing Dong、WenHao Wang、Yaxin Du、Siheng Chen

- 🎯 **研究动机**：图文交互产生单模态护栏难察觉的细微威胁，通用拒答损害可用性
- 🔬 **研究方法**：VLMGuard-R1 以推理引导重写器动态解读图文交互并改写输入，三阶段推理管线合成训练数据，不改模型参数
- 📌 **结论**：跨六个 VLM 优于四种基线，SIUO 基准上平均安全性提升 43.59%
...
### 60. Defending LLMs against Jailbreak Attacks via Template-Based ICL with a Defensive Suffix

🎓 [Official](https://aclanthology.org/2026.findings-acl.2123/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`defensive suffix`、`in-context learning defense`、`template-based assembly`、`negligible overhead`

👤 **作者**：Ruiyang Ni、Changlong Li、Shuaibiao Han、Zhiyu Yi、Perley Xu、Wenjie Ruan

- 🎯 **研究动机**：既有越狱防御依赖微调或启发式设计，耗时或效果有限
- 🔬 **研究方法**：离线迭代优化防御后缀，在线随机搜索选取最有效 ICL 示例，与原指令按模板组装结构化输入
- 📌 **结论**：对白盒黑盒高级攻击将 ASR 降至近 0%，良性任务效用不变且开销可忽略
...
### 61. Guardian-as-an-Advisor: Advancing Next-Generation Guardian Models for Trustworthy LLMs

🎓 [Official](https://aclanthology.org/2026.findings-acl.292/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`GaaA`、`guardian-as-an-advisor`、`soft gating`、`over-refusal reduction`

👤 **作者**：Yue Huang、…、Xiangliang Zhang

- 🎯 **研究动机**：硬门控安全检查器过度拒绝且偏离厂商 model spec，既有分类体系忽视鲁棒性与诚实性
- 🔬 **研究方法**：GaaA 软门控：守护模型输出风险标签与简短解释并前置到原查询再推理；以 20.8 万样本 GuardSet 训练 GuardAdvisor（SFT+RL）
- 📌 **结论**：检测准确率具竞争力且降低过度拒绝，守护推理仅占基模型算力 5% 以下
...
### 62. Robustness via Referencing: Defending against Prompt Injection Attacks by Referencing the Executed Instruction

🎓 [Official](https://aclanthology.org/2026.findings-acl.61/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`instruction referencing`、`prompt injection defense`、`output provenance filtering`、`instruction-following exploitation`

👤 **作者**：Yulin Chen、…、Bryan Hooi

- 🎯 **研究动机**：提示注入利用 LLM 无法区分原始与注入指令的缺陷，压制指令跟随倾向的防御收效有限
- 🔬 **研究方法**：顺势利用指令跟随：让模型回答时附注所执行的指令引用，过滤引用非原始指令的答案
- 📌 **结论**：综合实验验证对提示注入攻击的有效防御
...
### 63. Health-ORSC-Bench: A Benchmark for Measuring Over-Refusal and Safety Completion in Health Context

🎓 [Official](https://aclanthology.org/2026.findings-acl.1177/)　📅 2026-07　🏷 ACL 2026 Findings
...
- 🎯 **研究动机**：针对医疗边界请求不能只用 refuse/comply 二分评测
- 🔬 **研究方法**：30 个模型的结果显示安全优化模型在困难样本上可出现高达 80% 的误拒
- 📌 **结论**：Health-ORSC-Bench 提供七类 31,920 个良性边界 prompt 并测量 safe completion
...
### 64. Apertus: Democratizing Open and Compliant LLMs for Global Language Environments
...
### 66. Beyond Static Benchmarks: Synthesizing Harmful Content via Persona-based Simulation for Robust Evaluation
...
### 67. COMPASS: A Framework for Evaluating Organization-Specific Policy Alignment in LLMs
...
### 68. Emergent Misalignment via In-Context Learning: Narrow in-context examples can produce broadly misaligned LLMs
...
### 69. EthicMind: A Risk-Aware Framework for Ethical-Emotional Alignment in Multi-Turn Dialogue
...
### 70. HarmRLVR: Weaponizing Verifiable Rewards for Harmful LLM Alignment
...
### 71. How Should We Enhance the Safety of Large Reasoning Models: An Empirical Study
...
### 72. Interpretable Safety Alignment via SAE-Constructed Low-Rank Subspace Adaptation
...
### 73. Into the Gray Zone: Domain Contexts Can Blur LLM Safety Boundaries
...
### 74. Inverting the Shield: Systematically Generating Safety Tests from Policy Specifications
...
### 75. Knowing When Not to Answer: Lightweight KB-Aligned OOD Detection for Safe RAG
...
### 76. Knowledge without Wisdom: Measuring Misalignment between LLMs and Intended Impact
...
### 77. LASA: Language-Agnostic Semantic Alignment at the Semantic Bottleneck for LLM Safety
...
### 78. More Thinking, Less Talking: Internalizing Deliberative Safety into LLM Parameters
...
### 79. PAM: Enhancing General Alignment of Large Reasoning Models through Priority-Aware Metacognition
...
### 80. Projecting Out the Malice: A Global Subspace Approach to LLM Detoxification
...
### 81. Provably Safe Offline-to-Online RL: Decoupling Learning from Data-Driven Safety Enforcement
...
### 82. Psychological Steering in LLMs: An Evaluation of Effectiveness and Trustworthiness
...
### 83. Reasoning Hijacking: The Fragility of Reasoning Alignment in Large Language Models
...
### 84. Reasoning over Precedents Alongside Statutes: Case-Augmented Deliberative Alignment for LLM Safety
...
### 85. Reasoning Structure Matters for Safety Alignment of Reasoning Models
...
### 86. Resolving the Security-Auditability Dilemma with Auditable Latent Chain-of-Thought Alignment
...
### 87. SafeMT: Multi-turn Safety for Multimodal Language Models
...
### 88. Safety-Utility Conflicts Are Not Global: Surgical Alignment via Head-Level Diagnosis
...
### 89. SAME: Safety-Aware Model Editing Guided by Safety Transformation
...
### 90. Teach a Reward Model to Correct Itself: Reward Guided Adversarial Failure Discovery for Robust Reward Modeling
...
### 91. The “Knowledge–Behavior Gap” in Cultural Taboo Safety of Large Language Models
...
### 92. The Side Effects of Being Smart: Safety Risks in MLLMs’ Multi-Image Reasoning
...
### 93. TriPlay-RL: Tri-Role Self-Play Reinforcement Learning for LLM Safety Alignment
...
### 94. Understanding Emergent Misalignment via Feature Superposition Geometry
...
### 95. When Efficiency Meets Safety: A Benchmark Security Analysis of KV Cache Compression in Large Language Models
...
🎓 [Official](https://aclanthology.org/2026.findings-acl.1118/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`self-jailbreak`、`large reasoning models`、`Chain-of-Guardrail`、`trajectory-level training`

👤 **作者**：Yingzhi Mao、…、Le Sun

- 🎯 **研究动机**：大推理模型先识别有害意图又在后续推理中推翻判断（Self-Jailbreak），粗粒度约束难治根因且伤推理
- 🔬 **研究方法**：定位该失效模式后提出 Chain-of-Guardrail 轨迹级训练，只针对不安全推理步施加护栏
- 📌 **结论**：缓解自越狱同时保持推理能力
...
### 97. Simple Role Assignment is Extraordinarily Effective for Safety Alignment

🎓 [Official](https://aclanthology.org/2026.findings-acl.1164/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`role assignment alignment`、`Theory of Mind`、`training-free safety`、`role-conditioned generation`

👤 **作者**：Zhou Ziheng、…、Junqi Wang

- 🎯 **研究动机**：原则式对齐缺情境敏感性与完备性，需要紧凑的替代范式
- 🔬 **研究方法**：基于 Theory of Mind 用社会角色隐式编码价值与认知图式，角色条件生成器加迭代角色评论员的免训练流水线
- 📌 **结论**：DeepSeek-V3 在 WildJailbreak 的不安全输出从 81.4% 降至 3.6%，且适用于智能体安全任务
...
### 98. V-RoLoRA: RLVR-Driven MoE Routing for Steerable Pluralistic Alignment

🎓 [Official](https://aclanthology.org/2026.findings-acl.1377/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`V-RoLoRA`、`pluralistic alignment`、`MoE value routing`、`RLVR-verifiable reward`

👤 **作者**：Jing Wang、Yaomin Wu、Yinglin Wang、Yitong Yang

- 🎯 **研究动机**：提示工程式价值控制脆弱且不持久，多维组合价值难以可靠遵循
- 🔬 **研究方法**：V-RoLoRA 以条件门控在多个 LoRA 专家间路由价值或道德向量，并用 RLVR 可验证奖励约束输出合规
- 📌 **结论**：提示被扰动或省略时仍保持目标价值的行为控制
...
### 99. Multilingual Refusal Alignment for Safer Large Language Models

🎓 [Official](https://aclanthology.org/2026.findings-acl.1537/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`RefusEU`、`multilingual refusal alignment`、`cross-lingual safety transfer`、`controlled DPO`

👤 **作者**：Aleksandra Krasnodębska、Wojciech Kusa、Aldo Lipani

- 🎯 **研究动机**：安全行为跨语言不一致，单语对齐能否迁移到其他语言缺乏系统证据
- 🔬 **研究方法**：发布覆盖 12 种欧洲语言的 RefusEU 拒绝对齐数据集与专用测试集，做受控 DPO 实验
- 📌 **结论**：仅英语对齐不足以保证跨语言安全，需多语拒绝对齐
...
### 100. The Art of (Mis)alignment: How Fine-Tuning Methods Effectively Misalign and Realign LLMs in Post-Training

🎓 [Official](https://aclanthology.org/2026.findings-acl.164/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`analysis`、`fine-tuning misalignment`、`realignment recovery`、`SFT versus preference tuning`、`attack-defense asymmetry`

👤 **作者**：Rui Zhang、…、Yang Zhang

- 🎯 **研究动机**：攻击者可借微调瓦解安全对齐并在开放平台散布错配模型，再对齐缺乏系统比较
- 🔬 **研究方法**：在 4 个安全对齐 LLM 上评估 4 种 SFT 与 2 种偏好微调的错配、再对齐效果及交互
- 📌 **结论**：揭示攻防间的机制不对称，不同微调方法在两方向上差异显著
...
### 101. Value Alignment Tax: Measuring Value Trade-offs in LLM Alignment

🎓 [Official](https://aclanthology.org/2026.findings-acl.1749/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`analysis`、`value alignment tax`、`Schwartz value theory`、`value trade-off measurement`、`cascading value shift`

👤 **作者**：Jiajun Chen、Hua Shen

- 🎯 **研究动机**：对齐干预会隐式重塑整个价值体系，这种价值间的连锁权衡从未被度量
- 🔬 **研究方法**：VAT 基于 Schwartz 价值理论构建情景-动作数据，比较干预前后的规范判断，按目标增益刻画价值体系级涟漪
- 📌 **结论**：对齐单一价值会带来可测量的连锁价值偏移
...
### 102. SAFER: Advancing Safety Alignment via Efficient Ex-Ante Reasoning

🎓 [Official](https://aclanthology.org/2026.findings-acl.1808/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`SAFER`、`ex-ante reasoning`、`step-level preference optimization`、`verifiable safety rules`

👤 **作者**：Kehua Feng、…、Huajun Chen

- 🎯 **研究动机**：已有对齐方法难覆盖多样安全场景且易受对抗攻击
- 🔬 **研究方法**：SAFER 以初始评估、规则校验与路径校准的 Ex-Ante 推理两阶段训练：SFT 学推理轨迹，步级偏好优化强化
- 📌 **结论**：嵌入可验证安全规则后兼顾安全性与对抗鲁棒性
...
### 103. Understanding Conflicts in Multi-Objective Alignment through Reward Consistency

🎓 [Official](https://aclanthology.org/2026.findings-acl.269/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`analysis`、`reward consistency`、`multi-objective alignment`、`helpfulness-harmlessness conflict`、`data-level inconsistency`

👤 **作者**：Zhihao Xu、Yongqi Tong、Xin Zhang、Jun Zhou、Xiting Wang

- 🎯 **研究动机**：多目标对齐中 helpfulness 与 harmlessness 的冲突源于数据内在不一致，算法侧方案未触及根因
- 🔬 **研究方法**：提出 Reward Consistency 准则并证明满足 RC 的样本才能同时改进全部目标，据此采样构造成对数据并附松弛策略
- 📌 **结论**：同时优化下两目标平均提升 23.07%
...
### 104. Safety Is Not Universal: The Selective Safety Trap in LLM Alignment

🎓 [Official](https://aclanthology.org/2026.findings-acl.489/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`benchmark`、`MiJaBench`、`selective safety`、`minority group protection disparity`、`targeted DPO`

👤 **作者**：Iago Brito、Walcy Rios、Julia Dollis、Diogo Silva、Arlindo Galvão Filho

- 🎯 **研究动机**：聚合式安全评测制造普遍防护假象，掩盖对不同人群防护的巨大差异
- 🔬 **研究方法**：构建 MiJaBench 双语对抗越狱基准（43961 提示、16 少数群体）评测 14 个 LLM，并对 1B 基线做定向 DPO
- 📌 **结论**：同模型防御率随目标群体波动达 42%；定向 DPO 实现零样本泛化的安全提升
...
### 105. Self-Reflection Improves Safety of Large Reasoning Models

🎓 [Official](https://aclanthology.org/2026.findings-acl.678/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`self-reflection token`、`large reasoning models`、`harmful output recovery`、`post-training integration`

👤 **作者**：Qiang Huang、Wei Zhai、Feng Huang、Dejing Dou

- 🎯 **研究动机**：既有对齐停留在浅层防护，难应对复杂推理中的深层风险与策略性攻击
- 🔬 **研究方法**：引入特殊 Self-Reflection token 使 LRM 生成中自我反思并从有害输出恢复，无缝融入标准后训练范式
- 📌 **结论**：HCR 由 13.8% 降至 4.1%，安全-帮助性平衡兼优且在多种对抗攻击下稳健
...
### 106. You Only Need One Single Token to Refine Safety Alignment

🎓 [Official](https://aclanthology.org/2026.findings-acl.662/)　📅 2026-07　🏷 ACL 2026 Findings
...
- 🎯 **研究动机**：针对 training-free 校准推理开销高而全量微调成本大
- 🔬 **研究方法**：STA 冻结基座模型并只优化一个约 4,096 参数的 prefix token
- 📌 **结论**：结果跨 LLM、MLLM 和 reasoning model 改善安全—帮助性平衡
...
### 107. AHA: Aligning Large Audio-Language Models for Reasoning Hallucinations via Counterfactual Hard Negatives

🎓 [Official](https://aclanthology.org/2026.findings-acl.1464/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`audio hallucination`、`counterfactual hard negative`、`AHA-Eval`

👤 **作者**：Yanxi Chen、…、Yalin Wang

- 🎯 **研究动机**：针对 LALM 生成未被音频证据支持的事件、身份、时序和数量信息
- 🔬 **研究方法**：AHA 用 counterfactual hard negative 构造偏好数据并建立 AHA-Eval
- 📌 **结论**：Qwen-Audio-AHA 在该基准提升 13.7%，且在 MMAU-Test 与 MMAR 上也获得增益
...
### 108. Continual Safety Alignment via Gradient-Based Sample Selection

🎓 [Official](https://aclanthology.org/2026.findings-acl.942/)　📅 2026-04　🏷 ACL 2026 Findings

**关键词**：`defense`、`fine-tuning data`、`continual alignment`、`gradient selection`

👤 **作者**：Thong Bach、Dung Nguyen、Thao Le、Truyen Tran

- 🎯 **研究动机**：针对持续微调中的安全遗忘
- 🔬 **研究方法**：论文依据样本梯度对安全目标的贡献选择训练数据
- 📌 **结论**：结果以较低额外成本维持安全性，并减少对通用能力的影响
...
### 109. Towards Identification and Intervention of Safety-Critical Parameters in Large Language Models

🎓 [Official](https://aclanthology.org/2026.findings-acl.1616/)　📅 2026-04　🏷 ACL 2026 Findings

**关键词**：`analysis`、`harmful fine-tuning`、`safety parameters`、`parameter intervention`

👤 **作者**：Weiwei Qi、…、Kui Ren

- 🎯 **研究动机**：针对不同架构的安全能力由哪些参数承载尚不清楚
- 🔬 **研究方法**：论文用 ESI 定位安全关键参数并提出 SET 与 SPA 干预
- 📌 **结论**：结果能针对性保护安全权重并降低微调后的风险
...
### 110. Be Your Own Red Teamer: Safety Alignment via Self-Play and Reflective Experience Replay

📄 [arXiv](https://arxiv.org/abs/2601.10589) · 🎓 [Official](https://aclanthology.org/2026.findings-acl.933/)　📅 2026-01　🏷 ACL 2026 Findings

**关键词**：`defense`、`self-play alignment`、`reflective replay`、`adaptive red teaming`

👤 **作者**：Hao Wang、Yanting Wang、Hao Li、Rui Li、Lei Sha

- 🎯 **研究动机**：针对 defense 容易过拟合已知攻击模板
- 🔬 **研究方法**：论文让同一模型在强化学习循环中交替扮演 attacker 与 defender
- 📌 **结论**：结果动态演化攻击的同时增强对新 jailbreak 的拒答泛化
...
### 111. SafeMERGE: Preserving Safety Alignment in Fine-Tuned Large Language Models via Selective Layer-Wise Model Merging

📄 [arXiv](https://arxiv.org/abs/2503.17239) · 🎓 [Official](https://aclanthology.org/2026.findings-acl.1761/)　📅 2025-03　🏷 ACL 2026 Findings

**关键词**：`defense`、`harmful fine-tuning`、`model merging`、`layer selection`

👤 **作者**：Aladin Djuhera、Swanand Kadhe、Farhan Ahmed、Syed Zawad、Holger Boche

- 🎯 **研究动机**：针对 LoRA 任务适配器在部分层偏离安全子空间
- 🔬 **研究方法**：论文定位这些层并只与安全适配器选择性合并
- 📌 **结论**：结果恢复对齐，同时保留大部分下游性能
...
### 113. Can LLM Safety Be Ensured by Constraining Parameter Regions?
...
### 114. Detecting What Queries Seek: Steering LLM Safety with FFN Output Activation Monitoring
...
### 115. Embracing Anisotropy: Turning Massive Activations into Interpretable Control Knobs for Large Language Models
...
### 116. LLM Safety From Within: Detecting Harmful Content with Internal Representations
...
### 117. Mitigating Over-Refusal in Aligned Large Language Models via Inference-Time Activation Energy
...
### 118. Mitigating Safety Context Amnesia in Multimodal Reasoning Models via Intent-Guided Safety Reasoning
...
### 119. Please refuse to answer me! Mitigating Over-Refusal in Large Language Models via Adaptive Contrastive Decoding
...
### 120. Probing the Safety Robustness of LLMs in Latent Space
...
### 121. Pruning Unsafe Tickets: A Resource-Efficient Framework for Safer and More Robust LLMs
...
### 122. SafeConstellations: Mitigating Over-Refusals in LLMs Through Task-Aware Representation Steering
...
### 123. ReCon: Active Defense against Large Vision-Language Model Jailbreaks via Reverse Safety Concept Injection

🎓 [Official](https://aclanthology.org/2026.findings-acl.1173/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`ReCon`、`LVLM jailbreak defense`、`diffusion image purification`、`reverse safety concept injection`

👤 **作者**：Zheng He、Yiwei Wang、Hongxing Wang、Yujun Cai

- 🎯 **研究动机**：已有防御忽视视觉威胁、缺攻击语义特异性且无专用检测，导致对良性输入误伤
- 🔬 **研究方法**：ReCon 用扩散图像净化消除视觉扰动、自编码检测器过滤异常，再以逆向安全概念注入生成定向修正提示
- 📌 **结论**：多模态越狱防御有效且对良性输入侵入更小
...
### 124. Reward Yourself: Efficient Self Rewards for Trustworthy Sampling

🎓 [Official](https://aclanthology.org/2026.findings-acl.1554/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`SelfRW`、`self-reward signal`、`trustworthy sampling`、`token distribution pruning`、`reward-guided decoding`

👤 **作者**：Mingjie Li、Wai Si、Michael Backes、Yang Zhang

- 🎯 **研究动机**：奖励模型难以阻止隐私泄漏与刻板印象等不可信输出，重训代价又高
- 🔬 **研究方法**：SelfRW 对同一 LLM 剪枝近似 trust 与 untrust 两种 token 分布，以对数概率差作免微调辅助奖励
- 📌 **结论**：奖励引导采样显著减少不可信输出且不损任务性能
...
### 125. Cognitive Analysis Graph-Guided Multi-Turn Safety Enhancement for Large Language Models

🎓 [Official](https://aclanthology.org/2026.findings-acl.1558/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`CogGSE`、`cognitive analysis graph`、`multi-turn safety enhancement`、`question-specific retrieval`

👤 **作者**：Lanxue Zhang、Yuqiang Xie、Fang Fang、Yubing Ren、Xuebin Wang、Yanan Cao

- 🎯 **研究动机**：推理期安全方法忽视问答关联、难适配防御指令且不会利用对话历史
- 🔬 **研究方法**：CogGSE 用结构化认知分析图建模解题过程，检索问题专属图定制安全信息以引导安全响应
- 📌 **结论**：多轮对话中提升安全性并保持推理表现
...
### 126. Neuronal Insights into LLM Attacks: Targeted Neuron Tuning for Precise and Robust Vulnerability Patching

🎓 [Official](https://aclanthology.org/2026.findings-acl.1719/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`targeted neuron tuning`、`similarity gradient attribution`、`vulnerability patching`、`neuron-level repair`

👤 **作者**：Dan Shi、…、Deyi Xiong

- 🎯 **研究动机**：开放生成场景无固定输出，既有梯度归因难以定位对抗脆弱性相关的关键神经元
- 🔬 **研究方法**：提出相似度梯度归因在开放生成中找 targeted neurons，按两类神经元模式做精准调节修补
- 📌 **结论**：神经元级修补比粗粒度干预更精准且鲁棒
...
### 127. Analysing the Safety Pitfalls of Steering Vectors

🎓 [Official](https://aclanthology.org/2026.findings-acl.544/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`analysis`、`steering vectors`、`CAA audit`、`jailbreak susceptibility shift`、`refusal subspace overlap`

👤 **作者**：Yuxiao Li、Alina Fastowski、Efstratios Zaradoukas、Bardh Prenkaj、Gjergji Kasneci

- 🎯 **研究动机**：激活转向的脆弱性已有记录，但对越狱攻击成功率的影响缺乏系统审计
- 🔬 **研究方法**：统一评测协议下审计 CAA 转向向量对 jailbreak ASR 的作用，跨模型家族与规模并溯源机制
- 📌 **结论**：特定方向转向可使 ASR 升 57% 或降 50%，源于与拒答行为隐子空间重叠，揭示可控性-安全权衡
...
### 128. SafeSteer: A Decoding-level Defense Mechanism for Multimodal Large Language Models

📄 [arXiv](https://arxiv.org/abs/2605.11716) · 🎓 [Official](https://aclanthology.org/2026.findings-acl.916/)　📅 2026-05　🏷 ACL 2026 Findings

**关键词**：`defense`、`decoding steering`、`harmful tendency`、`token intervention`

👤 **作者**：Xinyi Zeng、…、Yu Tian

- 🎯 **研究动机**：针对重新微调 MLLM 成本高且 post-hoc filter 只能在有害内容生成后介入
- 🔬 **研究方法**：结果无需更新模型参数即可降低多类 multimodal jailbreak ASR
- 📌 **结论**：SafeSteer 在逐 token 解码中识别风险并沿安全方向动态 steering
...
### 129. TrajGuard: Streaming Hidden-state Trajectory Detection for Decoding-time Jailbreak Defense

📄 [arXiv](https://arxiv.org/abs/2604.07727) · 🎓 [Official](https://aclanthology.org/2026.findings-acl.655/)　📅 2026-04　🏷 ACL 2026 Findings
...
- 🎯 **研究动机**：针对静态 prompt、output 或单点 activation 忽略风险在 decoding 中的演化
- 🔬 **研究方法**：论文以滑动窗口聚合 critical-layer trajectory 并只在持续高风险时语义复核
- 📌 **结论**：结果平均防御率 95%、检测延迟 5.2 ms/token 且 FPR 低于 1.5%
...
### 130. All Changes May Have Invariant Principles: Improving Ever-Shifting Harmful Meme Detection via Design Concept Reproduction
...
### 131. BanHADEX: Towards Explainable HAte Speech Detection in Bangla Using Human Annotated EXplanation
...
### 132. Beyond Single-View Detection: A Dual-Space Reasoning Framework for Interpretable Harmful Meme Understanding
...
### 133. Confident, Calibrated, or Complicit: Safety Alignment and Ideological Bias in LLM Hate Speech Detection
...
### 134. Deep Research with Open-Domain Evaluation and Multi-Stage Guardrails for Safety
...
### 135. DIA-HARM: Dialectal Disparities in Harmful Content Detection Across 50 English Dialects
...
### 136. Domain Generalizable AI Guardrails with Augmented Policy Training
...
### 137. FlexGuard: Continuous Risk Scoring for Strictness-Adaptive LLM Content Moderation
...
### 138. HiddenGuard: Fine-Grained Safe Generation with Specialized Representation Router
...
### 139. LLM-Based Multi-Task Bangla Hate Speech Detection: Type, Severity, and Target
...
### 140. Luring as a Proxy: Evaluating Corpus Transferability for Cybergrooming Detection
...
### 141. New Terms, New Toxicity: Consensus-based Chinese Neologism Toxicity Detection via Search-Augmented LLMs
...
### 142. N-GLARE: An Non-Generative Latent Representation-Efficient LLM Safety Evaluator
...
### 143. Persona-Grounded Safety Evaluation of AI Companions in Multi-Turn Conversations
...
### 144. ReasoningGuard: Safeguarding Large Reasoning Models with Inference-time Safety Aha Moments
...
### 145. RST-Guarder: Enhancing Long-Context Robustness for Safeguards via RST Parsing and Probabilistic Inference
...
### 146. RV-HATE: Reinforced Multi-Module Voting for Implicit Hate Speech Detection
...
### 147. SMARTER: A Data-efficient Framework to Improve Toxicity Detection with Explanation via Self-augmenting Large Language Models
...
### 148. USB: A COMPREHENSIVE AND UNIFIED SAFETY EVALUATION BENCHMARK FOR MULTIMODAL LARGE LANGUAGE MODELS
...
### 149. Why LLM Safety Guardrails Collapse After Fine-tuning: A Similarity Analysis Between Alignment and Fine-tuning Datasets
...
### 150. Targeting the Needle, Ignoring the Haystack: Anchoring Crucial Cues for Evolving Scam Call Detection via an LLM-Assisted Classifier

🎓 [Official](https://aclanthology.org/2026.findings-acl.1025/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`detection`、`scam call detection`、`semantic primitives`、`LLM-assisted classifier`、`evolving fraud patterns`

👤 **作者**：Tong Wu、Qinliang Su、Jianxing Yu、Bo Liang、Minhua Huang

- 🎯 **研究动机**：诈骗通话标注稀缺且话术持续演变，监督模型易过拟合背景叙事而非欺骗意图
- 🔬 **研究方法**：以专家知识的 Semantic Primitives 为锚点，先在转写中识别稳定语义证据，再逻辑组合出裁决，LLM 辅助轻量分类
- 📌 **结论**：以稳定证据优先换取对新话术的泛化，缓解标注稀缺
...
### 151. RoleCDE: Benchmarking and Mitigating Role–Alignment Trade-offs in Role-Playing Agents

🎓 [Official](https://aclanthology.org/2026.findings-acl.106/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`benchmark`、`RoleCDE`、`role-playing agents`、`role-alignment trade-off`、`value conflict resolution`

👤 **作者**：Huayi Lai、…、Xun Liang

- 🎯 **研究动机**：角色扮演智能体在角色价值与对齐约束冲突下的决策缺乏系统评测，已有基准只看表面保真
- 🔬 **研究方法**：RoleCDE 以认知困境场景联合评测角色接地、价值冲突化解与决策倾向，约 8k 角色、近 240k 实例
- 📌 **结论**：发现 Role Value Decoupling：冲突时模型默认道德一致而非角色价值；针对性微调可改善权衡
...
### 152. Penetrating Linguistic Disguises: A Slang-aware Label-Aligned Framework for Fine-Grained Toxicity Extraction in Chinese Hate Speech Detection

🎓 [Official](https://aclanthology.org/2026.findings-acl.1061/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`detection`、`Chinese hate speech`、`slang disambiguation`、`quad extraction`、`label collision avoidance`

👤 **作者**：Wei Liu、Xiaoliang Chen、Duoqian Miao、Xu Gu、Xianyong Li、Yajun Du

- 🎯 **研究动机**：俚语混淆与灵活词界使中文仇恨言论四元组抽取边界失控，生成式与判别式方法各有瓶颈
- 🔬 **研究方法**：SSLF 结构-语义词典融合消歧俚语，LDVT 体积空间标注以专属标签通道消除标签碰撞
- 📌 **结论**：在 STATE ToxiCN 上缓解标签冲突并提升细粒度抽取
...
### 153. TOXIFRENCH: Benchmarking and Enhancing Language Models via CoT Fine-Tuning for French Toxicity Detection

🎓 [Official](https://aclanthology.org/2026.findings-acl.1074/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`benchmark`、`TOXIFRENCH`、`French toxicity detection`、`CoT fine-tuning`、`semi-automatic annotation`

👤 **作者**：Axel Delaval、Shujian Yang、Haicheng Wang、Han Qiu、Jialiang LU

- 🎯 **研究动机**：法语毒性检测缺乏文化相关的大规模人工标注资源，发展远落后于英语
- 🔬 **研究方法**：发布 53,622 条评论的 TOXIFRENCH 及均衡评测集，半自动流水线将人工标注压至 10%，再以 CoT 微调模型
- 📌 **结论**：小语言模型在鲁棒性与泛化上常反超更大模型
...
### 154. BOOKAGENT: Orchestrating Safety-Aware Visual Narratives via Multi-Agent Cognitive Calibration

🎓 [Official](https://aclanthology.org/2026.findings-acl.108/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`BookAgent`、`children's picture book generation`、`multi-agent cognitive calibration`、`multimodal safety verification`

👤 **作者**：Bo Gao、Chang Liu、Yuyang Miao、SiYuan Ma、Ser-Nam Lim

- 🎯 **研究动机**：儿童绘本多模态生成缺乏儿童特定安全约束与序列级跨模态安全校验
- 🔬 **研究方法**：BookAgent 多智能体认知校准联合规划、脚本、插画与全局修复，安全约束贯穿叙事规划与多模态验证
- 📌 **结论**：端到端合成质量与儿童安全性同步提升
...
### 155. GrandGuard: Taxonomy, Benchmark, and Safeguards for Elderly-Chatbot Interaction Safety

🎓 [Official](https://aclanthology.org/2026.findings-acl.1116/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`benchmark`、`GrandGuard`、`elderly-chatbot interaction`、`risk taxonomy`、`contextualized safeguards`

👤 **作者**：Changxuan Fan、…、Yangqiu Song

- 🎯 **研究动机**：老年人因孤独、数字素养与认知衰退面临情境化风险，如独自在暗处修灯即高危，已有基准面向一般危害
- 🔬 **研究方法**：GrandGuard 建立三级 50 类风险分类体系并配套基准与防护，源自真实事件、社区讨论与利益相关者研究
- 📌 **结论**：主流模型对老年情境风险存在系统性盲区，防护措施可缓解
...
### 156. OmniCompliance-100K: A Multi-Domain, Rule-Grounded, Real-World Safety Compliance Dataset

🎓 [Official](https://aclanthology.org/2026.findings-acl.115/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`benchmark`、`OmniCompliance-100K`、`rule-grounded compliance`、`web search agent`、`regulatory policy coverage`

👤 **作者**：Wenbin Hu、Huihao Jing、Haochen Shi、Changxuan Fan、Haoran Li、Yangqiu Song

- 🎯 **研究动机**：已有安全数据集依赖临时分类体系生成，缺乏稳健保护所需的规则锚定真实案例
- 🔬 **研究方法**：以网络搜索智能体从权威来源构建 OmniCompliance-100K，覆盖 74 项法规与平台政策等多领域
- 📌 **结论**：为合规视角的安全训练与评测提供规则接地的资源
...
### 157. MHSafeEval: Role-Aware Interaction-Level Evaluation of Mental Health Safety in Large Language Models

🎓 [Official](https://aclanthology.org/2026.findings-acl.1382/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`benchmark`、`MHSafeEval`、`mental health safety`、`role-aware interaction`、`multi-turn harm accumulation`

👤 **作者**：Suhyun Lee、Palakorn Achananuparp、Neemesh Yadav、Ee-Peng Lim、Yang Deng

- 🎯 **研究动机**：临床伤害具有交互性与情境依赖，孤立响应的粗粒度评测无法刻画多轮伤害的累积
- 🔬 **研究方法**：R-MHSafe 按 AI 咨询师扮演的加害者、教唆者等角色定义临床伤害分类，MHSafeEval 以智能体闭环做轨迹级伤害发现
- 📌 **结论**：揭示单轮评测遗漏的多轮累积伤害模式
...
### 158. Beyond the Safety Tax: Mitigating Unsafe Text-to-Image Generation via External Safety Rectification

🎓 [Official](https://aclanthology.org/2026.findings-acl.1394/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`SafePatch`、`text-to-image safety rectification`、`safety tax avoidance`、`trainable encoder clone`

👤 **作者**：Xiangtao Meng、Yingkai Dong、Ning Yu、Li Wang、Zheng Li、Shanqing Guo

- 🎯 **研究动机**：内部干预式 T2I 防御因概念纠缠损害良性生成质量，付出 Safety Tax
- 🔬 **研究方法**：SafePatch 以基座编码器的可训练克隆为结构隔离安全模块，不改基座地做可解释语义修正
- 📌 **结论**：抑制不安全输出同时避免良性质量退化
...
### 159. XGUARD: A Graded Benchmark for Evaluating Safety Failures of Large Language Models on Extremist Content

🎓 [Official](https://aclanthology.org/2026.findings-acl.1576/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`benchmark`、`XGUARD`、`extremist content`、`graded severity labeling`、`Attack Severity Curve`

👤 **作者**：Vadivel Abishethvarman、Bhavik Chandna、Pratik Jalan、Usman Naseem

- 🎯 **研究动机**：二元安全标签掩盖极端主义输出的风险谱系，无法度量失败频率与严重度
- 🔬 **研究方法**：XGUARD 含 3,840 条源于真实极端场景的红队提示，按极端主义认同度分 0–4 五级，以 Attack Severity Curve 可视化
- 📌 **结论**：实现跨威胁强度的脆弱性画像与防御机制比较
...
### 160. A Survey of Toxicity Mitigation Strategies for Multilingual Language Models

🎓 [Official](https://aclanthology.org/2026.findings-acl.1780/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`survey`、`multilingual toxicity mitigation`、`detoxification taxonomy`、`decoding-time editing`、`alignment-based detoxification`

👤 **作者**：Soham Dan、Himanshu Beniwal、Thomas Hartvigsen

- 🎯 **研究动机**：LLM 会复制并放大多语言社区的仇恨、骚扰与偏见内容，去毒方法缺乏系统梳理
- 🔬 **研究方法**：首个多语言去毒综述，按训练方法、事后编辑解码、对齐强化学习与数据创新四类归纳
- 📌 **结论**：给出多语言毒性缓解的分类框架与开放挑战
...
### 161. Faithfulness vs. Safety: Evaluating LLM Behavior Under Counterfactual Medical Evidence

🎓 [Official](https://aclanthology.org/2026.findings-acl.1847/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`analysis`、`faithfulness-safety conflict`、`counterfactual medical evidence`、`context over-trust`、`hazardous evidence acceptance`

👤 **作者**：Kaijie Mo、…、Junyi Li

- 🎯 **研究动机**：医疗等高风险域中，上下文忠实与模型先验或安全协议冲突时的 LLM 行为缺乏评估
- 🔬 **研究方法**：构建 MedCounterFact 数据集，将临床比较问题中的干预替换为四类反事实刺激（含毒物），评测多个前沿 LLM
- 📌 **结论**：各模型几乎全盘接受危险或荒谬的反事实证据并自信无保留作答，忠实性压倒安全
...
### 162. µsicalnote Something Just Like TRuST µsicalnote *: Toxicity Recognition of Span and Target

🎓 [Official](https://aclanthology.org/2026.findings-acl.1854/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`benchmark`、`TRuST`、`unified toxicity definition`、`span and target annotation`、`toxicity tri-task evaluation`

👤 **作者**：Berk Atıl、Namrata Sureddy、Rebecca Passonneau

- 🎯 **研究动机**：毒性定义不一致阻碍有害内容检测资源建设与 LLM 评测
- 🔬 **研究方法**：TRuST 以统一毒性定义与标注体系整合扩展资源，约 30 万标注（1.1 万人工），覆盖毒性检测、目标群体与毒词三任务
- 📌 **结论**：微调 PLM 三任务全面优于 LLM，推理模型也未带来可靠提升
...
### 163. SEA-SafeguardBench: Culturally Grounded Safety Benchmark for Southeast Asian Languages

🎓 [Official](https://aclanthology.org/2026.findings-acl.194/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`benchmark`、`SEA-SafeguardBench`、`Southeast Asian languages`、`culturally grounded safety`、`native annotation`

👤 **作者**：Panuthep Tasawong、Jian Ngui、Alham Aji、Trevor Cohn、Peerat Limkonchotiwat

- 🎯 **研究动机**：多语安全评测依赖机翻英文数据，东南亚语言的文化特异性危害被忽视
- 🔬 **研究方法**：构建首个 SEA 人工核验安全基准：8 语言 21640 样本，含通用、野外与内容生成三子集
- 📌 **结论**：SOTA LLM 与护栏模型在 SEA 文化危害场景显著劣于英文文本
...
### 164. Auditing LLM Responses to Harmful Stereotypes Targeting Mental Health Groups

🎓 [Official](https://aclanthology.org/2026.findings-acl.2010/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`analysis`、`stereotype endorsement audit`、`mental health groups`、`rights restriction rhetoric`、`moderation blind spot`

👤 **作者**：Arka Dutta、Rijul Magu、Sean Kim、Seohee Yoon、Munmun De Choudhury、Ashiqur KhudaBukhsh

- 🎯 **研究动机**：LLM 对精神健康群体的刻板印象背书与权利限制话术缺乏审计
- 🔬 **研究方法**：以刻板印象合理化提示审计多款开源 LLM，跨模型家族、版本与病种分析背书差异
- 📌 **结论**：多个常用模型明确背书有害刻板印象，主流有害内容评测与审核框架普遍漏检
...
### 165. DR-HM: Distill-then-Reinforce Training with Cognition-Aware Data Synthesis for Harmful Meme Detection

🎓 [Official](https://aclanthology.org/2026.findings-acl.2130/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`detection`、`DR-HM`、`harmful meme detection`、`cognition-aware data synthesis`、`A-GRPO reinforcement`

👤 **作者**：Zihan Cheng、…、Mingfu Zhang

- 🎯 **研究动机**：有害 meme 依赖隐式文化隐喻，小 MLLM 缺知识而大 MLLM 有系统性标注偏差
- 🔬 **研究方法**：六步认知感知数据合成将 meme 分析分解为渐进推理，先蒸馏再以 A-GRPO 强化训练
- 📌 **结论**：三个基准全面领先，FHM 准确率 84.7% 逼近人类标注水平
...
### 166. ToxiTrace: Gradient-Aligned Training for Explainable Chinese Toxicity Detection

🎓 [Official](https://aclanthology.org/2026.findings-acl.354/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`detection`、`ToxiTrace`、`toxicity span extraction`、`gradient-aligned training`、`explainable evidence`

👤 **作者**：Boyang Li、Hongzhe Shou、Yuanyuan Liang、JingBin Zhang、Fang Zhou

- 🎯 **研究动机**：中文毒性检测止于句级分类，难给出可读连续的毒性证据 span
- 🔬 **研究方法**：CuSA 将编码器显著性线索精炼为细粒度 span，GCLoss 梯度约束聚焦毒性证据，ARCL 构建样本特定对比推理对
- 📌 **结论**：分类与毒性 span 抽取双提升，推理高效且解释更连贯
...
### 167. Speak No Evil, Just Prompt: Low-resource Multilingual Toxic Speech Detection with Audio Language Model

🎓 [Official](https://aclanthology.org/2026.findings-acl.439/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`detection`、`SoftPrompt-TSD`、`speech toxicity detection`、`audio language model`、`low-resource multilingual`

👤 **作者**：Mingzi Zuo、…、Hao Liu

- 🎯 **研究动机**：语音毒性检测远少于文本，级联 ASR+分类器在低资源语言失效且丢失声学线索
- 🔬 **研究方法**：构建覆盖 53 语言与口音的毒性标注语音数据集 PolySpeechTox，提出基于冻结音频语言模型的 SoftPrompt-TSD 端到端检测
- 📌 **结论**：micro ROC-AUC 达 98.07%，缓解多语言基线的严重失效
...
### 168. Characterizing Selective Refusal Bias in Large Language Models

🎓 [Official](https://aclanthology.org/2026.findings-acl.550/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`analysis`、`selective refusal bias`、`demographic disparity`、`indirect re-attack`、`refusal characterization`

👤 **作者**：Adel Khorramrouz、Sharon Levy

- 🎯 **研究动机**：安全护栏可能只拒绝对部分人群的有害请求，选择性拒答偏差未被系统刻画
- 🔬 **研究方法**：按个体与交叉人口群体的拒答率、回复类型与拒答长度刻画偏差，并设计针对曾被拒群体的间接攻击
- 📌 **结论**：性别/性取向/国籍/宗教均现偏差；间接攻击下 Llama 3.1 约 89% 试验失守
...
### 169. FinSafetyBench: Evaluating LLM Safety in Real-World Financial Scenarios

🎓 [Official](https://aclanthology.org/2026.findings-acl.694/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`benchmark`、`FinSafetyBench`、`financial compliance safety`、`bilingual red-teaming`、`compliance refusal evaluation`

👤 **作者**：Yutao Hou、…、Yun Chen

- 🎯 **研究动机**：LLM 在金融场景可协助违法或不伦理行为，合规拒答能力缺乏系统红队评测
- 🔬 **研究方法**：基于真实金融犯罪与伦理标准构建 FinSafetyBench 双语红队基准，14 子类三种攻击设定下评测通用与金融 LLM
- 📌 **结论**：对抗提示可绕过合规防护，中文语境更脆弱，提示级防御对隐性操纵乏力
...
### 170. Red-Teaming NSFW Image Classifiers as Text-to-Image Safeguards

🎓 [Official](https://aclanthology.org/2026.findings-acl.506/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`attack`、`NSFW classifier`、`context shift`、`T2I safeguard`

👤 **作者**：Tinghao Xie、…、Li Chen

- 🎯 **研究动机**：NSFW classifier 对主体不变但背景和共现对象改变的 context shift 缺少系统压力测试
- 🔬 **研究方法**：再训练 LLM 重写 prompt 进行 exploitation
- 📌 **结论**：结果规避概率最高提升六倍，且漏洞迁移到实际 T2I 与 T2V system
...
### 171. Making MLLMs Blind: Adversarial Smuggling Attacks in MLLM Content Moderation

📄 [arXiv](https://arxiv.org/abs/2604.06950) · 🎓 [Official](https://aclanthology.org/2026.findings-acl.1006/)　📅 2026-04　🏷 ACL 2026 Findings
...
- 🎯 **研究动机**：研究 visual smuggling、perceptual blindness 场景下的攻击面，重点考察 reasoning blockade 如何影响目标模型或系统
- 🔬 **研究方法**：并构建 1,700 条 SmuggleBench
- 📌 **结论**：前沿闭源与开放 moderator 均出现高绕过率，说明视觉审核不能只依赖通用感知能力
...
### 172. CARO: Chain-of-Analogy Reasoning Optimization for Robust Content Moderation

📄 [arXiv](https://arxiv.org/abs/2604.10504) · 🎓 [Official](https://aclanthology.org/2026.findings-acl.1442/)　📅 2026-04　🏷 ACL 2026 Findings

**关键词**：`defense`、`analogical reasoning`、`decision shortcut`、`moderation robustness`

👤 **作者**：Bingzhe Wu、Haotian Lu、Yuchen Mou

- 🎯 **研究动机**：研究如何防御 analogical reasoning、decision shortcut 威胁，并评估 moderation robustness 条件下的安全收益与效用代价
- 🔬 **研究方法**：CARO 先用检索增强生成建立类比推理链并执行 SFT
- 📌 **结论**：推理时动态生成与当前案例匹配的参照，降低歧义内容诱发的 decision shortcut，并在困难审核基准上超过 reasoning model、Llama Guard 与静态检索基线
...
### 173. SEA-Guard: Culturally Grounded Multilingual Safeguard for Southeast Asia

📄 [arXiv](https://arxiv.org/abs/2602.01618) · 🎓 [Official](https://aclanthology.org/2026.findings-acl.141/)　📅 2026-02　🏷 ACL 2026 Findings

**关键词**：`defense`、`Southeast Asian languages`、`agentic data generation`、`cultural safety`

👤 **作者**：Panuthep Tasawong、Jian Ngui、Alham Aji、Trevor Cohn、Peerat Limkonchotiwat

- 🎯 **研究动机**：针对机器翻译数据遗漏东南亚本地价值、法规和伤害语境
- 🔬 **研究方法**：论文用 agentic pipeline 生成地区原生安全数据并训练 SEA-Guard
- 📌 **结论**：结果提高 culturally sensitive 内容检测且保持通用安全性能
...
### 174. When Helpers Become Hazards: A Benchmark for Analyzing Multimodal LLM-Powered Safety in Daily Life

📄 [arXiv](https://arxiv.org/abs/2601.04043) · 🎓 [Official](https://aclanthology.org/2026.findings-acl.1446/)　📅 2026-01　🏷 ACL 2026 Findings

**关键词**：`benchmark`、`SaLAD`、`implicit visual risk`、`actionable warning`

👤 **作者**：Xinyue Lou、…、Kaiyu Huang

- 🎯 **研究动机**：研究如何评测 implicit visual risk、SaLAD 风险，重点考察 actionable warning 场景下的覆盖度与可复现性
- 🔬 **研究方法**：单纯 refusal metric 无法衡量有效帮助；SaLAD 测试模型区分安全与危险场景并生成具体 warning
- 📌 **结论**：结果显示最佳模型在 unsafe 样本上的准确率仍只有 57.20%
...
### 175. UbuntuGuard: A Culturally-Grounded Policy Benchmark for Equitable AI Safety in African Languages.

📄 [arXiv](https://arxiv.org/abs/2601.12696) · 🎓 [Official](https://aclanthology.org/2026.findings-acl.1663/)　📅 2026-01　🏷 ACL 2026 Findings

**关键词**：`benchmark`、`African languages`、`expert-authored policy`、`cultural alignment`

👤 **作者**：Tassallah Abdullahi、…、Carsten Eickhoff

- 🎯 **研究动机**：针对英文 benchmark 高估非洲低资源语言的实际安全
- 🔬 **研究方法**：论文由 155 名领域专家编写 adversarial query、context-specific policy 和参考响应
- 📌 **结论**：结果显示 cross-lingual transfer 只能部分覆盖本地语境，dynamic guard 也仍难完全本地化
...
### 176. Peering Behind the Shield: Guardrail Identification in Large Language Models

📄 [arXiv](https://arxiv.org/abs/2502.01241) · 🎓 [Official](https://aclanthology.org/2026.findings-acl.566/)　📅 2025-02　🏷 ACL 2026 Findings
...
- 🎯 **研究动机**：针对黑盒 AI 服务隐藏所用 guardrail 及其 input/output placement
- 🔬 **研究方法**：结果 AP-Test 可通过响应差异识别后端 guardrail，为模型审计也为定向规避暴露新攻击面
- 📌 **结论**：论文为候选 guard 优化具有区分性的 adversarial prompt
...
### 177. ACIArena: Toward Unified Evaluation for Agent Cascading Injection
...
### 178. BadScientist: Can a Research Agent Write Convincing but Unsound Papers that Fool LLM Reviewers?
...
### 179. Beyond Explicit Refusals: Soft-Failure Attacks on Retrieval-Augmented Generation
...
### 180. Conjunctive Prompt Attacks in Multi-Agent LLM Systems
...
### 181. Evo-Attacker: Memory-Augmented Reinforcement Learning for Long-Horizon Tool Attacks on LLM-MAS
...
### 182. Open Schrödinger’s Closed Box: Identifying Retrieval Augmented Generation in API-Accessible Large Language Model Services
...
### 183. Query-Efficient Agentic Graph Extraction Attacks on GraphRAG Systems
...
### 184. Stop Fixating on Prompts: Reasoning Hijacking and Constraint Tightening for Red-Teaming LLM Agents
...
### 185. TAMAS: Benchmarking Adversarial Risks in Multi-Agent LLM Systems
...
### 186. When Efficiency Becomes a Vulnerability: Computational Cost Attacks on WebAgents
...
### 187. When Personalization Legitimizes Risks: Uncovering Safety Vulnerabilities in Personalized Dialogue Agents
...
### 188. Rethinking Assessments of Prompt Injection Attacks

🎓 [Official](https://aclanthology.org/2026.findings-acl.1191/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`analysis`、`prompt injection evaluation`、`real-world application testing`、`defense effectiveness`、`evaluation validity`

👤 **作者**：Chi Cui、Yixin Wu、Michael Backes、Yang Zhang

- 🎯 **研究动机**：常见提示注入评测缺乏全面性与真实世界相关性，结论难以指导防御
- 🔬 **研究方法**：跨 8 种设定评估 37 个真实应用、185 个注入任务与 21 条攻击指令共 143,745 次查询，并评估提示级与模型级防御
- 📌 **结论**：真实应用比研究设定更脆弱，简单攻击指令反而更有效，现有防御局限明显
...
### 189. EVA: Evolving Semantic Adversaries for Red-Teaming GUI Agents Against Environmental Injection Attacks

🎓 [Official](https://aclanthology.org/2026.findings-acl.1230/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`attack`、`EVA`、`GUI agent red-teaming`、`environmental injection`、`evolutionary semantic adversaries`

👤 **作者**：Yijie Lu、…、Zhuosheng Zhang

- 🎯 **研究动机**：GUI 智能体对环境注入攻击天然脆弱，已有红队在目标先验知识与计算成本间两难
- 🔬 **研究方法**：EVA 以演化式语义对抗体对环境注入攻击做红队，并分析决定攻击成败的关键因素
- 📌 **结论**：以低目标知识依赖发现 GUI 智能体的环境注入漏洞

<details>
<summary>📝 展开完整英文摘要（Abstract）</summary>

Autonomous GUI agents are inherently vulnerable to Environmental Injection Attacks (EIAs). However, existing red-teaming methods face a trade-off between requiring target-specific knowledge and incurring prohibitive computational costs. More fundamentally, a key question remains: what factors determine attack success?

</details>


### 190. How Adversarial Environments Mislead Agentic AI?

🎓 [Official](https://aclanthology.org/2026.findings-acl.499/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`attack`、`Potemkin`、`adversarial environmental injection`、`cognitive drift`、`strategy collapse`

👤 **作者**：Zhonghao Zhan、Huichi Zhou、Zhenhao Li、Peiyuan Jing、Krinos Li、Hamed Haddadi

- 🎯 **研究动机**：工具集成智能体默认信任外部工具，评测从不检验工具说谎的情形
- 🔬 **研究方法**：形式化 Adversarial Environmental Injection 威胁模型，以 MCP 兼容的 Potemkin 构造广度（认知漂移）与深度（策略崩溃）两类投毒攻击
- 📌 **结论**：五个前沿智能体 11000+ 运行显示认知与导航鲁棒性相互独立，抗一类常加剧另一类脆弱
...
### 191. Web Fraud Attacks Against LLM-Driven Multi-Agent Systems

🎓 [Official](https://aclanthology.org/2026.findings-acl.686/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`attack`、`web fraud attack`、`multi-agent link trust exploitation`、`URL manipulation`、`detection evasion`

👤 **作者**：Dezhang Kong、…、Meng Han

- 🎯 **研究动机**：多智能体系统对 Web 链接的信任可被攻击者用作扩大攻击面的跳板
- 🔬 **研究方法**：设计 12 种利用链接结构的攻击变体：同形字欺骗、子目录嵌套、参数混淆等
- 📌 **结论**：跨 MAS 架构破坏力显著且免复杂输入设计即可规避检测，大幅降低攻击门槛
...
### 192. Prompt Injection in Automated Résumé Screening with Large Language Models: Single and Multi-Injection Settings

📄 [arXiv](https://arxiv.org/abs/2606.27287) · 🎓 [Official](https://aclanthology.org/2026.findings-acl.142/)　📅 2026-06　🏷 ACL 2026 Findings

**关键词**：`attack`、`hiring-system injection`、`résumé injection`、`multi-injection`

👤 **作者**：Preet Baxi、Jiannan Xu、Jane Jiang、Stefanus Jasin

- 🎯 **研究动机**：针对求职者能否用隐藏指令操纵自动简历排序
- 🔬 **研究方法**：论文比较单个与多个候选人注入及不同质量分布
- 📌 **结论**：结果发现稀少注入且候选质量接近时风险最大，广泛注入时收益会迅速消失
...
### 193. MalURLBench: A Benchmark Evaluating Agents’ Vulnerabilities When Processing Web URLs

📄 [arXiv](https://arxiv.org/abs/2601.18113) · 🎓 [Official](https://aclanthology.org/2026.findings-acl.716/)　📅 2026-01　🏷 ACL 2026 Findings

**关键词**：`benchmark`、`malicious URL`、`URL obfuscation`、`URLGuard`

👤 **作者**：Dezhang Kong、…、Meng Han

- 🎯 **研究动机**：针对 Web Agent 接受伪装恶意 URL 后会继续访问危险页面；论文构建覆盖十类场景和七类真实恶意网站的 61,845 个实例
- 🔬 **研究方法**：并提出 URLGuard
- 📌 **结论**：结果十二种模型普遍难识别精心伪装的 URL
...
### 194. CORBA: Contagious Recursive Blocking Attacks on Multi-Agent Systems Based on Large Language Models

📄 [arXiv](https://arxiv.org/abs/2502.14529) · 🎓 [Official](https://aclanthology.org/2026.findings-acl.342/)　📅 2025-02　🏷 ACL 2026 Findings

**关键词**：`attack`、`multi-agent DoS`、`recursive propagation`、`collaboration blocking`

👤 **作者**：Zhenhong Zhou、…、Qing Guo

- 🎯 **研究动机**：针对开放通信使多 Agent 协作结构可被利用
- 🔬 **研究方法**：结果能耗尽计算并造成系统瘫痪，提出了区别于单节点 DoS 的协作拒绝攻击
- 📌 **结论**：论文用表面无害且可传染的递归指令让消息在不同拓扑中反复传播
...
### 195. Agentic Oversight via Dialectic Reasoning
...
### 196. A Multi-Agent Framework for High-Interaction Terminal Simulation
...
### 197. Benchmarking Web Agent Safety under E-commerce Deceptive Interfaces
...
### 198. BlindGuard: Safeguarding LLM-based Multi-Agent Systems under Unknown Attacks
...
### 199. Detecting RAG Extraction Attack via Dual-Path Runtime Integrity Game
...
### 200. Don’t Click That: Teaching Web Agents to Resist Deceptive Interfaces
...
### 201. From Proof to Program: Characterizing Tool-Induced Reasoning Hallucinations in Large Language Models
...
### 202. JARVIS or Ultron? A Survey on the Safety and Security Threats of Computer-Using Agents
...
### 203. MARCH: Multi-Agent Reinforced Check for Hallucination
...
### 204. Multimodal Safety Evaluation in Generative Agent Social Simulations
...
### 205. OS-Sentinel: Towards Safety-Enhanced Mobile GUI Agents via Hybrid Validation in Realistic Workflows
...
### 206. RISK: A Framework for GUI Agents in E-commerce Risk Management
...
### 207. SafeAgent: Safeguarding LLM Agents via an Automated Risk Simulator
...
### 208. SafeMCP: Proactive Power Regulation for LLM Agent Defense via Environment-Grounded Look-Ahead Reasoning
...
### 209. SecureVibeBench: Benchmarking Secure Vibe Coding of AI Agents via Reconstructing Vulnerability-Introducing Scenarios
...
### 210. The Reasoning Trap: How Enhancing LLM Reasoning Amplifies Tool Hallucination
...
### 211. Towards Trustworthy Smart Contract Synthesis: A Multi-Agent Framework with Lean-Based Verification
...
### 212. Uncertainty Quantification in LLM Agents: Foundations, Emerging Challenges, and Opportunities
...
### 213. VIGIL: Defending LLM Agents Against Tool-Stream Injection via Verify-Before-Commit
...
### 214. When "Correct" Is Not Safe: Can We Trust Functionally Correct Patches Generated by Code Agents?
...
### 217. PerMemSafe: Benchmarking Implicit Personalized Safety of Long Horizon Self-Evolving Agents

🎓 [Official](https://aclanthology.org/2026.findings-acl.320/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`benchmark`、`PerMemSafe`、`implicit personalized safety`、`long-horizon self-evolving agents`、`SentinelMem`

👤 **作者**：Hengyu An、…、Shouling Ji

- 🎯 **研究动机**：自演化智能体的用户记忆使普遍安全的回复在个体上下文中有害，传统上下文无关评测失效
- 🔬 **研究方法**：形式化 Implicit Personalized Safety，构建 PerMemSafe 长程基准，并提出显式建模个性化风险推断与记忆演化的 SentinelMem
- 📌 **结论**：最强智能体安全率仅约 50%，SentinelMem 提升 23.8% 且保持帮助性
...
### 218. PRA-RAG: Provably Robust Aggregation in Retrieval-Augmented Generation against Retrieval Corruption

📄 [arXiv](https://arxiv.org/abs/2607.00012) · 🎓 [Official](https://aclanthology.org/2026.findings-acl.1794/)　📅 2026-05　🏷 ACL 2026 Findings

**关键词**：`defense`、`robust aggregation`、`geometric subset`、`certified bound`

👤 **作者**：Xue Tan、…、Ping Chen

- 🎯 **研究动机**：针对 LLM 缺少 retrieved fact 的参数知识时启发式防御不稳定
- 🔬 **研究方法**：PRA-RAG 对检索文本组合采样、用 embedding geometry 选出鲁棒子集并聚合
- 📌 **结论**：理论界定毒证据最大影响，实验将 ASR 最低降至 1% 且保持 71% accuracy
...
### 219. ToolSafe: Enhancing Tool Invocation Safety of LLM-based agents via Proactive Step-level Guardrail and Feedback

📄 [arXiv](https://arxiv.org/abs/2601.10156) · 🎓 [Official](https://aclanthology.org/2026.findings-acl.1850/)　📅 2026-01　🏷 ACL 2026 Findings

**关键词**：`defense`、`tool invocation`、`step-level guard`、`TS-Flow`

👤 **作者**：Yutao Mou、…、Jing Shao

- 🎯 **研究动机**：针对不安全 tool call 需要在执行前发现的问题
- 🔬 **研究方法**：论文构建 TS-Bench
- 📌 **结论**：结果平均减少 65% 有害调用并改善受注入时的良性任务完成率
...
### 220. Activation Decomposition and Steering for LLM Backdoor Remediation
...
### 221. Among Us: Measuring and Mitigating Malicious Contributions in Model Collaboration Systems
...
### 222. Backdoor Collapse: Eliminating Unknown Threats Via Known Backdoor Aggregation In Language Models
...
### 223. Backdoors in RLVR: Jailbreak Backdoors in LLMs From Verifiable Reward
...
### 224. Compiling Activation Steering into Weights via Null-Space Constraints for Stealthy Backdoors
...
### 225. Critical-CoT: A Robust Defense Framework against Reasoning-Level Backdoor Attacks in Large Language Models
...
### 226. CTRAP: Embedding Collapse Trap to Safeguard Large Language Models from Harmful Fine-Tuning
...
### 227. Defense Against Knowledge Poisoning Attack on GraphRAG
...
### 228. In-Context Representation Hijacking
...
### 229. Inhibitory Attacks on Backdoor-based Fingerprinting for Large Language Models
...
### 230. Knowledge Poisoning Attacks on Medical Multi-Modal Retrieval-Augmented Generation
...
### 231. LogicPoison: Logical Attacks on Graph Retrieval-Augmented Generation
...
### 232. Merging Triggers, Breaking Backdoors: Defensive Poisoning for Instruction-Tuned Language Models
...
### 233. MirageBackdoor: A Stealthy Attack that Induces Think-Well-Answer-Wrong Reasoning
...
### 234. MM-PoisonRAG: Disrupting Multimodal RAG with Local and Global Knowledge Poisoning Attacks
...
### 235. OASIS: Mitigating Harmful Fine-tuning Attacks on LLMs via Orthogonal and Adaptive Safety Alignment Strategy
...
### 236. PARASITE: Conditional System Prompt Poisoning to Hijack LLMs
...
### 237. Retrievals Can Be Detrimental: Unveiling the Backdoor Vulnerability of Retrieval-Augmented Diffusion Models
...
### 238. Safeguarding LLM Fine-tuning via Push-Pull Distributional Alignment
...
### 239. SGT: Securing Open-Source LLMs Against Malicious Fine-tuning via Safety Guidance Trigger
...
### 240. Toward Secure Tuning: Mitigating Security Risks from Instruction Fine-Tuning
...
### 241. Visual Inception: Compromising Long-term Planning in Agentic Recommenders via Multimodal Memory Poisoning
...
### 242. XOXO: Stealthy Cross-Origin Context Poisoning Attacks against AI Coding Assistants
...
### 243. Train in Vain: Functionality-Preserving Poisoning to Prevent Unauthorized Use of Code Datasets

🎓 [Official](https://aclanthology.org/2026.findings-acl.1564/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`attack`、`FunPoison`、`dataset poisoning`、`unauthorized use deterrence`、`functionality-preserving poison`、`code compilability`

👤 **作者**：Yuan Xiao、…、Zhenyu Chen

- 🎯 **研究动机**：代码数据集被未授权训练难以防范，已有投毒需全量污染且破坏代码可编译性
- 🔬 **研究方法**：FunPoison 向执行路径注入短小可编译的弱用途片段，自动修复、保守安全检查与类型感知合成保证副作用自由与隐蔽
- 📌 **结论**：少量污染即可显著降低未授权 CodeLLM 的生成效用
...
### 244. Rejection-to-Acceptance Transition: Model Editing-Based Jailbreak Backdoor Injection Not Limited to Few Output Tokens

🎓 [Official](https://aclanthology.org/2026.findings-acl.1625/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`attack`、`JEST`、`model editing backdoor`、`rejection-to-acceptance transition`、`representation hijacking`

👤 **作者**：Shiji Yang、…、Shu Zhao

- 🎯 **研究动机**：已有编辑式越狱后门把后门绑定到少数预定义短语，攻击成本随短语数量上升
- 🔬 **研究方法**：JEST 以表征转移引导的模型编辑把 LLM 从拒绝域劫持到接受域，触发后门即持续生成有害内容
- 📌 **结论**：摆脱短语数量依赖，以更少编辑实现稳定越狱后门
...
### 245. Hail to the Thief: Exploring Attacks and Defenses in Decentralised GRPO

🎓 [Official](https://aclanthology.org/2026.findings-acl.1950/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`analysis`、`decentralized GRPO`、`completion poisoning`、`logit probability verification`、`DoS vulnerability`

👤 **作者**：Nikolay Blagoev、Oguzhan Ersoy、Lydia Chen

- 🎯 **研究动机**：去中心化 GRPO 的对抗鲁棒性无人研究，恶意节点可借共享完成串投毒
- 🔬 **研究方法**：提出恶意节点投毒攻击与两种防御（logit 概率校验、LLM judge 过滤），在数学与代码任务验证
- 📌 **结论**：攻击 50 轮内 ASR 可达 100%；防御挡住投毒但防不住输出超长的 DoS
...
### 246. Watch Out Your Industrial Copilots: Stealthy Backdoor Attack Against LLM-Based PLC Code Generation

🎓 [Official](https://aclanthology.org/2026.findings-acl.609/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`attack`、`STBack`、`PLC code generation backdoor`、`industrial copilot`、`semantic ensemble trigger`

👤 **作者**：Xinyuan An、Liu Xiaoxia、Dongxia Wang、Zhanhang Xiong、Wenhai Wang

- 🎯 **研究动机**：LLM 生成 PLC 代码的工业副驾引入新攻击面，后门风险未被研究
- 🔬 **研究方法**：STBack 设计六种 PLC 恶意逻辑注入模式生成毒样本，三阶段管线精炼隐蔽性，以语义集成触发器微调注入后门
- 📌 **结论**：多 LLM 上平均 ASR 82.92%，与良性代码语义相似度超 95% 并绕过质量验证，既有防御无效
...
### 247. BackdoorAgent: A Unified Framework for Backdoor Attacks on LLM-based Agents

📄 [arXiv](https://arxiv.org/abs/2601.04566) · 🎓 [Official](https://aclanthology.org/2026.findings-acl.791/)　📅 2026-07　🏷 ACL 2026 Findings
...
- 🎯 **研究动机**：研究如何评测 stage-aware backdoor、memory stage 风险，重点考察 trigger propagation 场景下的覆盖度与可复现性
- 🔬 **研究方法**：BackdoorAgent 统一 planning、memory 与 tool-use 三阶段并覆盖四类 Agent 应用
- 📌 **结论**：GPT-based backbone 上 memory-stage trigger persistence 为 77.97%
...
### 248. When Backdoors Go Beyond Triggers: Semantic Drift in Diffusion Models Under Encoder Attacks

📄 [arXiv](https://arxiv.org/abs/2602.20193) · 🎓 [Official](https://aclanthology.org/2026.findings-acl.1421/)　📅 2026-02　🏷 ACL 2026 Findings

**关键词**：`analysis`、`encoder poisoning`、`semantic drift`、`representation geometry`

👤 **作者**：Shenyang Chen、Liuwan Zhu

- 🎯 **研究动机**：ASR 与图像质量无法揭示 encoder 后门对整个语义空间的影响
- 🔬 **研究方法**：论文发现 target-centered low-rank manifold deformation，并提出 SEMAD 评估未触发概念的语义漂移
- 📌 **结论**：论文发现 target-centered low-rank manifold deformation，并提出 SEMAD 评估未触发概念的语义漂移
...
### 249. Why LoRA Fails to Forget: Regularized Low-Rank Adaptation Against Backdoors in Language Models

📄 [arXiv](https://arxiv.org/abs/2601.06305) · 🎓 [Official](https://aclanthology.org/2026.findings-acl.1732/)　📅 2026-01　🏷 ACL 2026 Findings

**关键词**：`LoRA`、`regularized forgetting`

👤 **作者**：Hoang-Chau Luong、Lingwei Chen

- 🎯 **研究动机**：解释普通 LoRA 难以覆盖后门权重方向
- 🔬 **研究方法**：并用正则化低秩更新提升遗忘效果
- 📌 **结论**：并用正则化低秩更新提升遗忘效果
...
### 250. P2P: A Poison-to-Poison Remedy for Reliable Backdoor Defense in LLMs

📄 [arXiv](https://arxiv.org/abs/2510.04503) · 🎓 [Official](https://aclanthology.org/2026.findings-acl.600/)　📅 2025-10　🏷 ACL 2026 Findings

**关键词**：`poison-to-poison`、`remediation`

👤 **作者**：Shuai Zhao、…、Anh Luu

- 🎯 **研究动机**：研究如何防御 poison-to-poison、remediation 威胁，并评估 remediation 条件下的安全收益与效用代价
- 🔬 **研究方法**：在攻击触发器未知或不完整时修复模型
- 📌 **结论**：用受控防御毒样本抵消原后门学习信号
...
### 251. RIPRAG: Hack a Black-box Retrieval-Augmented Generation Question-Answering System with Reinforcement Learning

📄 [arXiv](https://arxiv.org/abs/2510.10008) · 🎓 [Official](https://aclanthology.org/2026.findings-acl.833/)　📅 2025-10　🏷 ACL 2026 Findings

**关键词**：`attack`、`RAG poisoning`、`reinforcement learning`、`black-box RAG`

👤 **作者**：Meng Xi、…、Jianwei Yin

- 🎯 **研究动机**：针对黑盒攻击无法获得检索和生成梯度
- 🔬 **研究方法**：论文以系统反馈为奖励学习毒文本
- 📌 **结论**：结果联合适应召回与回答阶段，在有限查询预算下提高目标问答操控成功率
...
### 252. Rethinking Reasoning: A Survey on Reasoning-based Backdoors in LLMs

📄 [arXiv](https://arxiv.org/abs/2510.07697) · 🎓 [Official](https://aclanthology.org/2026.findings-acl.863/)　📅 2025-10　🏷 ACL 2026 Findings

**关键词**：`survey`、`reasoning backdoor`

👤 **作者**：Man Hu、…、Shuai Zhao

- 🎯 **研究动机**：统一整理推理数据、显式 CoT 与连续潜在推理中的触发器、攻击目标、评测和防御
- 🔬 **研究方法**：统一整理推理数据、显式 CoT 与连续潜在推理中的触发器、攻击目标、评测和防御
- 📌 **结论**：统一整理推理数据、显式 CoT 与连续潜在推理中的触发器、攻击目标、评测和防御
...
### 253. SLIP: Soft Label Mechanism and Key-Extraction-Guided CoT-based Defense Against Instruction Backdoor in APIs

📄 [arXiv](https://arxiv.org/abs/2508.06153) · 🎓 [Official](https://aclanthology.org/2026.findings-acl.896/)　📅 2025-08　🏷 ACL 2026 Findings

**关键词**：`API`、`soft label`、`CoT`

👤 **作者**：Wu Zhengxian、Juan Wen、Wanli Peng、Haowei Chang、Yinghan Zhou、Xue Yiming

- 🎯 **研究动机**：研究如何防御 API、soft label 威胁，并评估 CoT 条件下的安全收益与效用代价
- 🔬 **研究方法**：在只能访问 API 时抽取关键触发线索
- 📌 **结论**：并用软标签与审查式 CoT 修正回答
...
### 254. Black-Box Membership Inference Attacks for Video Training Data in Multimodal Large Language Models
...
### 255. CheckMIABench: Firm Foundations For Membership Inference Attacks on Language Models
...
### 256. CoLA: A Choice Leakage Attack Framework to Expose Privacy Risks in Subset Training
...
### 257. ContextLens: Modeling Imperfect Privacy and Safety Context for Legal Compliance
...
### 258. De-Anonymization at Scale via Tournament-Style Attribution
...
### 259. Do LLMs Really Memorize Personally Identifiable Information? Revisiting PII Leakage with a Cue-Controlled Memorization Framework
...
### 260. Evaluating Answer Leakage Robustness of LLM Tutors against Adversarial Student Attacks
...
### 261. Hyperion: Private Token Sampling with Homomorphic Encryption
...
### 262. On the (In-)Security of the Shuffling Defense in the Transformer Secure Inference
...
### 263. PII-Bench: Evaluating Query-Aware Privacy Protection Systems
...
### 264. Powerful Training-Free Membership Inference Against Fine-Tuned Autoregressive Language Models
...
### 266. Privacy Collapse: Benign Fine-Tuning Can Break Contextual Privacy in Language Models
...
### 267. Privacy-preserving Prosody Representation Learning
...
### 268. Privacy-R1: Privacy-Aware Multi-LLM Agent Collaboration via Reinforcement Learning
...
### 269. Protecting Bystander Privacy via Selective Hearing in Audio LLMs
...
### 270. Robust Membership Inference for Large Language Models under Adversarial Generative Corruption
...
### 271. SharedRequest: Privacy-Preserving Model-Agnostic Inference for Large Language Models
...
### 272. Towards Privacy-Preserving Large Language Model: Text-free Inference Through Alignment and Adaptation
...
### 273. User Perceptions vs. Proxy LLM Judges: Privacy and Helpfulness in LLM Responses to Privacy-Sensitive Scenarios
...
### 274. Your Inference Request Will Become a Black Box: Confidential Inference for Cloud-based Large Language Models
...
### 275. Privacy Risks of Intermediate Representations: Attribute Inference in Distributed LLM Inference

🎓 [Official](https://aclanthology.org/2026.findings-acl.1172/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`attack`、`attribute inference`、`intermediate representations`、`distributed LLM inference`、`zero-shot matching`

👤 **作者**：Yang Lyu、…、Hui LI

- 🎯 **研究动机**：分布式 LLM 推理以传输中间隐层规避原始输入外发，其隐私风险被想当然视为安全而未检验
- 🔬 **研究方法**：IR-AIA 把属性推断重构为中间表征空间的零样本匹配，SG-APCR 处理层间各向异性等结构困难
- 📌 **结论**：仅凭中间表征即可泄漏敏感用户属性
...
### 276. Beyond Local vs. External: A Game-Theoretic Framework for Trustworthy Knowledge Acquisition

🎓 [Official](https://aclanthology.org/2026.findings-acl.1299/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`game-theoretic knowledge acquisition`、`privacy-aware query decomposition`、`adversarial reconstruction`、`intent leakage control`

👤 **作者**：Rujing Yao、…、Xiaozhong Liu

- 🎯 **研究动机**：向云端 LLM 提交原始查询会暴露敏感意图，只用本地模型又损失答案质量
- 🔬 **研究方法**：GTKA 把权衡建模为博弈：隐私感知子查询分解、对抗重建攻击者度量泄漏、可信本地整合器合成答案
- 📌 **结论**：在降低意图泄漏的同时逼近云端答案质量
...
### 277. PAC-BENCH: Evaluating Multi-Agent Collaboration under Privacy Constraints

🎓 [Official](https://aclanthology.org/2026.findings-acl.1552/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`benchmark`、`PAC-BENCH`、`multi-agent collaboration`、`privacy-constrained behavior`、`collaboration dynamics`

👤 **作者**：Minjun Park、…、Jinyoung Yeo

- 🎯 **研究动机**：个人与组织的专用智能体相互协作渐成常态，协作过程受隐私约束的行为动态缺乏理解（源摘要截断）
- 🔬 **研究方法**：PAC-BENCH 基准系统评估多智能体在隐私约束下的协作行为
- 📌 **结论**：为多智能体协作中的隐私风险提供首个量化评测基准

<details>
<summary>📝 展开完整英文摘要（Abstract）</summary>

We are entering an era in which individuals and organizations increasingly deploy dedicated AI agents that interact and collaborate with other agents.However, the dynamics of multi-agent collaboration under privacy constraints remain poorly understood.In this work, we present PAC -

</details>


### 278. LDEDE: LRP-Driven Efficient Detection and Editing Framework for LLM Privacy Neurons

🎓 [Official](https://aclanthology.org/2026.findings-acl.1666/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`LDEDE`、`privacy neuron editing`、`layer-wise relevance propagation`、`GDPR-compliant deployment`

👤 **作者**：Zhao Zhengyuan、…、Yang Xiaocheng

- 🎯 **研究动机**：训练数据敏感信息因模型记忆而泄漏，已有神经元编辑在定位精度与效率间失衡
- 🔬 **研究方法**：LDEDE 用层级相关性传播高效定位隐私神经元并直接编辑，面向 GDPR 合规部署
- 📌 **结论**：更准确高效地移除隐私敏感信息
...
### 279. Memory Dial: A Training Framework for Controllable Memorization in Language Models

🎓 [Official](https://aclanthology.org/2026.findings-acl.179/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`tool`、`Memory Dial`、`controllable memorization`、`temperature sharpening`、`memorization causal study`

👤 **作者**：Xiangbo Zhang、Ali Emami

- 🎯 **研究动机**：事后检测难以把记忆化与架构、数据及优化解耦，记忆化的因果影响不清
- 🔬 **研究方法**：Memory Dial 以单参数在交叉熵与温度锐化目标间插值，产出仅记忆压力不同的模型族
- 📌 **结论**：可单调调控记忆化，六种架构五个基准验证其对行为的影响
...
### 280. Adaptive Backtracking for Privacy Protection in Large Language Models

🎓 [Official](https://aclanthology.org/2026.findings-acl.1857/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`ABack`、`decoding-time privacy protection`、`PII leakage interception`、`intent-state modeling`

👤 **作者**：Zhihao Yao、…、Bing Qin

- 🎯 **研究动机**：RAG 隐私防御受隐私-可用性权衡制约，且缺正式 PII 基准
- 🔬 **研究方法**：ABack 免训练同步监控解码，建模心理状态捕捉初始泄漏意图并改写响应；另构建 PII 对抗基准
- 📌 **结论**：对抗攻击下隐私保护较强基线最高提升 14%，且不损响应效用
...
### 281. LLEOT: A Privacy-Enhancing Offsite Tuning Framework via Loss Landscape Elevation

🎓 [Official](https://aclanthology.org/2026.findings-acl.1878/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`LLEOT`、`offsite tuning`、`loss landscape elevation`、`simulator misuse prevention`

👤 **作者**：Jin Zhong、Jinglin Liang、Tongtong Yang、Zijian Xie、Shuangping Huang、Hanlin Gu

- 🎯 **研究动机**：Offsite Tuning 模拟器保留较强推理能力，暴露模型能力隐私与误用风险
- 🔬 **研究方法**：LLEOT 以 Loss Landscape Elevation 强制模拟器与原模型损失面固定边距，理论上同时放大模拟器困惑度并保持梯度对齐
- 📌 **结论**：下游适配性能稳健，同时有效抑制模拟器误用，兼顾数据与模型能力隐私
...
### 282. Controlling What You Share: Assessing Language Model Adherence to Privacy Preferences

🎓 [Official](https://aclanthology.org/2026.findings-acl.1990/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`privacy preference adherence`、`local query rewriting`、`PEEP dataset`、`PROFIT training`

👤 **作者**：Guillem Ramírez、Alexandra Birch、Ivan Titov

- 🎯 **研究动机**：调用商用 LLM API 被迫整体暴露用户数据，缺可控披露机制
- 🔬 **研究方法**：以自然语言隐私档案声明禁披露项，本地小模型据此改写查询再外发；配套 PEEP 数据集与 PROFIT 训练
- 📌 **结论**：训练后轻量本地模型隐私保护显著更好，性能比肩大模型 few-shot
...
### 283. Look Twice before You Leap: A Rational Framework for Localized Adversarial Text Anonymization

🎓 [Official](https://aclanthology.org/2026.findings-acl.274/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`RLAA`、`adversarial text anonymization`、`attacker-arbitrator-anonymizer loop`、`rational early stopping`

👤 **作者**：Donghang Duan、Xu Zheng、Yuefeng He、Chong Mu、Leyi Cai、Lizong Zhang

- 🎯 **研究动机**：文本匿名化依赖远程 API 造成隐私悖论，迁至本地小模型又因贪婪对抗策略效用崩塌
- 🔬 **研究方法**：RLAA 免训练本地框架：Attacker-Arbitrator-Anonymizer 以边际隐私收益/边际效用成本权衡替代贪婪策略，仲裁者过滤幽灵泄漏实现理性早停
- 📌 **结论**：多基准上取得更优隐私-效用权衡，结构性避免效用坍塌
...
### 284. AudioPrivacy: Parallel Audio Dataset for Speaker Profiling with Diverse Audio Types and Rich Attributes

🎓 [Official](https://aclanthology.org/2026.findings-acl.283/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`benchmark`、`AudioPrivacy`、`speaker attribute profiling`、`parallel audio dataset`、`attribute inference leakage`

👤 **作者**：Jiabei He、Yanzhe Zhang、Jiaming Zhou、Hui Wang、Haoqin Sun、Yong Qin

- 🎯 **研究动机**：语音隐私研究聚焦身份声纹，说话人属性隐私（SAP）泄漏缺乏系统评估
- 🔬 **研究方法**：构建 227.3 小时、1000 说话人、四类并行模态（含非发声信号）与 11 属性的中文数据集并评测属性推断泄漏
- 📌 **结论**：多属性显著泄漏，非发声信号亦可推断；MM-LLM 可精确画像并加剧风险
...
### 285. LeakDojo: Decoding the Leakage Threats of RAG Systems

🎓 [Official](https://aclanthology.org/2026.findings-acl.287/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`benchmark`、`LeakDojo`、`RAG database leakage`、`controlled leakage evaluation`、`instruction-following leakage link`

👤 **作者**：Maosen Zhang、…、Han Qiu

- 🎯 **研究动机**：RAG 系统的数据库泄漏风险缺乏系统性受控评估
- 🔬 **研究方法**：LeakDojo 可配置框架跨 14 个 LLM、4 个数据集与多样 RAG 系统，基准测试六种既有泄漏攻击
- 📌 **结论**：查询生成与对抗指令独立贡献泄漏且近似乘积；指令遵循越强泄漏越高，RAG 忠实度提升反增泄漏
...
### 286. SEAD: A Surrogate-free Label-only Membership Inference Attack against Pre-trained LLMs with Semantic-Aware Density

🎓 [Official](https://aclanthology.org/2026.findings-acl.337/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`attack`、`SEAD`、`membership inference`、`label-only attack`、`semantic-aware density estimation`

👤 **作者**：Biao Yi、…、Dacheng Tao

- 🎯 **研究动机**：label-only MIA 依赖代理模型估计目标概率，对代理选择敏感且误差大
- 🔬 **研究方法**：SEAD 对目标模型自身蒙特卡洛采样直接估计 token 概率，语义感知密度同时计精确匹配与语义等价 token
- 📌 **结论**：概率估计误差降低一个数量级，攻击效果持续超越既有方法
...
### 287. Adaptive Text Anonymization: Learning Privacy-Utility Trade-offs via Prompt Optimization

🎓 [Official](https://aclanthology.org/2026.findings-acl.401/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`adaptive text anonymization`、`prompt optimization`、`downstream-aware privacy policy`、`privacy-utility trade-off`

👤 **作者**：Gabriel Loiseau、Damien Sileo、Damien Riquet、Maxime Meyer、Marc Tommasi

- 🎯 **研究动机**：文本匿名化的隐私-效用平衡随领域与下游用途变化，静态手工策略难泛化
- 🔬 **研究方法**：将匿名化策略自适应形式化为新任务，以任务特定提示优化自动构建面向隐私目标与用途的匿名化指令
- 📌 **结论**：五数据集基准上全面更优权衡，开源小模型比肩闭源大模型
...
### 288. ProxyPrompt: Securing System Prompts against Prompt Extraction Attacks

🎓 [Official](https://aclanthology.org/2026.findings-acl.429/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`ProxyPrompt`、`system prompt protection`、`prompt extraction resistance`、`surrogate prompt`

👤 **作者**：Zhixiong Zhuang、Maria-Irina Nicolae、Hui-Po Wang、Mario Fritz

- 🎯 **研究动机**：system prompt 编码敏感信息与过滤规则，既有抗提取防御易被绕过或需频繁更新
- 🔬 **研究方法**：以保持任务效用的代理 prompt 替换原 prompt，令攻击者无法复现任务或获取敏感信息
- 📌 **结论**：264 组提示-模型对上保护率 94.70%，远超次优防御的 42.80%
...
### 289. Do Multimodal RAG Systems Leak Data? A Comprehensive Evaluation of Membership Inference and Image Caption Retrieval Attacks

🎓 [Official](https://aclanthology.org/2026.findings-acl.444/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`analysis`、`multimodal RAG privacy`、`membership inference`、`image caption retrieval attack`、`leakage evaluation`

👤 **作者**：Ali Al-Lawati、Suhang Wang

- 🎯 **研究动机**：多模态 RAG 连接私有数据集，其隐私泄漏风险缺乏实证分析
- 🔬 **研究方法**：经标准提示实施成员推理与图片说明检索攻击，判定视觉资产是否入库并泄漏其元数据
- 📌 **结论**：证实 mRAG 管道存在可观隐私泄漏，呼吁隐私保护机制
...
### 290. PII-VisBench: Evaluating Personally Identifiable Information Safety in Vision Language Models Along a Continuum of Visibility

🎓 [Official](https://aclanthology.org/2026.findings-acl.501/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`benchmark`、`PII-VisBench`、`PII disclosure`、`online visibility continuum`、`VLM privacy gradient`

👤 **作者**：G Shahariar、Zabir Al Nazi、Md Bhuiyan、Zhouxing Shi

- 🎯 **研究动机**：VLM 的 PII 泄漏评测视隐私为静态抽取，忽视主体在线存在度的连续影响
- 🔬 **研究方法**：4000 探针按 200 主体的四档在线可见度分层，以拒答率与条件 PII 披露率评测 18 个开源 VLM
- 📌 **结论**：各模型拒答率与披露率随在线可见度呈一致梯度（高可见度披露 9.10% 起），隐私对齐存在系统性缺口

<details>
<summary>📝 展开完整英文摘要（Abstract）</summary>

Vision Language Models (VLMs) are increasingly integrated into privacy-critical domains, yet existing evaluations of personally identifiable information (PII) leakage largely treat privacy as a static extraction task and ignore how a subject’s online presence—the volume of their data available online—influences privacy alignment. We introduce PII-VisBench , a novel benchmark containing 4,000 unique probes designed to evaluate VLM safety through the continuum of online presence . The benchmark stratifies 200 subjects into four visibility categories: high, medium, low, and zero —based on the extent and nature of their information available online. We evaluate 18 open-source VLMs (0.3B–32B) based on two key metrics: percentage of PII probing queries refused ( Refusal Rate ) and the fraction of non-refusal responses flagged for containing PII ( Conditional PII Disclosure Rate ). Across models, we observe a consistent pattern: refusals increase and PII disclosures decrease (9.10% high →

</details>


### 291. Understanding Secret Leakage Risks in Code LLMs: A Tokenization Perspective

🎓 [Official](https://aclanthology.org/2026.findings-acl.6/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`analysis`、`secret leakage`、`BPE tokenization bias`、`gibberish bias`、`code LLM memorization`

👤 **作者**：Meifang Chen、…、Michael Lyu

- 🎯 **研究动机**：代码 LLM 因记忆无意泄漏代码密钥构成网络安全风险，tokenization 的影响不明
- 🔬 **研究方法**：揭示 BPE 分词的 gibberish bias：字符级熵高而 token 级熵低的密钥最易被记忆，归因于训练与密钥数据的 token 分布偏移
- 📌 **结论**：大词表趋势加剧该偏差，需在分词器设计中纳入密钥记忆缓解
...
### 292. Detecting Sensitive Personal Information in Japanese Pre-Training Corpora for Large Language Models

🎓 [Official](https://aclanthology.org/2026.findings-acl.653/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`detection`、`sensitive personal information`、`Japanese pre-training corpora`、`APPI compliance`、`corpus screening`

👤 **作者**：Rei Minamoto、Yusuke Oda、Daisuke Kawahara

- 🎯 **研究动机**：日语预训练语料中要特别注意个人信息（SCPI）的检测研究缺失，威胁合规与泄漏
- 🔬 **研究方法**：基于 APPI 法定义构建 LLM 标注的 SCPI 数据集，训练机器学习分类器快速检测语料中的 SCPI
- 📌 **结论**：SCPI 分类器可有效识别敏感信息，系首个日语研究并指出检测难点
...
### 293. AudioStealer: Extracting Audio Prompts via Shapley Value-Guided Query Search

🎓 [Official](https://aclanthology.org/2026.findings-acl.688/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`attack`、`AudioStealer`、`audio prompt stealing`、`Shapley value attribution`、`text-to-music IP`

👤 **作者**：Yingbin Jin、…、Xinfeng Li

- 🎯 **研究动机**：文生音乐提示成为高价值 IP，音频语义纠缠使提示窃取比文本图像域更难
- 🔬 **研究方法**：两阶段黑盒攻击：音频-语言嵌入引导的启发搜索定位候选，Shapley 值博弈归因精炼语义贡献，仅需影子模型
- 📌 **结论**：高文本一致性恢复原始提示，再生成音频保持强感知相似性
...
### 294. Your LLM Agent Can Leak Your Data: Data Exfiltration via Backdoored Tool Use

📄 [arXiv](https://arxiv.org/abs/2604.05432) · 🎓 [Official](https://aclanthology.org/2026.findings-acl.1257/)　📅 2026-04　🏷 ACL 2026 Findings

**关键词**：`tool-use agent`、`data exfiltration`

👤 **作者**：Wuyang Zhang、Shichao Pei

- 🎯 **研究动机**：研究 tool-use agent、data exfiltration 场景下的攻击面，重点考察 data exfiltration 如何影响目标模型或系统
- 🔬 **研究方法**：Back-Reveal 在微调 Agent 中植入语义触发器
- 📌 **结论**：激活后调用 memory tool 读取上下文并伪装成检索请求外传
...
### 295. Topology Matters: Measuring Memory Leakage in Multi-Agent LLMs

📄 [arXiv](https://arxiv.org/abs/2512.04668) · 🎓 [Official](https://aclanthology.org/2026.findings-acl.1980/)　📅 2025-12　🏷 ACL 2026 Findings

**关键词**：`attack`、`memory leakage`、`graph topology`、`PII extraction`

👤 **作者**：Jinbo Liu、…、Xiyang Hu

- 🎯 **研究动机**：针对通信 topology 如何影响 Agent memory 泄漏缺少定量研究
- 🔬 **研究方法**：针对通信 topology 如何影响 Agent memory 泄漏缺少定量研究；论文以 MAMA 的 Engram-Resonance 两阶段协议比较六类拓扑和多种攻击者位置
- 📌 **结论**：结果连接越密、距离越短且目标中心性越高时泄漏越严重，并支持 topology-aware access control
...
### 296. CAP: Controllable Alignment Prompting for Unlearning in LLMs
...
### 297. CiPO: Counterfactual Unlearning for Large Reasoning Models through Iterative Preference Optimization
...
### 298. CRISP: Persistent Concept Unlearning via Sparse Autoencoders
...
### 299. Decoding-Unlearning: Fact Forgetting via Entropy-Guided Inference
...
### 300. Forget What Matters, Keep the Rest: Selective Unlearning of Informative Tokens
...
### 301. From Narrow Unlearning to Emergent Misalignment in LLMs
...
### 302. JPU: Bridging Jailbreak Defense and Unlearning via On-Policy Path Rectification
...
### 303. Knowledge Beyond Language: Bridging the Gap in Multilingual Machine Unlearning Evaluation
...
### 304. LOTUS: Evolving Multimodal Unlearning via Hyperbolic Entailment and Lorentz Transport
...
### 305. Maximizing Local Entropy Where It Matters: Prefix-Aware Localized LLM Unlearning
...
### 306. Modeling LLM Unlearning as an Asymmetric Two-Task Learning Problem
...
### 307. REMIND: Memorization and Unlearning in LLMs Through the Lens of Input Loss Landscapes
...
### 308. Rendering Data Unlearnable by Exploiting LLM Alignment Mechanisms
...
### 309. Selective Span-Level Unlearning for Large Language Models
...
### 310. SGPVT: Self-Generated Proximal Visual Tokens for Mitigating Proximal Collateral Damage in MLLM Unlearning
...
### 311. Unlearners Can Lie: Evaluating and Improving Honesty in LLM Unlearning
...
### 312. CURaTE: Continual Unlearning in Real Time with Ensured Preservation of LLM Knowledge

🎓 [Official](https://aclanthology.org/2026.findings-acl.1102/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`CURaTE`、`continual unlearning`、`real-time refusal`、`utility preservation`

👤 **作者**：Seyun Bae、Seokhan Lee、Eunho Yang

- 🎯 **研究动机**：已有遗忘方法无法持续即时响应，更新累积降低效用并使敏感信息长期暴露
- 🔬 **研究方法**：CURaTE 训练句向量模型为遗忘请求建立尖锐决策边界，按输入相似度实时决定回答或拒绝
- 📌 **结论**：连续遗忘下维持效用并缩短敏感信息暴露窗口
...
### 313. Anatomy of Unlearning: The Dual Impact of Fact Salience and Model Fine-Tuning

🎓 [Official](https://aclanthology.org/2026.findings-acl.1287/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`analysis`、`machine unlearning`、`fact salience`、`pretraining versus SFT origin`、`DUAL benchmark`

👤 **作者**：Anna Borisiuk、Andrey Savchenko、Alexander Panchenko、Elena Tutubalina

- 🎯 **研究动机**：遗忘研究默认所有事实同等可遗忘，忽视知识来自预训练还是 SFT 的来源差异
- 🔬 **研究方法**：DUAL 基准含 28.6k Wikidata 三元组，以 Wikipedia 链接数与 LLM 打分标注流行度和显著性，对比两阶段遗忘行为
- 📌 **结论**：对遗忘数据先做 SFT 使遗忘更平滑、保留率提高 10–50%；直接遗忘预训练模型易反弹或灾难遗忘
...
### 314. Multimodal Unlearning Across Vision, Language, Video, and Audio: Survey of Methods, Datasets, and Benchmarks

🎓 [Official](https://aclanthology.org/2026.findings-acl.1379/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`survey`、`multimodal unlearning`、`cross-modal knowledge removal`、`unlearning taxonomy`、`datasets and benchmarks`

👤 **作者**：Nobin Sarwar、Shubhashis Roy Dipta、Zheyuan Liu、Vaidehi Patil

- 🎯 **研究动机**：多模态基础模型编码敏感、版权与不安全的跨模态关联，重训不可行且知识跨模态共享致定向遗忘困难
- 🔬 **研究方法**：系统综述视觉、语言、视频、音频的遗忘方法、数据集与基准，给出统一分类体系
- 📌 **结论**：厘清删除强度、保留、效率与可逆性的权衡及开放问题
...
### 315. From Domains to Instances: Dual-Granularity Data Synthesis for LLM Unlearning

🎓 [Official](https://aclanthology.org/2026.findings-acl.1424/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`benchmark`、`unlearning data synthesis`、`dual-granularity forget sets`、`target-model distribution matching`、`adversarial prompting`

👤 **作者**：Xiaoyu Xu、…、Haibo Hu

- 🎯 **研究动机**：已有遗忘基准难以真实反映模型实际学到的遗忘范围，域级与实例级粒度被混同
- 🔬 **研究方法**：形式化两种遗忘粒度，用目标模型自身经种子引导与对抗提示生成匹配其内部知识分布的遗忘集
- 📌 **结论**：相关性与多样性更优，Harry Potter 域相关性提升约 20%

<details>
<summary>📝 展开完整英文摘要（Abstract）</summary>

Although machine unlearning is essential for removing private, harmful, or copyrighted content from LLMs, current benchmarks often fail to faithfully represent the true “forgetting scope” learned by the model. We formalize two distinct unlearning granularities, domain-level and instance-level, and propose , an automated framework for synthesizing high-quality forget sets.Unlike prior work relying on external generators, exploits the target model per se to elicit data that matches its internal knowledge distribution through seed-guided and adversarial prompting. Our experiments across diverse benchmarks show that it achieves a superior balance of relevance, diversity, and efficiency. Quantitatively, in the Harry Potter domain, it improves relevance by ∼20

</details>


### 316. Before Forgetting, Learn to Remember: Revisiting Foundational Learning Failures in LVLM Unlearning Benchmarks

🎓 [Official](https://aclanthology.org/2026.findings-acl.1701/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`analysis`、`LVLM unlearning`、`under-memorization diagnosis`、`multi-hop curse`、`Exposure metric`

👤 **作者**：Junehyoung Kwon、MiHyeon Kim、Eunju Lee、JungMin Yun、Byeonggeuk Lim、YoungBin Kim

- 🎯 **研究动机**：遗忘基准用虚构身份时模型在第一阶段就没记住目标信息，后续遗忘评测不可靠
- 🔬 **研究方法**：诊断欠记忆与多跳诅咒，ReMem 以数据扩展、推理感知 QA 与多样视觉上下文保证先记住，并提出 Exposure 度量擦除深度
- 📌 **结论**：在可靠记忆基础上重测遗忘，暴露内部概率分布层面的残留
...
### 317. Direct Token Optimization: A Self-Contained Approach to Large Language Model Unlearning

🎓 [Official](https://aclanthology.org/2026.findings-acl.2088/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`DTO`、`token-level unlearning`、`utility-preserving regularization`、`self-contained optimization`

👤 **作者**：Hong Lee、Ruixuan Liu、Li Xiong

- 🎯 **研究动机**：现有 LLM 遗忘方法依赖辅助模型、保留集或商业服务，引入额外隐私风险
- 🔬 **研究方法**：DTO 直接优化 token 级目标：目标 token 最大化遗忘目标，非目标 token 施加效用保持正则
- 📌 **结论**：多个遗忘基准上 forget quality 最高提升 16.8 倍，全程自包含无需外部资源
...
### 318. OFFSIDE: Benchmarking Unlearning Misinformation in Multimodal Large Language Models

🎓 [Official](https://aclanthology.org/2026.findings-acl.613/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`benchmark`、`OFFSIDE`、`multimodal misinformation unlearning`、`relearning recovery`、`prompt attack robustness`

👤 **作者**：Hao Zheng、…、Jiaheng Wei

- 🎯 **研究动机**：MLLM 遗忘基准受限于图像多样性差、遗忘目标粗粒度与评测场景单一
- 🔬 **研究方法**：构建 15.68K 记录、80 球员的人工错误信息遗忘基准 OFFSIDE，四测试集评估遗忘效力、泛化、效用与鲁棒性
- 📌 **结论**：遗忘的谣言易经再学习恢复且所有方法惧怕提示攻击；单模态方法难处理多模态谣言
...
### 319. AGTAO: Robust and Stabilized LLM Unlearning via Adversarial Gating Training with Adaptive Orthogonality

🎓 [Official](https://aclanthology.org/2026.findings-acl.665/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`AGTAO`、`adversarial gating training`、`unlearning robustness`、`adaptive orthogonality`

👤 **作者**：Pengyu Li、…、Jun Liu

- 🎯 **研究动机**：激进遗忘引发灾难性遗忘损效用，保守遗忘又留对抗恢复漏洞
- 🔬 **研究方法**：AGTAO 以对抗门控训练与自适应正交性约束，在遗忘彻底性、效用保持与抗对抗恢复间取得平衡
- 📌 **结论**：实现鲁棒且稳定的 LLM 遗忘，兼顾模型效用与抵御对抗性恢复

<details>
<summary>📝 展开完整英文摘要（Abstract）</summary>

While Large Language Models (LLMs) have achieved remarkable capabilities, they unintentionally memorize sensitive data, posing critical privacy and security risks.Machine unlearning is pivotal for mitigating these risks, yet existing paradigms face a fundamental dilemma: aggressive unlearning often induces catastrophic forgetting that degrades model utility, whereas conservative strategies risk superficial forgetting, leaving models vulnerable to adversarial recovery. To address this trade-off, we propose AGT AO
...
### 320. AgentMark: Utility-Preserving Behavioral Watermarking for Agents
...
### 321. A Linguistics-Aware LLM Watermarking via Syntactic Predictability
...
### 322. Distillation Traps and Guards: A Calibration Knob for LLM Distillability
...
### 323. Don’t Corrupt the Fact: A Trustworthy RAG Watermarking Framework based on Dual Factual Shield
...
### 324. Fingerprinting LLMs via Prompt Injection
...
### 325. From TDMA to CDMA: A Multi-bit Watermark for Diffusion Language Models
...
### 326. Gap-K%: Measuring Top-1 Prediction Gap for Detecting Pretraining Data
...
### 327. PDR: A Plug-and-Play Positional Decay Framework for LLM Pre-training Data Detection
...
### 328. PROMPRINT: Prompt Fingerprinting via First-Token Response for LLM App Cloning Detection
...
### 329. Protecting Language Models Against Unauthorized Distillation through Trace Rewriting
...
### 330. QuantileMark: A Message-Symmetric Multi-bit Watermark for LLMs
...
### 331. ReasMark: A Robust Watermark for Attributing LLM Reasoning Under Knowledge Distillation Attacks
...
### 332. SSG: Logit-Balanced Vocabulary Partitioning for LLM Watermarking
...
### 333. SWAN: Semantic Watermarking with Abstract Meaning Representation
...
### 334. UMMF: Protecting Copyright of Large Vision-Language Models through Unlearning-based Multimodal Memorization Fingerprint
...
### 335. XMark: Reliable Multi-Bit Watermarking for LLM-Generated Texts
...
### 336. You Can Have a Second Chance: Unbiased and Multi-bit Watermarking for Diffusion Language Models with Regret-based Remasking
...
### 337. Beyond A Fixed Seal: Adaptive Stealing Watermark in Large Language Models

🎓 [Official](https://aclanthology.org/2026.findings-acl.1036/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`attack`、`watermark stealing`、`adaptive seal construction`、`position-based seal`、`watermark reliability`

👤 **作者**：Shuhao Zhang、Yuli Chen、Jiale Han、Bo Cheng、Jiabao Ma

- 🎯 **研究动机**：水印窃取算法策略固定，忽视窃得水印信息的非均匀分布与真实生成过程的动态性
- 🔬 **研究方法**：Adaptive Stealing 以 Position-Based Seal Construction 与自适应选择模块，从上下文有序 token 的激活态定义多攻击视角
- 📌 **结论**：从受害者输出窃取水印并构造强针对性攻击，进一步削弱水印可靠性
...
### 338. Knowledge-Infused Multi-Bit Watermarking for RAG Knowledge Bases

🎓 [Official](https://aclanthology.org/2026.findings-acl.1066/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`RAG knowledge base watermarking`、`multi-bit watermark`、`knowledge completion`、`Watermark Text Indexer`

👤 **作者**：Ke Yang、Shuguang Yuan、Jing Yu、Chi Chen

- 🎯 **研究动机**：RAG 知识库 IP 价值高，已有水印编码容量有限且可能损害检索或知识质量
- 🔬 **研究方法**：KMW 借良性知识补全生成携带多比特水印的文本，配 Watermark Text Indexer 优化查询以稳定检出
- 📌 **结论**：在保知识质量与 RAG 性能的同时实现可检索的多比特水印
...
### 339. DualGuard: Dual-stream Large Language Model Watermarking Defense against Paraphrase and Spoofing Attack

🎓 [Official](https://aclanthology.org/2026.findings-acl.1169/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`DualGuard`、`dual-stream watermark`、`spoofing resistance`、`paraphrase robustness`

👤 **作者**：Hao Li、…、Li Guo

- 🎯 **研究动机**：已有水印只防 paraphrase，忽视搭便车式 spoofing 可注入有害内容并破坏归因信任
- 🔬 **研究方法**：DualGuard 按语义内容动态注入两路互补水印信号，同时覆盖改写与伪造两类攻击
- 📌 **结论**：首个能同时防御 paraphrase 与 spoofing 的水印算法
...
### 340. Topic-Based Watermarks for Large Language Models

🎓 [Official](https://aclanthology.org/2026.findings-acl.1220/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`topic-based watermark`、`green-list token selection`、`robustness-fluency trade-off`

👤 **作者**：Alexander Nemecek、Yuzhou Jiang、Erman Ayday

- 🎯 **研究动机**：已有水印在攻击鲁棒性、生成质量与额外开销之间权衡明显
- 🔬 **研究方法**：按主题把词汇划分为对齐子集，对输入选中相关主题的 token 绿名单以嵌入水印
- 📌 **结论**：轻量实现下兼顾鲁棒性与文本流畅连贯
...
### 341. Position: LLM Watermarking Should Align Stakeholders’ Incentives for Practical Adoption

🎓 [Official](https://aclanthology.org/2026.findings-acl.1290/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`analysis`、`watermark adoption incentives`、`stakeholder misalignment`、`detection tool governance`、`deployment barriers`

👤 **作者**：Yepeng Liu、Xuandong Zhao、Dawn Song、Gregory Wornell、Yuheng Bu

- 🎯 **研究动机**：水印算法进展与实际部署滞后的落差，源于提供方、平台与终端用户激励错位
- 🔬 **研究方法**：从竞争风险、检测工具治理与归因问题三障碍，重审模型、文本与上下文三类水印的适用场景
- 📌 **结论**：窄场景如数据去污染、用户可控溯源与不诚实审稿人识别更可能落地
...
### 342. RShield: A User-level Traceable Backdoor Watermark for LLMs in Embedding-as-a-Service

🎓 [Official](https://aclanthology.org/2026.findings-acl.1347/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`RShield`、`backdoor watermark`、`user-level attribution`、`Embedding-as-a-Service`

👤 **作者**：Lingyun Xiang、…、Zhangjie Fu

- 🎯 **研究动机**：已有后门水印只有零比特检测能力，多用户 EaaS 场景无法定位侵权用户
- 🔬 **研究方法**：RShield 用 Reed-Solomon 纠错码与正交特征映射构造容错符号序列，轻量 Adapter 自适应注入多比特水印
- 📌 **结论**：模型提取攻击的噪声信道下仍可恢复用户级归因
...
### 343. Measuring Watermarking under Jailbreaking: ASR Inflation and Goal-Compliance Mismatch

🎓 [Official](https://aclanthology.org/2026.findings-acl.1797/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`analysis`、`watermark-jailbreak interaction`、`ASR inflation`、`goal-compliance mismatch`、`judge reliability`

👤 **作者**：Sungwoo Han、Sangjun Moon、Jingun Kwon、Hidetaka Kamigaito、Manabu Okumura

- 🎯 **研究动机**：水印研究默认良性提示，越狱改变生成分布后水印与对齐的交互未知
- 🔬 **研究方法**：在 4 个 LLM 与 Static、AutoDAN、DSN 三设定下评测 6 种水印方法，审查判分式 ASR 与危害的错位
- 📌 **结论**：水印会虚高 judge 判定的 ASR，且 ASR 上升并不代表有害目标达成
...
### 344. EntroBench: Evaluating LLM Watermarking Under Multi-Entropy Scenarios and Practical User Operations

🎓 [Official](https://aclanthology.org/2026.findings-acl.2089/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`benchmark`、`EntroBench`、`watermark evaluation`、`multi-entropy scenarios`、`user operation robustness`

👤 **作者**：Pengyuan Qin、Linnan Tu、Yuhan Ke、Hefei Ling

- 🎯 **研究动机**：水印评测囿于固定熵设定，忽视熵水平、任务差异与真实用户操作的影响
- 🔬 **研究方法**：EntroBench 覆盖三档熵与七类任务，经超参搜索公平评测八种水印方法的可检测性-质量权衡与鲁棒性
- 📌 **结论**：各方法难以跨熵一致；常见非对抗用户操作即可大幅削弱水印信号
...
### 345. Ghost in the Shell: Synonym-Aware Logit Shaping Fingerprint for Copyright Protection of Large Vision-Language Models

🎓 [Official](https://aclanthology.org/2026.findings-acl.273/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`SALSF`、`logit shaping fingerprint`、`LVLM copyright protection`、`synonym-aware token distribution`

👤 **作者**：Xiaofan Zheng、Xinghao Wang、Xiaojun Wan

- 🎯 **研究动机**：后门式 LVLM 指纹直接扭曲原预测，损害模态对齐并带来鲁棒-无害权衡
- 🔬 **研究方法**：SALSF 在 logit 空间重塑语义相近长尾 token 的分布以抬升语义簇概率，保持 top-1 预测及其概率近似不变
- 📌 **结论**：鲁棒嵌入指纹的同时最大程度保留正常输出与模型能力
...
### 346. Duplicate-Aware Controlled Code Generation: Enhancing Copyright Protection with Targeted Reordering Beam Search in LLMs

🎓 [Official](https://aclanthology.org/2026.findings-acl.280/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`TRBS`、`duplicate-aware decoding`、`verbatim reproduction suppression`、`FM-index detection`、`beam reordering`

👤 **作者**：Junbo Fu、Guoshuai Zhao、Linkang Yang、Yunqi Mi、Xueming Qian

- 🎯 **研究动机**：LLM 逐字复现受版权代码带来侵权风险，缺乏模型用户侧的控制手段
- 🔬 **研究方法**：提出 DACCG 任务与 TRBS 解码：FM-index 高效检测重复子串，spike-entropy 保护结构锚点并动态重排 beam 候选
- 📌 **结论**：多语言代码基准上有效减少逐字复现且保持功能质量
...
### 347. The Mark Fades: Adaptive Evolutionary Paraphrase-based Attack against LLM Watermarks

🎓 [Official](https://aclanthology.org/2026.findings-acl.459/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`attack`、`TSAPA`、`watermark removal`、`evolutionary paraphrase`、`Pareto multi-objective search`

👤 **作者**：Yusheng Zhao、Jian Zhao、Tianle Zhang、Feng Wei、Xuelong Li

- 🎯 **研究动机**：既有释义攻击难以平衡水印移除效果与文本质量
- 🔬 **研究方法**：TSAPA 免训练进化框架将水印移除建模为约束多目标优化，遗传算法沿 Pareto 前沿搜索，PLL 引导变异精准修改载水印 token
- 📌 **结论**：Qwen3 系列多种水印方案上 ASR 超 90% 且语义保真度高
...
### 348. AI use in American newspapers is widespread, uneven, and rarely disclosed
...
### 349. Authorship Attribution in Multilingual Machine-Generated Texts
...
### 350. Beyond the Final Actor: Modeling the Dual Roles of Creator and Editor for Fine-Grained LLM-Generated Text Detection
...
### 351. Breaking the Generator Barrier: Disentangled Representation for Generalizable AI-Text Detection
...
### 352. Can AI-Generated Persuasion Be Detected? Persuaficial Benchmark and AI vs. Human Linguistic Differences
...
### 353. CoCoNUTS: Concentrating on Content while Neglecting Uninformative Textual Styles for AI-Generated Peer Review Detection
...
### 354. CodeRipple: Wavelet-Based Detection of LLM-Generated Code
...
### 355. DetectRL-X: Towards Reliable Multilingual and Real-World LLM-Generated Text Detection
...
### 356. Exons-Detect: Identifying and Amplifying Exonic Tokens via Hidden-State Discrepancy for Robust AI-Generated Text Detection
...
### 357. Explainable Disentangled Representation Learning for Generalizable Authorship Attribution in the Era of Generative AI
...
### 358. Identifying Bias in Machine-generated Text Detection
...
### 359. LAMCL: A Length-aware Momentum Contrastive Learning Framework for Multiscale Machine-Revised Text Detection
...
### 360. Verifiable LLM-Generated Text Detection via Projected Semantic-Structural Distributions
...
### 361. When Personalization Tricks Detectors: The Feature-Inversion Trap in Machine-Generated Text Detection
...
### 362. Who Wrote This Line? Evaluating the Detection of LLM-Generated Classical Chinese Poetry
...
### 363. Breaking the “Provable Security”: Detecting Finite-Precision Artifacts in LLM-based Steganography via Low-Probability Vanishing

🎓 [Official](https://aclanthology.org/2026.findings-acl.1013/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`detection`、`LLM steganography`、`finite-precision artifacts`、`Low-Probability Vanishing`、`statistical hypothesis testing`

👤 **作者**：Wenzhao Cao、Yaofei Wang、Donghui Hu

- 🎯 **研究动机**：生成式语言隐写以分布对齐自称可证明安全，有限精度算术留下的可检测痕迹未被审视
- 🔬 **研究方法**：指出 Low-Probability Vanishing 漏洞，RRNs-HT 将检测转为对采样机制的统计假设检验，并在同源设定下隔离伪影
- 📌 **结论**：以高检出率攻破 AC、Meteor 等方案的安全声明
...
### 364. Reasoning-Aware AIGC Detection via Alignment and Reinforcement

🎓 [Official](https://aclanthology.org/2026.findings-acl.1043/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`detection`、`AIGC detection`、`REVEAL`、`explainable reasoning chain`、`AIGC-text-bank`

👤 **作者**：Zhao Wang、Max Xiong、Jianxun Lian、Zhicheng Dou

- 🎯 **研究动机**：模型持续演进下 AIGC 检测的可靠性与可解释性不足，且缺乏多域多来源数据
- 🔬 **研究方法**：构建 AIGC-text-bank 多域多作者场景数据集，REVEAL 先生成可解释推理链再分类，SFT 加 RL 两阶段训练
- 📌 **结论**：多个基准取得 SOTA，兼顾检测准确与过程透明
...
### 365. CEAID: Benchmark of Multilingual Machine-Generated Text Detection Methods for Central European Languages

🎓 [Official](https://aclanthology.org/2026.findings-acl.1458/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`benchmark`、`CEAID`、`Central European languages`、`multilingual MGT detection`、`adversarial transferability`

👤 **作者**：Dominik Macko、Jakub Kopál

- 🎯 **研究动机**：机器生成文本检测集中于英语，检测器对中欧语言的跨语言可迁移性几乎未探明
- 🔬 **研究方法**：CEAID 做多域、多生成器、多语言组合评测，并考察检测方法的对抗鲁棒性
- 📌 **结论**：中欧语言上监督微调检测器效果与抗攻击性最佳
...
### 366. MASH: Evading Black-Box AI-Generated Text Detectors via Style Humanization

🎓 [Official](https://aclanthology.org/2026.findings-acl.1487/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`attack`、`MASH`、`detector evasion`、`style humanization`、`DPO rewriting`

👤 **作者**：Yongtong Gu、Songze Li、Xia Hu

- 🎯 **研究动机**：AIGT 检测器对对抗规避十分脆弱，已有逃逸依赖白盒假设或高昂计算交互成本
- 🔬 **研究方法**：MASH 依次用风格注入 SFT、DPO 与推理时改写，把 AI 文本分布整形为人类写作风格
- 📌 **结论**：6 个数据集、5 个检测器上优于 11 个逃逸基线
...
### 367. C-ReD: A Comprehensive Chinese Benchmark for AI-Generated Text Detection Derived from Real-World Prompts

🎓 [Official](https://aclanthology.org/2026.findings-acl.2119/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`benchmark`、`C-ReD`、`Chinese AIGT detection`、`real-world prompts`、`unseen model generalization`

👤 **作者**：Chenxi Qing、…、Shu-Tao Xia

- 🎯 **研究动机**：中文 AI 生成文本检测基准存在模型多样性不足与数据同质化问题
- 🔬 **研究方法**：C-ReD 基于真实用户提示构建综合中文检测基准，覆盖多模型多领域
- 📌 **结论**：支持可靠域内检测，并对未见 LLM 与外部中文数据集强泛化
...
### 368. GigaCheck: Detecting LLM-generated Content via Object-Centric Span Localization

🎓 [Official](https://aclanthology.org/2026.findings-acl.213/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`detection`、`GigaCheck`、`span localization`、`DETR-style architecture`、`document-level provenance`

👤 **作者**：Irina Tolstykh、Aleksandra Tsybina、Sergey Yakubson、Aleksandr Gordeev、Vladimir Dokholyan、Maksim Kuprashevich

- 🎯 **研究动机**：生成文本激增而检测滞后于生成模型，滥用难防且需定位生成片段
- 🔬 **研究方法**：GigaCheck 文档级以微调 LLM 表示判别来源；span 级把生成片段当对象，以 DETR 式结构定位 AI 区间
- 📌 **结论**：三个分类与三个定位基准均鲁棒有效，共享骨干兼顾两场景
...
### 369. ExaGPT: Example-Based Machine-Generated Text Detection for Human Interpretability

🎓 [Official](https://aclanthology.org/2026.findings-acl.380/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`detection`、`ExaGPT`、`example-based detection`、`span-level evidence`、`human interpretability`

👤 **作者**：Ryuto Koike、Masahiro Kaneko、Ayana Niwa、Preslav Nakov、Naoaki Okazaki

- 🎯 **研究动机**：检测误判后果严重（如损及学术尊严），既有可解释检测与人类判断过程不对齐
- 🔬 **研究方法**：ExaGPT 以与人类写作/机器生成语料的相似 span 多寡判别来源，并提供逐 span 相似例证作为证据
- 📌 **结论**：四个领域三种生成器上大幅提升检测，人类评估证实例证更利于判断可靠性
...
### 370. WaveDetect: Robust Framework for Machine-Generated Text Detection via Wavelet Transform

🎓 [Official](https://aclanthology.org/2026.findings-acl.424/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`detection`、`WaveDetect`、`wavelet transform`、`time-frequency fingerprint`、`adversarial robustness`

👤 **作者**：Zhichen Liu、Kaitong Qin、Linhan He、Yang Xu

- 🎯 **研究动机**：依赖表层语义工件的检测在对抗扰动、跨域与模型演化下日益脆弱
- 🔬 **研究方法**：将输出概率建模为信号，经可微连续小波变换转换到时频域提取频谱指纹
- 📌 **结论**：RAID 等三个数据集达新 SOTA，抗攻击、跨主题与未见演化 LLM 均鲁棒
...
### 371. Leveraging Human and Machine Preferences for Zero-shot Detection of AI-Generated Text

🎓 [Official](https://aclanthology.org/2026.findings-acl.671/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`detection`、`HAPDA`、`zero-shot AIGT detection`、`human-machine preference divergence`、`token-level reweighting`

👤 **作者**：Lei Jiang、Desheng Wu、Xiaolong Zheng、Cuicui Luo

- 🎯 **研究动机**：零样本检测均等对待所有 token，忽视人与模型解读同一文本的预测差异信号
- 🔬 **研究方法**：HAPDA 联合微调人偏好与机偏好成对模型，以差异感知重加权校准 token 级检测分数
- 📌 **结论**：五个代表性基线在多种评测场景下检测性能一致显著提升
...
### 372. A Data-Centric Approach to Generalizable Speech Deepfake Detection
...
### 373. AEGIS: A Holistic Benchmark for Evaluating Forensic Analysis of AI-Generated Academic Images
...
### 374. All That Glisters Is Not Gold: A Benchmark for Reference-Free Counterfactual Financial Misinformation Detection
...
### 375. Beyond the Crowd: LLM-Augmented Community Notes for Governing Health Misinformation
...
### 376. Cultivating Forensic Reasoning for Generalizable Multimodal Manipulation Detection
...
### 377. DiNO: Disinformation Narrative Observer
...
### 378. FactVerse: A Benchmark for Factual Consistency in Interleaved Image–Text Generation
...
### 379. From Detection to Understanding: Multi-Turn Reasoning for Video Misinformation Analysis
...
### 380. From Form to Logic: Masked Reconstruction and Reasoning Distillation for Short Video Fake News Detection
...
### 381. Generating Attribution Reports for Manipulated Facial Images: A Dataset and Baseline
...
### 382. Is this chart lying to me? Automating the detection of misleading visualizations
...
### 383. LiveFact: A Dynamic, Time-Aware Benchmark for LLM-Driven Fake News Detection
...
### 384. Mask-to-Correct^+: Leveraging Retriever Diversity for Masking-guided Faithful Fact Correction
...
### 385. MedForge: Interpretable Medical Deepfake Detection via Forgery-aware Reasoning
...
### 386. Perception, Understanding and Reasoning: A Multimodal Benchmark for Video Fake News Detection
...
### 387. Protecting multimodal large language models against misleading visualizations
...
### 388. REFLEX: Self-Refining Explainable Fact-Checking via Verdict-Anchored Style Control
...
### 389. To Lie or Not to Lie? Investigating The Biased Spread of Global Lies by LLMs
...
### 390. TrendFact: A Benchmark Towards Hotspot Perception in Automatic Fact-Checking
...
### 391. VeriTaS: The First Dynamic Benchmark for Multimodal Automated Fact-Checking
...
### 392. What’s Left Unsaid? Detecting and Correcting Misleading Omissions in Multimodal News Previews
...
### 393. When Misinformation Speaks and Converses: Rethinking Fact-Checking in Audio Platforms
...
### 394. A Unified Feature Mixture Framework for Joint Speech and Singing Deepfake Detection

🎓 [Official](https://aclanthology.org/2026.findings-acl.1245/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`detection`、`GenuVoice`、`singing voice deepfake`、`mixture-of-experts fusion`、`speech-to-singing domain shift`

👤 **作者**：Aastha Sharma、Guangjing Wang

- 🎯 **研究动机**：语音转换与歌声合成抬升音频伪造风险，已有检测在 speech-to-singing 域移下严重失效
- 🔬 **研究方法**：GenuVoice 以 mixture-of-experts 融合 Wav2Vec 2.0、log-mel 与 MFCC 三视角，加语音保持的多域微调
- 📌 **结论**：CtrSVDD 上 EER 1.82%，适配歌唱域且不损语音检测
...
### 395. Fine-tuning with Hierarchical Prompting for Robust Propaganda Classification Across Annotation Schemas

🎓 [Official](https://aclanthology.org/2026.findings-acl.139/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`detection`、`propaganda classification`、`annotation schema robustness`、`hierarchical prompting`、`intent-oriented taxonomy`

👤 **作者**：Lukas Stähelin、…、Vera Schmitt

- 🎯 **研究动机**：社交媒体宣传检测受噪声短文本与低标注一致性拖累，不同标注体系下的方法差异不明
- 🔬 **研究方法**：提出意图导向的宣传技巧分类法并与既有体系对比，四个 LLM 上比较微调与分层提示 HiPP
- 📌 **结论**：微调是必要条件，HiPP 先细后聚的 prompting 更稳
...
### 396. Large Language Models Require Curated Context for Reliable Political Fact-Checking—Even with Reasoning and Web Search

🎓 [Official](https://aclanthology.org/2026.findings-acl.1467/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`analysis`、`political fact-checking`、`curated RAG`、`reasoning and web search limits`、`verification reliability`

👤 **作者**：Matthew DeVerna、Kai-Cheng Yang、Harry Yan、Filippo Menczer

- 🎯 **研究动机**：数百万用户已用带推理与联网的聊天机器人做核查，其端到端核查能力缺乏严格评估
- 🔬 **研究方法**：在 6,000+ 条 PolitiFact 核查声明上评测 15 个 LLM 的标准、推理与联网变体，并对比策展 RAG
- 📌 **结论**：推理收益甚微、联网仅中等提升；策展 RAG 使 macro F1 平均提升 233%
...
### 397. XLSR-MamBo: Scaling the Hybrid Mamba-Attention Backbone for Audio Deepfake Detection

🎓 [Official](https://aclanthology.org/2026.findings-acl.1573/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`detection`、`XLSR-MamBo`、`audio deepfake detection`、`Mamba-attention hybrid`、`backbone topology comparison`

👤 **作者**：Kwok-Ho Ng、Tingting Song、Yongdong WU、Zhihua Xia

- 🎯 **研究动机**：语音合成以假乱真带来安全风险，纯因果 SSM 难捕获全局频域伪影
- 🔬 **研究方法**：XLSR-MamBo 组合 XLSR 前端与 Mamba、Mamba2、Hydra 等混合骨干，系统比较四种拓扑
- 📌 **结论**：ASVspoof 2021 LA、DF 与 In-the-Wild 上具竞争力
...
### 398. Detecting AI-Generated Video: A Vision–Language Dual-View Survey

🎓 [Official](https://aclanthology.org/2026.findings-acl.1613/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`survey`、`AI-generated video detection`、`vision-language dual view`、`fact fidelity verification`、`paradigm shift`

👤 **作者**：Dylan Hou、…、Yuhan Liu

- 🎯 **研究动机**：生成视频日益逼真，基于低层伪影的传统检测范式日渐失效
- 🔬 **研究方法**：把 AIGC-V 检测重构为事实保真度验证，以视觉-语言双视角四层分类综述现有方法
- 📌 **结论**：梳理从伪影匹配到语义证据验证的范式迁移路径
...
### 399. HCFD: A Benchmark for Audio Deepfake Detection in Healthcare

🎓 [Official](https://aclanthology.org/2026.findings-acl.1739/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`benchmark`、`HCFD`、`healthcare audio deepfake`、`pathological speech`、`PHOENIX-Mamba`

👤 **作者**：Mohd Akhtar、Muskaan Singh

- 🎯 **研究动机**：主流编解码伪造检测器训练于健康语音，病理语音条件下的表现未知
- 🔬 **研究方法**：发布首个病理感知数据集 Healthcare CodecFake（真实与神经编解码合成配对），并提出 PHOENIX-Mamba 检测模型
- 📌 **结论**：SOTA 检测器在病理语音上显著退化，凸显医疗场景适配需求
...
### 400. GAVEL: Evidence-Contract Debate with Mechanized Scrutiny for Provenance-Grounded Fact-Checking

🎓 [Official](https://aclanthology.org/2026.findings-acl.1789/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`GAVEL`、`evidence-contract debate`、`provenance-grounded fact-checking`、`mechanized scrutiny`

👤 **作者**：Ruoyu Xu、Gaoxiang Li、Victor Sheng

- 🎯 **研究动机**：多智能体核查仍会产出证据薄弱却具说服力的结论，多跳异构证据下溯源失效
- 🔬 **研究方法**：GAVEL 要求辩方以 Evidence Contract 把原子子声明绑定到证据单元，Scrutinizer 对引用做确定性校验
- 📌 **结论**：提升细粒度证据溯源下的核查可靠性与可审计性
...
### 401. Beyond Evidence: Belief-Chain Conditioning for Persuasive Misinformation Debunking Explanation

🎓 [Official](https://aclanthology.org/2026.findings-acl.2076/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`belief-chain conditioning`、`misinformation debunking`、`theory-of-mind explanation`、`persuasive correction`

👤 **作者**：Yi-Li Hsu、Li-Wun Chang、Chun-Yu Hsu、Wei-Kuan Shih、Aiping Xiong、Lun-Wei Ku

- 🎯 **研究动机**：持强虚假信念者抗拒更正，LLM 辟谣解释默认中立、说服力不足
- 🔬 **研究方法**：从信/不信两视角实例化认知链（情境-线索-想法-行动-情绪）并条件化生成解释，以 GPT-4.1 角色扮演对照评测六维度
- 📌 **结论**：注入信者认知链显著提升错误信念受众的解释质量感知，验证 ToM 增强辟谣说服力
...
### 402. Indic-CodecFake meets SATYAM: Towards Detecting Neural Audio Codec Synthesized Speech Deepfakes in Indic Languages

🎓 [Official](https://aclanthology.org/2026.findings-acl.2159/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`benchmark`、`Indic-CodecFake`、`codec-synthesized speech deepfake`、`Indic languages`、`SATYAM`

👤 **作者**：Mohd Akhtar、Orchid Chetia Phukan、Arun Buduru

- 🎯 **研究动机**：神经音频编解码合成语音的深伪检测集中于中英文，印度语言基本空白
- 🔬 **研究方法**：构建多印度语言 CodecFake 基准（多说话人多 NAC 类型），评测 SOTA 检测器与 ALM 零样本能力，并提出双曲 ALM 检测器 SATYAM
- 📌 **结论**：英文中心训练的 SOTA 检测器与 ALM 在印度语言上均显著失效
...
### 403. Do Not Guess, Verify: Logic-Guided Adaptive Reasoning for Multimodal Misinformation Detection

🎓 [Official](https://aclanthology.org/2026.findings-acl.238/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`detection`、`LoGAR`、`multimodal misinformation detection`、`logic-guided verification anchor`、`adaptive reasoning depth`

👤 **作者**：Kun Huang、Rui Qiu、Xiaoming Li、Salah Uddin

- 🎯 **研究动机**：多模态误信息检测依赖相关性特征聚合，易受伪关联与噪声干扰且无显式验证
- 🔬 **研究方法**：LoGAR 以 VLM 生成的显式验证依据为全局语义锚，引导多模态融合与社交图消息传递，并按实例自适应推理深度
- 📌 **结论**：多个多模态误信息基准超 SOTA 且计算成本显著降低
...
### 404. RTCFake: Speech Deepfake Detection in Real-Time Communication

🎓 [Official](https://aclanthology.org/2026.findings-acl.285/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`benchmark`、`RTCFake`、`real-time communication deepfake`、`platform-invariant representation`、`phoneme-guided consistency`

👤 **作者**：Jun Xue、…、Bo Cai

- 🎯 **研究动机**：语音深伪检测偏重离线仿真，难应对 RTC 传输中的未知语音增强与编解码失真
- 🔬 **研究方法**：构建经主流会议平台真实传输配对的 RTCFake 数据集（约 600 小时），提出音素引导一致性学习获取平台不变语义表征
- 📌 **结论**：在未见平台与复杂噪声评测集上检测显著提升，树立真实场景基准
...
### 405. When depth is redundant: Efficient transformer-based speech anti-spoofing

🎓 [Official](https://aclanthology.org/2026.findings-acl.318/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`detection`、`speech anti-spoofing`、`layer redundancy analysis`、`representation alignment`、`unseen attack generalization`

👤 **作者**：Hoan Tran、Damien Lolive、Aghilas Sini、Arnaud Delhay、Pierre-Francois Marteau、David Guennec

- 🎯 **研究动机**：深伪对抗模型对未见 spoofing 攻击泛化差，深层 transformer 相邻层表示冗余而浅层欠利用
- 🔬 **研究方法**：分析层级冗余并提出训练策略，显式对齐浅层与中间层表示至末层的任务特化表示
- 📌 **结论**：提升对未见攻击的域外检测鲁棒性，同时保持域内判别能力
...
### 406. LoReFact: Bridging the Logic Gap in Fact-Checking

🎓 [Official](https://aclanthology.org/2026.findings-acl.346/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`benchmark`、`LoReFact`、`logic-aware fact-checking`、`logical fallacy detection`、`LoReFactScore`

👤 **作者**：Qiming Xie、Wenjie Zheng、Xiangqing Shen、Rui Xia

- 🎯 **研究动机**：分解-验证式核查忽视事实间逻辑依赖，含逻辑谬误的文本可被误判为真
- 🔬 **研究方法**：提出内容-逻辑耦合事实性范式，构建 LoReFact 数据集、LoRe-Factcheck 框架与逻辑感知指标 LoReFactScore
- 📌 **结论**：验证逻辑事实性维度的重要性，联合评测可有效暴露并惩罚逻辑谬误
...
### 407. ICLAD: In-Context Learning with Comparison-Guidance for Audio Deepfake Detection

🎓 [Official](https://aclanthology.org/2026.findings-acl.450/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`detection`、`ICLAD`、`comparison-guided reasoning`、`audio language model`、`in-the-wild generalization`

👤 **作者**：Benjamin Chou、Yi Zhu、Surya Koppisetti

- 🎯 **研究动机**：SOTA 音频深伪检测系统对野外深伪泛化差
- 🔬 **研究方法**：ICLAD 以音频语言模型成对比较推理发现并过滤幻觉与无关声学属性，路由机制将 OOD 样本交给 ALM
- 📌 **结论**：野外数据集上 macro F1 相对专用检测器最高 2 倍提升，免训练且可解释
...
### 408. Same Claim, Different Judgment: Benchmarking Scenario-Induced Bias in Multilingual Financial Misinformation Detection

🎓 [Official](https://aclanthology.org/2026.findings-acl.479/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`benchmark`、`scenario-induced bias`、`multilingual financial misinformation`、`persona perturbation`、`judgment instability`

👤 **作者**：Zhiwei Liu、…、Sophia Ananiadou

- 🎯 **研究动机**：场景诱导偏差使同一金融误信息获不同判定，威胁高风险多语种检测
- 🔬 **研究方法**：与金融专家共建角色-人格/地域/族裔宗教三类场景与英中希腊孟四语误信息数据，系统评测 22 个 LLM
- 📌 **结论**：行为偏差显著，揭示金融误信息判定的场景不稳定性
...
### 409. Decide less, communicate more: On the construct validity of end-to-end fact-checking in medicine

🎓 [Official](https://aclanthology.org/2026.findings-acl.496/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`analysis`、`construct validity`、`medical fact-checking`、`expert evidence synthesis`、`task decomposition`

👤 **作者**：Sebastian Joseph、…、Junyi Li

- 🎯 **研究动机**：医学端到端事实核查智能体被寄予厚望却少被使用，其构念效度未受检验
- 🔬 **研究方法**：与临床专家合作研究专家如何综合医学证据核查社媒真实声明，以此确定任务性能上限
- 📌 **结论**：揭示证据连接困难、意图歧义与真值标签主观等根本挑战，主张分解式沟通设计
...
### 410. Propaganda Signals in LLMs: Perspectival Divergence and Narrative Framing in the Russia-Ukraine War

🎓 [Official](https://aclanthology.org/2026.findings-acl.557/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`analysis`、`propaganda framing`、`narrative bias quantification`、`Russia-Ukraine war coverage`、`perspectival divergence`

👤 **作者**：Ofir Shabat、Ido Guy、Kira Radinsky

- 🎯 **研究动机**：LLM 解释俄乌冲突时是否复现宣传叙事缺乏定量研究
- 🔬 **研究方法**：以中性事件陈述配 RU/UA 导向参考文本构建评测集，语义距离量化偏向并按五类宣传技巧剖析输出
- 📌 **结论**：各模型存在跨提示稳定的偏向与技巧画像，常规事实性指标无法捕捉
...
### 411. Probing Multimodal Large Language Models on Cognitive Biases in Chinese Short-Video Misinformation

🎓 [Official](https://aclanthology.org/2026.findings-acl.616/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`analysis`、`short-video health misinformation`、`cognitive bias robustness`、`social cue deception`、`MLLM probing`

👤 **作者**：Jen-tse Huang、Chang Chen、Shiyang Lai、Wenxuan Wang、Michelle Kaufman、Mark Dredze

- 🎯 **研究动机**：短视频健康误信息纠缠视觉实验与社会线索，MLLM 对认知偏差的鲁棒性未知
- 🔬 **研究方法**：200 条人工标注短视频覆盖四健康领域并标注三类欺骗模式，五种模态设定下评测 8 个前沿 MLLM
- 📌 **结论**：多模态最优的 Gemini-2.5-Pro 信念分仅 71.5/100、o3 仅 35.2，权威频道等社会线索诱导误信
...
### 412. Accommodation and Epistemic Vigilance: A Pragmatic Account of Why LLMs Fail to Challenge Harmful Beliefs
...
### 413. Are LLMs Reliable Rankers? Rank Manipulation via Two-Stage Token Optimization
...
### 414. Can Factual Opinions Be Edited (Manipulated) in Large Language Models?
...
### 415. Do LLM Agents Mirror Socio-Cognitive Effects in Power-Asymmetric Conversations?
...
### 416. Feeling Right vs. Being Right: How AI Sycophancy Affects Value-Laden Deliberation
...
### 417. Flattery in Motion: Benchmarking and Analyzing Sycophancy in Video-LLMs
...
### 418. Good Arguments Against the People Pleasers: How Reasoning Mitigates (Yet Masks) LLM Sycophancy
...
### 419. How Controllable Are Large Language Models? A Unified Evaluation across Behavioral Granularities
...
### 420. Inertia in Moral and Value Judgments of Large Language Models
...
### 421. Lying with Truths: Open-Channel Multi-Agent Collusion for Belief Manipulation via Generative Montage
...
### 422. Mind the (DH) Gap! A Contrast in Risky Choices Between Reasoning and Conversational LLMs
...
### 423. Narrative License and Model Sycophancy in LLM Summaries of Scientific Work
...
### 424. Quantifying and Mitigating Socially Desirable Responding in LLMs: A Desirability-Matched Graded Forced-Choice Psychometric Study
...
### 425. Social Dynamics as Critical Vulnerabilities that Undermine Objective Decision-Making in LLM Collectives
...
### 426. The Stackelberg Speaker: Optimizing Persuasive Communication in Social Deduction Games
...
### 427. Thinking-Based Non-Thinking: Solving the Reward Hacking Problem in Training Hybrid Reasoning Models via Reinforcement Learning
...
### 428. TinyJudge: Unverifiable Constraint Alignment via Lightweight Specialist Ensembles
...
### 429. Too Nice to Tell the Truth: Quantifying Agreeableness-Driven Sycophancy in Role-Playing Language Models
...
### 430. Trajectory Signatures of Deception in Large Language Models
...
### 431. Sounding vs. Being an Expert: Disentangling Authority, Register and Cultural Impact in Sycophantic LLMs

🎓 [Official](https://aclanthology.org/2026.findings-acl.1627/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`analysis`、`sycophancy`、`authority cues`、`linguistic register`、`cross-cultural variation`

👤 **作者**：Gabriele Maraia、Fabio Zanzotto、Leonardo Ranaldi

- 🎯 **研究动机**：迎合使模型附和错误断言，其社会语言学诱因（显性权威与语言语域）从未被分离
- 🔬 **研究方法**：Sycophancy Matrix 对抗框架隔离资历与语域变量，在 TruthfulQA 控制子集与英西葡变体上测开放权重模型
- 📌 **结论**：部分架构中高级语域比专家头衔更易诱发盲从，且跨文化变体差异显著
...
### 432. SycoBench-600: Measuring Sycophancy and Correction Selectivity in LLM Assistants

🎓 [Official](https://aclanthology.org/2026.findings-acl.1759/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`benchmark`、`SycoBench-600`、`sycophancy measurement`、`correction selectivity`、`social pressure perturbation`

👤 **作者**：Debu Sinha

- 🎯 **研究动机**：偏好对齐诱发迎合，在高风险建议中动摇可靠性，纳正与拒错的权衡未被测
- 🔬 **研究方法**：SycoBench-600 以质疑、权威与错误建议三种社会压力扰动测迎合，并测 correction selectivity
- 📌 **结论**：量化助手在压力下附和错误与拒绝正确建议的失衡
...
### 433. Measuring Large Language Models’ Adversarial Behavior in Social Deduction Games

🎓 [Official](https://aclanthology.org/2026.findings-acl.2043/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`analysis`、`social deduction games`、`adversarial behavior taxonomy`、`multi-agent simulation`、`social stability`

👤 **作者**：Marissa Li、Esha Shivakumar、Peiran Wang、Ying Li、Yuan Tian

- 🎯 **研究动机**：安全评测聚焦单轮拒答，LLM 交互社会情境中的对抗与欺骗行为未知
- 🔬 **研究方法**：五种社交推理游戏多智能体模拟施加社会压力，开放卡片分类构建行为分类学并以元 LLM 统一标注
- 📌 **结论**：各模型呈现稳定差异化行为画像，结构化审议方式影响社会稳定性与竞争胜率
...
### 436. Diagnosing and Mitigating Sycophancy and Skepticism in LLM Causal Judgment

🎓 [Official](https://aclanthology.org/2026.findings-acl.427/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`analysis`、`causal judgment`、`sycophancy and skepticism`、`recursive causal audit`、`CAUSALT3`

👤 **作者**：Edward Chang

- 🎯 **研究动机**：前沿 LLM 因果判断中屈服于压力与过度怀疑的危害未被诊断
- 🔬 **研究方法**：以 Utility/Safety/Wise-Refusal 三轴框定，提出免金标签的递归因果审计 RCA 与含陷阱族和压力协议的 CAUSALT3
- 📌 **结论**：发现怀疑陷阱（Claude Haiku 拒绝 60% 有效 L1 链接）与规模化悖论（GPT-5.2 在 L3 落后 55 分）
...
### 437. LLMs Deceive Unintentionally: Emergent Misalignment in Dishonesty from Misaligned Samples to Biased Human-AI Interactions

🎓 [Official](https://aclanthology.org/2026.findings-acl.455/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`analysis`、`emergent misalignment`、`dishonest fine-tuning spillover`、`biased human-AI interaction`、`data quality origin`

👤 **作者**：Xuhao Hu、Wang Peng、Xiaoya Lu、Dongrui Liu、Xuanjing Huang、Jing Shao

- 🎯 **研究动机**：窄域不诚实微调样本是否会外溢为广泛的非故意欺骗与错位尚不清楚
- 🔬 **研究方法**：分析不诚实样本微调向偏差化人机交互的传导路径，刻画 emergent misalignment 的表现
- 📌 **结论**：窄域错误完成微调可诱发跨域不诚实行为并扭曲人机交互，指向数据质量这一错位源头

<details>
<summary>📝 展开完整英文摘要（Abstract）</summary>

Previous research has shown that LLMs finetuned on incorrect completions within narrow domains ( e.g.

</details>


### 438. Detecting Proxy Gaming in RL and LLM Alignment via Evaluator Stress Tests

🎓 [Official](https://aclanthology.org/2026.findings-acl.513/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`detection`、`proxy gaming detection`、`evaluator stress test`、`reward hacking`、`specification gaming`

👤 **作者**：Sanjeda Akter、Ibne Shihab、Anuj Sharma

- 🎯 **研究动机**：代理优化利用评测器弱点而非改进目标，威胁 RL 奖励黑客与 LLM 对齐中的评测器投机
- 🔬 **研究方法**：Evaluator Stress Test 以受控扰动加语义有效性审计分离可利用敏感性与内容驱动改进，跨 RL 与 LLM 两域验证
- 📌 **结论**：RL 域 78.4% 精度/81.7% 召回，LLM 域 74.2%/78.6% 且早于质量下降预警；闭环缓解使人类胜率 +8.3 分
...
### 439. RLHS: Mitigating Misalignment in RLHF with Hindsight Simulation

🎓 [Official](https://aclanthology.org/2026.findings-acl.556/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`RLHS`、`hindsight simulation`、`Goodhart mitigation`、`RLHF misalignment`

👤 **作者**：Kaiqu Liang、Haimin Hu、Ryan Liu、Thomas Griffiths、Jaime Fisac

- 🎯 **研究动机**：RLHF 的评估者反馈依赖可被 AI 输出影响的下游预测，诱发 Goodhart 式系统性错位
- 🔬 **研究方法**：理论证明以后见模拟结果条件化反馈可解耦对齐信号，提出 RLHS 在三类咨询场景以 PPO/DPO 验证
- 📌 **结论**：对齐显著优于 RLHF；RLHF 单任务微调即损害 TruthfulQA 等真实性与可信基准
...
### 440. Achieving Multi-Hop Calculation and Safe Abstention in Financial Numerical Reasoning by Metric Graph Constrained LLMs
...
### 441. Calibrated? Not for Everyone: How Sexual Orientation and Religious Markers Distort LLM Accuracy and Confidence in Medical QA
...
### 442. CURA: Clinical Uncertainty Risk Alignment for Language Model–Based Risk Prediction
...
### 443. DeepGuard: Secure Code Generation via Multi-Layer Semantic Aggregation
...
### 444. Evaluating Structure-Aware Retrieval and Safety in Statute-Centric Legal QA
...
### 445. From Trust to Compromise: Outcome-Verified LLM Phishing Simulation and Real-Time Defense
...
### 446. LLMs (Almost) Never Abstain Under Medical Uncertainty
...
### 447. Mitigating Legal Hallucinations via Symbolic Constraints and Analogical Precedents
...
### 448. NaturalSloth: Revisiting Denial-of-Service Attacks on Large Language Models
...
### 449. ProMedical: Hierarchical Fine-Grained Criteria Modeling for Medical LLM Alignment via Explicit Injection
...
### 450. Responsible Evaluation of AI for Mental Health
...
### 451. RoboFailRing: Retrieval-Augmented and Language Grounding Failure Detection for VLM-enabled Robotic Manipulation
...
### 452. SAFE-QAQ: End-to-End Slow-Thinking Audio-Text Fraud Detection via Reinforcement Learning
...
### 453. SHAPE: Unifying Safety, Helpfulness and Pedagogy for Educational LLMs
...
### 454. SoundBreak: A Systematic Study of Audio-Only Adversarial Attacks on Trimodal Models
...
### 455. Still Between Us? Evaluating and Improving Voice Assistant Robustness to Third-Party Interruptions
...
### 456. When Background Matters: Breaking Medical Vision Language Models by Transferable Attack
...
### 457. A.S.E: A Repository-Level Benchmark for Evaluating Security in AI-Generated Code

🎓 [Official](https://aclanthology.org/2026.findings-acl.1569/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`benchmark`、`A.S.E`、`repository-level code security`、`AI-generated code`、`secure coding evaluation`

👤 **作者**：Keke Lian、…、Dong Zhang

- 🎯 **研究动机**：已有代码安全基准偏离真实 AI 辅助编程场景，难以评估生产环境风险
- 🔬 **研究方法**：A.S.E 以仓库级任务镜像真实编程场景，评测主流 LLM 生成代码的安全性
- 📌 **结论**：LLM 仍难以安全编码，片段级优势无法延续到仓库级复杂场景
...
### 458. MolSafeEval: A Benchmark for Uncovering Safety Risks in AI-Generated Molecules

🎓 [Official](https://aclanthology.org/2026.findings-acl.1679/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`benchmark`、`MolSafeEval`、`AI-generated molecules`、`toxicity knowledge graph`、`chemical safety evaluation`

👤 **作者**：Tong Xu、Xinzhe Cao、Zhihui Zhu、Keyan Ding、Huajun Chen

- 🎯 **研究动机**：分子生成基准只关注复杂度、新颖性与属性对齐，忽视生成分子的毒性等安全隐患
- 🔬 **研究方法**：MolSafeEval 整合毒理数据库与危险规则构建分子安全知识图，支撑 LLM 推理的系统检测
- 📌 **结论**：补上生成式化学的安全评测缺口
...
### 459. CCD: Mitigating Hallucinations in Radiology MLLMs via Clinical Contrastive Decoding

🎓 [Official](https://aclanthology.org/2026.findings-acl.1755/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`CCD`、`clinical contrastive decoding`、`radiology hallucination`、`training-free mitigation`

👤 **作者**：Xi Zhang、Zaiqiao Meng、Jake Lever、Edmond Ho

- 🎯 **研究动机**：放射 MLLM 常产出无临床依据的描述，在高风险医学场景可致误判
- 🔬 **研究方法**：发现对临床章节的过度敏感诱发幻觉，CCD 免训练免检索，用任务专家模型的双阶段对比修正 token logits
- 📌 **结论**：减少临床无据描述并增强图像接地
...
### 460. PrinciplismQA: A Philosophy-Grounded Approach to Assessing LLM-Human Clinical Medical Ethics Alignment

🎓 [Official](https://aclanthology.org/2026.findings-acl.1806/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`benchmark`、`PrinciplismQA`、`clinical ethics alignment`、`principlism framework`、`expert-validated items`

👤 **作者**：Chang Hong、…、Yan Hu

- 🎯 **研究动机**：医疗 LLM 临近临床部署，伦理权衡推理缺乏哲学框架锚定与专家校验的评估
- 🔬 **研究方法**：基于 Principlism 构建 3,648 道专家校验题，覆盖知识考察与临床推理两类
- 📌 **结论**：为临床伦理对齐提供可校验的评估方法与基准
...
### 461. Dialectic-Med: Mitigating Diagnostic Hallucinations via Counterfactual Adversarial Multi-Agent Debate

🎓 [Official](https://aclanthology.org/2026.findings-acl.1837/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`defense`、`Dialectic-Med`、`diagnostic hallucination`、`counterfactual adversarial debate`、`visual falsification module`

👤 **作者**：Zhixiang Lu、Jionglong Su

- 🎯 **研究动机**：医疗 MLLM 因确认偏误幻觉视觉细节以支撑错误诊断，CoT 缺乏内在纠错机制
- 🔬 **研究方法**：Dialectic-Med 三角色对抗辩证：Opponent 视觉证伪模块主动检索矛盾证据，Mediator 以加权共识图裁决冲突
- 📌 **结论**：MIMIC-CXR-VQA 等三个医学 VQA 基准达 SOTA，诊断幻觉与解释不忠实显著缓解
...
### 462. SafetyALFRED: Evaluating Safety-Conscious Planning of Vision Language Models

🎓 [Official](https://aclanthology.org/2026.findings-acl.1852/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`benchmark`、`SafetyALFRED`、`embodied safety planning`、`VLM hazard mitigation`、`kitchen environment tasks`

👤 **作者**：Josue Torres-Fonseca、…、Joyce Chai

- 🎯 **研究动机**：MLLM 安全评测止于脱离实体的问答式危险识别，未测主动风险消解能力
- 🔬 **研究方法**：在 ALFRED 上增补六类厨房危险构建 SafetyALFRED，评测 Qwen/Gemma/Gemini 11 个模型的识别与具身任务规划
- 📌 **结论**：模型 QA 识别准确但具身缓解成功率显著偏低，证明静态评测不足以保障物理安全
...
### 463. InferPilot: Autonomous Inference Attacks Against ML Services With LLM-Based Agents

🎓 [Official](https://aclanthology.org/2026.findings-acl.572/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`attack`、`InferPilot`、`autonomous inference attack`、`LLM attack agent`、`ML service risk probing`

👤 **作者**：Yixin Wu、Rui Wen、Chi Cui、Michael Backes、Yang Zhang

- 🎯 **研究动机**：推理攻击可系统评估 ML 服务风险，但最优攻击实施对非专家过于困难
- 🔬 **研究方法**：构建自主攻击智能体 InferPilot，多智能体框架与任务特定动作空间使其端到端执行推理攻击并自适应调参
- 📌 **结论**：20 个目标服务上 GPT-4o 任务完成率 100%、性能近专家，token 成本仅 0.627/次
...
### 464. Infinite Babble: Inflating 3D Vision-Language Model Inference Overhead via Adversarial Geometric Perturbation

🎓 [Official](https://aclanthology.org/2026.findings-acl.259/)　📅 2026-07　🏷 ACL 2026 Findings

**关键词**：`attack`、`3D-VLM DoS`、`geometric perturbation`、`EOS suppression`

👤 **作者**：Shuoyang Sun、…、Shu-Tao Xia

- 🎯 **研究动机**：针对 3D-VLM 会处理不可信点云且依赖自回归解码
- 🔬 **研究方法**：论文用 Inflate3D 扰动语义关键区域并压低 EOS 概率
- 📌 **结论**：结果在保持几何结构的同时将输出长度和能耗最高放大 6.45 倍
...
### 465. ATAAT: Adaptive Threat-Aware Adversarial Tuning Framework against Backdoor Attacks on Vision-Language-Action Models

📄 [arXiv](https://arxiv.org/abs/2605.08612) · 🎓 [Official](https://aclanthology.org/2026.findings-acl.1077/)　📅 2026-05　🏷 ACL 2026 Findings

**关键词**：`attack`、`visual pathway`、`gradient interference`、`semantic trigger`

👤 **作者**：Kewei Chen、Yayu Long、Shuai Li、Mingsheng Shang

- 🎯 **研究动机**：ATAAT 是攻击而非防御：它以 Threat-Method Adaptive Mapping 选择梯度解耦策略
- 🔬 **研究方法**：在 5% 投毒率下取得超过 80% 的 targeted ASR
- 📌 **结论**：并支持复杂语义级视觉触发器
...
### 466. SilentDrift: Exploiting Action Chunking for Stealthy Backdoor Attacks on Vision-Language-Action Models

📄 [arXiv](https://arxiv.org/abs/2601.14323) · 🎓 [Official](https://aclanthology.org/2026.findings-acl.1725/)　📅 2026-01　🏷 ACL 2026 Findings

**关键词**：`attack`、`action chunking`、`delta pose`、`trajectory drift`

👤 **作者**：Bingxin Xu、Yuzhang Shang、Binghui Wang、Emilio Ferrara

- 🎯 **研究动机**：研究 action chunking、delta pose 场景下的攻击面，重点考察 trajectory drift 如何影响目标模型或系统
- 🔬 **研究方法**：利用 action chunking 与 delta-pose integration 形成的 intra-chunk visual open loop
- 📌 **结论**：在 LIBERO 上以低于 2% 投毒率取得 93.2% ASR 和 95.3% clean success
...
- 2026-08-22（主会）：以官方 Anthology Long/Short 卷为录用证据，逐篇核对标题、链接、摘要与去重；主会 277 篇完成核验。
- 2026-09-09（Findings 补充）：以官方 [Findings 卷](https://aclanthology.org/volumes/2026.findings-acl/)（2,163 篇）为完整分母，标题宽筛 386 篇后逐篇阅读摘要判断收录；新增 153 篇并补入 36 篇已入库论文（🏷 ACL 2026 Findings 徽章标记，总结与仓内一致）；链接以 Anthology 官方页为准，可核实的 arXiv 版本并列保留；与主会及全仓按 arXiv ID、规范化标题去重；未决项：8 篇 Findings 论文无官方摘要（front matter 或空摘要页），未收录。
