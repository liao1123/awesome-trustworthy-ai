...
| 2025&#8209;09 | FreezeVLA: Action-Freezing Attacks against Vision-Language-Action Models | attack、VLA DoS、action freezing、adversarial image | 未注明（arXiv） | [arXiv](https://arxiv.org/abs/2509.19870) | [Repository](https://github.com/xinwong/FreezeVLA)（当前仅 README） | 针对 VLA 在关键干预时可能忽略后续指令，论文用 min-max 双层优化生成让动作持续冻结的对抗图像；结果在三种模型和四个机器人基准上平均成功率达 76.2%，单张图还能跨语言提示迁移。 |
