...
| 2026&#8209;03 | ReFACT: A Benchmark for Scientific Confabulation Detection with Positional Error Annotations | benchmark、scientific confabulation、span error、judge reliability | EACL 2026 | [Official](https://aclanthology.org/2026.eacl-long.381/) | [Code](https://github.com/ddz5431/ReFACT) | 针对科学 confabulation detector 缺少可定位的专家证据；ReFACT 提供 1,001 个 span-level 标注问答；结果九个 LLM 的错误预测中 61% 是无关显著片段，且 GPT-4o pairwise 比较反而弱于独立判断。 |
