...
| 2026&#8209;03 | Probabilistic Concept Graph Reasoning for Multimodal Misinformation Detection | detection、multimodal misinformation、concept graph、uncertainty reasoning | CVPR 2026 | [Official](https://openaccess.thecvf.com/content/CVPR2026/html/Yang_Probabilistic_Concept_Graph_Reasoning_for_Multimodal_Misinformation_Detection_CVPR_2026_paper.html) · [arXiv](https://arxiv.org/abs/2603.25203) | [Code](https://github.com/2302Jerry/pcgr) | 针对虚假信息利用图文关系而非单模态伪造，作者以概率概念图推断实体与事件一致性，并显式表达不确定性以提升检测可靠性。 |
