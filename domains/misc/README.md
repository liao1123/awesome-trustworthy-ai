...
本目录收纳当前规模较小、暂不需要独立目录层级的研究领域。每个领域直接保存为一个 Markdown 文件，文件内包含研究方向、研究脉络和按语义拆分的论文表格；当某个领域形成稳定且内容较多的二级分类后，再提升为 `domains/` 下的独立文件夹。
...
| [Persona Vector 与人格安全](persona-vectors.md) | Persona 表征的形成、监测与 steering，以及 persona drift、场景化 jailbreak 和角色条件成本攻击。 |
