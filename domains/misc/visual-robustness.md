...
| --- | --- | --- | --- | --- | --- | --- |
| 2026&#8209;06 | What the Eyes See, the LLMs Miss: Exploiting Human Perception for Adversarial Text Attacks | attack、VLM robustness、visual illusion、visual adversarial attack | USENIX 2026 | [arXiv](https://arxiv.org/abs/2606.09700) | 暂未公开 | 针对文本审核器忽略人类可感知的排版线索，论文用间距、强调和空间布局构造黑盒 HPAA；结果仅三次查询即可保持超过 86% 的人类识别率并把多种检测率压到 1% 以下。 |
...
| 2026 | When Harmful Content Goes Invisible: Unveiling Perception Failure of LVLMs with CAMOUHARMTI | attack、VLM content moderation、visual illusion | CVPR 2026，已录用 | 暂未找到公开论文页 | [Code](https://github.com/1371149/CamouHarmTV) | 针对有害内容经过视觉伪装后可能逃过 LVLM 审核，论文用 CAMOUHARMTI 构造和评测伪装样本；结果揭示内容仍可被人感知但模型难以识别的安全盲点。 |
