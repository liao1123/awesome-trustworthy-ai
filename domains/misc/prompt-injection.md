...
| 2026 | BERM: Low-Overhead Prompt-Injection Detection via In-Situ Benign Representation Modeling | detection、prompt injection、benign manifold、low-latency guardrail | IJCAI-ECAI 2026 | [Accepted](https://2026.ijcai.org/accepted-papers/?ijtrack=main-track) · [Preprint](https://ijcai-preprints.s3.us-west-1.amazonaws.com/2026/8133.pdf) | 暂未公开 | 针对外接 guard model 延迟高而启发式规则脆弱，BERM 直接利用宿主 LLM prefill 表征学习良性流形，以轻量分类器低开销检测注入。 |
...
| 2025&#8209;03 | Defeating Prompt Injections by Design | defense、LLM agent、prompt injection、capability enforcement | IEEE SaTML 2026 | [Official](https://satml.org/2026/accepted-papers/) · [arXiv](https://arxiv.org/abs/2503.18813) | [Code](https://github.com/google-research/camel-prompt-injection) | 针对智能体处理不可信工具输出时遭 prompt injection 的风险，CaMeL 分离 control flow 与 data flow 并执行 capability policy，在 AgentDojo 上以可证明安全方式完成 67% 的任务。 |
