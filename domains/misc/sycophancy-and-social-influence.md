...
| 2026 | Sycophants in the Courtroom: Are LLMs Fragile to Juridical Authority and Evolving Legal Standards? | analysis、legal AI、high-risk deployment、sycophancy | ACL 2026 | [Official](https://aclanthology.org/2026.acl-long.497/) | 暂未公开 | 法律—医疗对照显示 LLM 难判断法律引用的辖区、时效和层级，易对被扰动的权威材料过度自信并受格式诱导；模型越大、指令遵循越强，这一法律迎合反而可能越严重。 |
