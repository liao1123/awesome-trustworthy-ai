...
| 时间 | 论文名称 | 关键词 | 会议中稿情况 | 论文链接 | 代码链接 | 一句话总结 |
| --- | --- | --- | --- | --- | --- | --- |
| 2026&#8209;08 | Learning What to Fail On: Failure-Mode Contextual Bandits for Adversarial Data Curation | analysis、adversarial robustness、fine-tuning data、risk filtering | 未注明（arXiv） | [arXiv](https://arxiv.org/abs/2608.18681) | 暂未公开 | 我们提出一个感知失效的对抗检索增强框架，用于提高自然语言理解的鲁棒性；不同于使用固定奖励阈值选择合成样本，我们把对抗数据整理表述为一个失效模式上下文多臂老虎机问题；最后，理论解释表明，在给定假设下，失效模式采样能够减少与捷径一致的梯度贡献，同时把分布漂移限制在有界范围内。 |
