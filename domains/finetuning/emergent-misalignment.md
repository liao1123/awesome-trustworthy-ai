...
| 2025&#8209;06 | Persona Features Control Emergent Misalignment | defense、emergent misalignment、persona feature、sparse autoencoder | ICLR 2026 | [Official](https://iclr.cc/virtual/2026/poster/10006528) · [arXiv](https://arxiv.org/abs/2506.19823) | 暂未公开 | 针对涌现错位由哪些内部特征驱动，论文用稀疏自编码器和模型差分定位有毒人格特征；结果该特征既能预测和操纵错位，也可通过良性微调被削弱。 |

## 机制、边界与稳健性分析

| 时间 | 论文名称 | 关键词 | 会议中稿情况 | 论文链接 | 代码链接 | 一句话总结 |
| --- | --- | --- | --- | --- | --- | --- |
| 2026&#8209;08 | On the Threat Model of Weird Generalization and Emergent Misalignment | analysis、weird generalization、adversarial data engineering、evaluation sensitivity | 未注明（arXiv） | [arXiv](https://arxiv.org/abs/2608.23476) | [Code / Data](https://github.com/miriamwanner/wg-data) | 跨三个开放模型和四套数据的实验显示，weird generalization 对数据组成与语言的依赖强于规模，对预训练熟悉数据强于新颖数据，并随少量评测问题的选择显著波动；论文因此将其校准为需要精心数据工程的对抗性威胁，而非普通微调中稳定、普遍的固有危险。 |
...
| 2026&#8209;07 | Constitutional Midtraining: Content Presence Drives Alignment Gains | analysis、emergent misalignment、behavioral generalization、alignment stability | 未注明（arXiv） | [arXiv](https://arxiv.org/abs/2607.26654) | [Code](https://github.com/desBugger/constitutional-mt) | 论文在 120B 训练规模注入 3.94 亿 token constitutional corpus，发现内容本身比课程结构更影响持久对齐；其对 blackmail 的优势经良性微调仍保留 17.5 个百分点且无平均能力损失，但面对 in-context pressure 时会衰减。 |
