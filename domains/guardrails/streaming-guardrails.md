...
| --- | --- | --- | --- | --- | --- | --- |
| 2026&#8209;07 | Online Safety Monitoring for LLMs | defense、online monitor、risk control、alarm calibration | 未确认（arXiv Comments：ICML 2026 Hypothesis Testing Workshop） | [arXiv](https://arxiv.org/abs/2607.02510) | 暂未公开 | 论文把外部 verifier 的连续信号通过 risk-control calibration 转成实时 alarm threshold，并在推理与红队数据上与 sequential hypothesis testing 比较；结果说明简单、可校准的在线阈值器即可成为有竞争力的流式安全监控基线。 |
