...
| 2023&#8209;11 | Certified Defense on the Fairness of Graph Neural Networks | defense、fairness attack、certification、graph neural network | KDD 2026 | [Official](https://doi.org/10.1145/3770854.3780323) · [arXiv](https://arxiv.org/abs/2311.02757) | [Code](https://github.com/yushundong/ELEGANT) | ELEGANT 针对攻击者篡改节点属性或图结构以破坏群体公平性的威胁，为给定扰动预算下的 GNN fairness 提供可证明保证。 |
