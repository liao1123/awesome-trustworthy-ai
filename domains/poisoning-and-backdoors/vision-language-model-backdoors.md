...
| 2026&#8209;06 | Backdoor Learning in Language Models and Vision-Language Models | attack、VLM safety、model backdoor、VLM backdoor | 未注明（arXiv） | [arXiv](https://arxiv.org/abs/2608.18095) | [Code](https://github.com/usnistgov/trojai-round-generation/tree/round5) | 深度学习的最新进展显著增强了自然语言处理（NLP）和视觉—语言模型（VLM）的能力；本论文研究可信 AI 与高效多模态表征学习的两个关键维度：（1）安全性：分析、检测并设计 NLP 与 VLM 中的后门攻击；（2）效率：研究面向临床和医学影像应用的先进多模态表征方法。 |
