...
| 时间 | 论文名称 | 关键词 | 会议中稿情况 | 论文链接 | 代码链接 | 一句话总结 |
| --- | --- | --- | --- | --- | --- | --- |
| 2026&#8209;08 | ActivationBackdoor: Backdooring Large Language Models in Collaborative Inference via Intermediate Activations | attack、LLM backdoor、collaborative inference、activation injection | KDD 2026 | [Official](https://doi.org/10.1145/3770855.3818136) | 暂未公开 | ActivationBackdoor 在协同推理传递的中间 activation 中植入触发行为，揭示即使模型权重和文本输入可信，分段执行接口仍可成为后门入口。 |
