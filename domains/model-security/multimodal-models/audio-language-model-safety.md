...
| 2026&#8209;03 | Attacker’s Noise Can Manipulate Your Audio-based LLM in the Real World | attack、over-the-air noise、target action、bystander impact | EACL 2026 | [Official](https://aclanthology.org/2026.eacl-long.66/) | 暂未公开 | 针对 audio LLM 会在开放声学环境中接收第三方信号；论文构造可经空气传播的隐蔽 perturbation；结果可触发 wake word、修改日历等 target behavior，并降低附近无辜用户的响应质量。 |
