...
> Generator training-time backdoor 主记录见 [扩散模型后门](../../poison-and-backdoor/diffusion-backdoor.md)；独立 image/video moderation model 见 [Multimodal Guardrails](../../guardrails/multimodal-guardrails.md)。
