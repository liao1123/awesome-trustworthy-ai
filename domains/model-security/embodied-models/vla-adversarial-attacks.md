...
| 2025&#8209;10 | CHAI: Command Hijacking against Embodied AI ↗ | attack、embodied AI、visual prompt injection、command hijacking | IEEE SaTML 2026 | [Official](https://satml.org/2026/accepted-papers/) · [arXiv](https://arxiv.org/abs/2510.00181) | 暂未公开 | 针对具身 LVLM 会把环境中的自然语言标牌解释为控制指令，CHAI 以 token search、字典和攻击模型生成欺骗性 Visual Attack Prompt；在无人机紧急降落、自动驾驶、空中目标跟踪和真实机器人车上均优于既有攻击，验证命令劫持会形成可执行物理后果。 |
