...
> Diffusion LM 的 training-time trigger、BadDLM、SHADOWMASK 与 purification 见 [扩散模型后门](../../poison-and-backdoor/diffusion-backdoor.md)；潜在 latency/energy amplification 见 [Language Model DoS](../../dos/llm-dos.md)。
